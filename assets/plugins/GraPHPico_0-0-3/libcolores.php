<?
	...
	$colores[35] = ImageColorAllocate($image,211,154,104);      // prueba
	$colores[36] = ImageColorAllocate($image,193,112,39);      // Naranja dos obscuro
	$colores[37] = ImageColorAllocate($image,211,154,104);
