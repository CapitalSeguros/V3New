                                ...
                                $.each(datos.recibosSemanales, function(b,datosa){
                                    $.each(datosa, function(s, registros){
                                        ...
                                        if(b=="RecibosEmitidos"){
                                            acumulado_prima=registros.PrimaAcumulada;
                                            console.log(acumulado_prima);
                                        }
                                                    ...
                                                    <div class="panel-body">
                                                        <table class="table table-bordered" id="tabla_info_`+mes+`">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>$ `+new Intl.NumberFormat().format(registros.Prima)+` </td>
                                                                ...
                                                                <tr>
                                                                    <td>$ `+new Intl.NumberFormat().format(registros.PrimaPendiente)+`</td>
                                                                ...
                                                                <tr>
                                                                    <td>$ `+new Intl.NumberFormat().format(registros.Comision)+`</td>
                                                                ...
                                                                info_reporte+=`
                                                                    <td>`+(comisionA/datos.metaComercial).toFixed(2)+`%</td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td>$ `+new Intl.NumberFormat().format(registros.ComisionPendiente)+`</td>
                                                                    <td class="text-left">Comisión pendiente</td>  
                                                                </tr>
                                                                <tr>
                                                                    <td>$ `+new Intl.NumberFormat().format(registros.Comision/registros.Polizas)+`</td>
                                                ...
                                                <div class="panel-body">
                                                    <table class="table table-bordered" id="tabla_info_`+mes+`">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                $.each(datosb, function(sp, registrosp){
                                                                    ...
                                                                    info_reporte+=`<td>$ `+new Intl.NumberFormat().format(registrosp.PrimaPendiente)+`</td>`;
                                                                });

                                                            info_reporte+=`
                                                                <td>$ `+new Intl.NumberFormat().format(sumatoriaPrimasNetasPendientes)+`</td>
                                                        ...
                                                        info_reporte+=`
                                                                ...
                                                                <td>`+(datos.metaComercial*(comisionAcu/datos.metaComercial)).toFixed(2)+`</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left">Comisión cobrada</td>`;
                                                            ...
                                                            info_reporte+=`
                                                                <td>$ `+new Intl.NumberFormat().format(comisionpendientesum)+`</td>
                                                            </tr>
                                                            <tr>
