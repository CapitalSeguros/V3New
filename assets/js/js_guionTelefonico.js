...
function crearBloqueConversacion(){
    ...
    entradaTexto.setAttribute("class","form-control");
    ...
    divisor.style = "border-top:1px solid #e3e3e3";
                    ...
                    <div class="mt-4">
                        <!--<div>-->
                            <div class="form-group row">
                             ...
                             <textarea class="form-control" name="textoGuion" id="texto_${contador}" cols="90" rows="5">${res.mensaje[a].texto.replace("<br />", "\n")}</textarea>
                        <!--</div>-->
                    </div>
                `;
