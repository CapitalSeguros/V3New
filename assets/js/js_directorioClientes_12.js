            ...
            if(res.mensaje!=""){
                ...
                for(var i in res.contactos){
                    ...
                    body_modal.innerHTML+=`
							...
							<div><p>Enviar correo electronico a: <a href="mailto:${res.contactos[i].EMail1}">${res.contactos[i].EMail1}</a></p></div>
                            <div class="form-group">
                            ...
                            <div class="col-md-12"><div class="mb-4">Clientes unificados: </div>${clients}</div>
                        `;
                }
            }
        }
