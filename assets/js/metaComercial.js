    ...
    xmlhhtp.onreadystatechange=function(){
        if(this.readyState==4 && this.status==200){
            ...
            if(resultado.mensaje==""){
                ...
                var contenedor_info1=document.getElementById("cantidad_polizas_contenedor");
                var contenedor_info2=document.getElementById("prima_polizas_contenedor");
                ...
                for(r in resultado){
                    ...
                    if(r!="mensaje"){
                        ...
                        contenedor_info1.innerHTML+=`
                            <tr id="td_ramo_`+r+`" id_coor="`+r+`">
                                <td>`+resultado[r].Nombre+`</td>
                                <td>`+resultado[r].Correo+`</td>
                                <td id="autos">`+resultado[r].Polizas.autos+`</td>
                                <td id="vida">`+resultado[r].Polizas.vida+`</td>
                                <td id="danios">`+resultado[r].Polizas.danios+`</td>
                                <td id="gmm">`+resultado[r].Polizas.gmm+`</td>
                                <td id="fianzas">`+resultado[r].Polizas.fianzas+`</td>
                        ...
                        `
                        contenedor_info2.innerHTML+=`
                            <tr id="td_ramo_`+r+`" id_coor="`+r+`">
                                <td>`+resultado[r].Nombre+`</td>
                                <td>`+resultado[r].Correo+`</td>
                                <td id="autos">`+resultado[r].Primas.autos+`</td>
                                <td id="vida">`+resultado[r].Primas.vida+`</td>
                                <td id="danios">`+resultado[r].Primas.danios+`</td>
                                <td id="gmm">`+resultado[r].Primas.gmm+`</td>
                                <td id="fianzas">`+resultado[r].Primas.fianzas+`</td>
                                <!--<td class="sicas_result" style="display:none">
                                    <button type="button" class="boton_modal_sicas btn btn-info btn-xs" data-toggle="modal" data-target="#modal_ramos" id_modal="`+r+`" style="display:none">
                                    Ver resultado Sicas
                                    </button>
