...
var datatable = jQuery(".nc-list-table").DataTable({
    ordering: false,
    ajax: {
        url: `https://capsys.com.mx/V3/binconformidad/getNCList?getOnlyMyList=true&year=${date.getFullYear()}`,
        type: `GET`,
        dataSrc: ``
    },
    columns: [
...
jQuery(".show-all-elements").on("click", function(e){
    ...
    datatable.ajax.url(`https://capsys.com.mx/V3/binconformidad/getNCList?getOnlyMyList=true&year=${date.getFullYear()}`).load();
});
//------------------------------