...
var cadFiltro= '<label>Filtrar: </label>';
cadFiltro=cadFiltro+'<select id="selectFiltro">';
...
capa.innerHTML=cadena
 ...
 htmlPlanilha =htmlPlanilha+' xmlns:x="urn:schemas-microsoft-com:office:excel"';
  ...
  htmlPlanilha=htmlPlanilha+ cadena + '</body></html>'  
    ...
    window.navigator.msSaveOrOpenBlob(blobObject, "cobranza.xls");
     } 
    }
  }
/*===============================================================================================*/
   ...
   var imp="";
                    $.ajax({
                        ...
                        success : function(datat)
                            ...
                            //alert(imp);
                              //var sting=document.getElementById('txt').value;
                              var micapa = document.getElementById('ventana-flotante');
                              //micapa.innerHTML= '<input type="button" value="'+sting+'com_xxx" name="option" /><input type="hidden" value="introduce" name="task" />';
                             var tbl = document.getElementById('tabla'); // table reference
                             lastCol = tbl.rows[0].cells.length-1; 
                             //document.getElementById('tabla').rows.length
                            //alert(document.getElementById('tabla').rows[1].cells[2].innerText);
