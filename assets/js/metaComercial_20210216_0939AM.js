        ...
        if(this.readyState==4 && this.status==200){
            ...
            if(resp.mensaje!=""){
                ...
                resultados+=`<div style="width: 100%; border: 1px #D5D8DC solid; padding: 10px 10px 0px 10px; border-radius: 10px">
                    <p><small style="color: #ABB2B9" class="text-right"><i class="fa fa-calendar" aria-hidden="true"></i> Fecha de consulta a Sicas: `+hoy.getFullYear()+`-`+(hoy.getMonth()+1)+`-`+hoy.getDate()+` `+hoy.getHours()+`:`+hoy.getMinutes()+`:`+hoy.getSeconds()+`</small></p>
