                    ...
                    if("PolizasFianzasEmitidas" in r_t){
                        ...
                        ppp["semana2"] = {
                            "asesor": {
                                ...
                                "comision0Acumulada": ppp["semana1"]["asesor"]["comision0Acumulada"] + comision0_semana1_asesor,//comision0_semana1_asesor,
                                "comision1": comision1_semana2_asesor,
                                "comision1Acumulada": ppp["semana1"]["asesor"]["comision1Acumulada"] + comision1_semana1_asesor //comision1_semana1_asesor
                            ...
                            "gap": {
                                ...
                                "comision0Acumulada": ppp["semana1"]["gap"]["comision0Acumulada"] + comision0_semana1_gap,//comision0_semana1_asesor,
                                "comision1": comision1_semana2_gap,
                                "comision1Acumulada": ppp["semana1"]["gap"]["comision1Acumulada"] + comision1_semana1_gap
                            }
                        }
                                                    ...
                                                    <div role="tabpanel" class="tab-pane active" id="vendedor_semanal_`+mes+`_`+r+`_`+s.slice(4)+`">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                var vendedores_semana_unitario = datos[`vendedores`][`${r}`][`sem_${s.slice(4)}`] || {};
                                                                const total_agentes_semana = Object.keys(vendedores_semana_unitario).length;
                                                                const total_comision_unitaria = Object.values(vendedores_semana_unitario).reduce((acc, va) => acc + va.Comision, 0);
                                                                const total_prima_unitaria = Object.values(vendedores_semana_unitario).reduce((acc, va) => acc + va.Prima, 0);
                                                                const total_autos_unitaria = Object.values(vendedores_semana_unitario).filter(arr_ => arr_.Ramo.Vehiculos).reduce((acc, cur) => acc + cur.Ramo.Vehiculos, 0);
                                                                const total_vida_unitaria = Object.values(vendedores_semana_unitario).filter(arr_ => arr_.Ramo.Vida).reduce((acc, cur) => acc + cur.Ramo.Vida, 0);
                                                                const total_danos_unitaria = Object.values(vendedores_semana_unitario).filter(arr_ => arr_.Ramo.Daños).reduce((acc, cur) => acc + cur.Ramo.Daños, 0);
                                                                const total_gmm_unitaria = Object.values(vendedores_semana_unitario).filter(arr_ => arr_.Ramo.GMM).reduce((acc, cur) => acc + cur.Ramo.GMM, 0);
                                                                    //const total_fianzas_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.Fianzas).reduce((acc, cur) => acc + cur.Ramo.Fianzas, 0);
                                                                const total_ap_unitaria = Object.values(vendedores_semana_unitario).filter(arr_ => arr_.Ramo.AP).reduce((acc, cur) => acc + cur.Ramo.AP, 0);
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    var semana_y_tipo = datos["acumulado_vendedores"][`${r}`][`${s.slice(4)}`];

                                                                    const total_agentes = Object.keys(semana_y_tipo).length;
                                                                    const total_comision_ = Object.values(semana_y_tipo).reduce((acc, va) => acc + va.Comision, 0);
                                                                    const total_prima_ = Object.values(semana_y_tipo).reduce((acc, va) => acc + va.Prima, 0);
                                                                    const total_autos_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.Vehiculos).reduce((acc, cur) => acc + cur.Ramo.Vehiculos, 0);
                                                                    const total_vida_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.Vida).reduce((acc, cur) => acc + cur.Ramo.Vida, 0);
                                                                    const total_danos_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.Daños).reduce((acc, cur) => acc + cur.Ramo.Daños, 0);
                                                                    const total_gmm_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.GMM).reduce((acc, cur) => acc + cur.Ramo.GMM, 0);
                                                                    //const total_fianzas_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.Fianzas).reduce((acc, cur) => acc + cur.Ramo.Fianzas, 0);
                                                                    const total_ap_ = Object.values(semana_y_tipo).filter(arr_ => arr_.Ramo.AP).reduce((acc, cur) => acc + cur.Ramo.AP, 0);
                                                        ...
                                                        <table class="table table-bordered" id="tabla_info_`+mes+`_`+b+`_`+s.slice(4)+`">
                                                            ...
                                                            if(b!="RecibosEmitidos" && b!="RecibosPendientes" && b!="RecibosUnoEmitidos"){ //b!="RecibosEmitidos" && b!="RecibosPendientes"
                                                                ...
                                                                info_reporte+=`
                                                                    ...
                                                                    info_reporte+=`
                                                                        <td>`+((comisionA/mc)*100).toFixed(2)+`%</td>
                                                                    </tr>
                                                                `;  
