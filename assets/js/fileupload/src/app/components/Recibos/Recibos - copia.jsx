                                                ...
                                                <div className="tab-pane fade active show in" id="datos-generales" role="tabpanel" aria-labelledby="datos-generales-tab">
                                                    <div className='row mb-3'>
                                                        <div className='col-md-12 text-right'>
                                                            ...
                                                            <a className='btn btn-primary btn-s' data-toggle="tooltip" data-placement="bottom" title="Aplicar pago" onClick={() => RecalcularRecibo()}><i className="fa fa-refresh" aria-hidden="true"></i>&nbsp;Recalcular recibo</a>
                                                                    ...
                                                                    <div className="form-group">
                                                                        ...
                                                                        <div className="col-sm-8" style={{ paddingRight: 'unset' }}>
                                                                            ...
                                                                            <CurrencyInputField
                                                                                ...
                                                                                onBlur={(e) => { handleBlur, NewReloadPrices("PrimaNeta", e.target.value, values) /* , ReloadAll(values, null) */ }}
                                                                                min={0}
                                                                                maxLength={10}
                                                                                disabled={disabled}
                                                                                //prefix='$'
                                                                ...
                                                                <div className='col-md-12'>
                                                                    <div className="form-groug">
                                                                        ...
                                                                        <div className="col-sm-4" style={{ paddingRight: 'unset' }}>
                                                                            <CurrencyInputField
                                                                                className='form-control input-sm numeric'
                                                                                onBlur={(e) => { handleBlur, NewReloadPrices("Descuento", e.target.value, values) /* , ReloadAll(values, '') */ }}
                                                                                min={0}
                                                                                maxLength={10}
                                                                                disabled={disabled}
                                                                                //prefix='$'
                                                                ...
                                                                <div className='col-md-12'>
                                                                    <div className="form-groug">
                                                                        ...
                                                                        <div className="col-sm-4" style={{ paddingRight: 'unset' }}>
                                                                            <CurrencyInputField
                                                                                className='form-control input-sm numeric'
                                                                                onBlur={(e) => { handleBlur, NewReloadPrices("ComN", e.target.value, values)/* , ReloadAll(values, '') */ }}
                                                                                min={0}
                                                                                maxLength={10}
                                                                                disabled={disabled}
                                                                                //prefix='$'
                                                        ...
                                                        <div className='col-md-4'>
                                                            <div className='row'>
                                                                <div className='col-md-12'>
                                                                    <div className='form-group'>
                                                                        <label>Estatus</label>
                                                                        <input type="text" className='form-control input-sm' name="Estatus" id="Estatus" disabled={true} />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className='row'>
                                                                ...
                                                                <div className='card-body p-0'>
                                                                    <div className='row'>
                                                                        ...
                                                                        <div className='col-md-2 mb-2'>
                                                                            <label htmlFor="txMotivo"><p></p></label>
                                                                            <div className='form-group'>
                                                                                <h6>{selectedPago.FechaAplica ? moment(selectedPago.FechaAplica).format('DD/MM/YYYY h:mm') : ''}</h6>
                                                                                <hr />
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div className='card-body p-0'>
                                                                    <div className='row'>
                                                                        ...
                                                                        <div className='col-md-2 mb-0'>
                                                                            <label htmlFor="txMotivo"><p></p></label>
                                                                            <div className='form-group'>
                                                                                <h6>{selectedPago.FechaLiquidacionUsuario ? moment(selectedPago.FechaLiquidacionUsuario).format('DD/MM/YYYY h:mm') : ''}</h6>
