...
var cadFiltro= '';
cadFiltro = '<label for="selectFiltro">Filtrar</label>';
cadFiltro = cadFiltro+'<select id="selectFiltro" class="form-control">';
...
ramoNombre=ramoNombre.replace(/\s/g,"_");
RamosNombre=RamosNombre.replace(/\s/g,"_");
ramoNombre=ramoNombre.replace("ñ","n");
RamosNombre=RamosNombre.replace("ñ","n");
let clase='class=""';
  var cadString='<div>'+'<a '+clase+' href="'+dirUrl+'actividades/agregar/Cotizacion/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+
  '&consultar=Renovacin&cliente=&estatus&=&ramo=&subramo=&promotor=&grupo&subgrupo=&poliza">Cotizacion</a> '
  cadString+='<a  '+clase+'  href="'+dirUrl+'actividades/agregar/Emision/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+'&consultar=Renovacin&cliente=&estatus&=&ramo=&subramo=&promotor=&grupo&subgrupo=&poliza">Emision</a>'
  cadString+=' <a  '+clase+'  href="'+dirUrl+'actividades/agregar/Endoso/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente/verFol?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+'&consultar=Renovacin&cliente=&estatus&=&ramo=&subramo=&promotor=&grupo&subgrupo=&poliza">Endoso</a> '
  cadString+='<a  '+clase+'  href="'+dirUrl+'actividades/agregar/Cancelacion/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente/verFol?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+'&consultar=Renovacin&cliente=&estatus&=&ramo=&subramo=&promotor=&grupo&subgrupo=&poliza">Cancelacion</a>'
  cadString+=' <a  '+clase+'  href="'+dirUrl+'actividades/agregar/Sustitucion/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente/verFol?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+'&consultar=Renovacin&cliente=&estatus&=&ramo="VEHICULOS"&subramo=&promotor=&grupo&subgrupo=&poliza"> Sustitucion </a> '
  cadString+='<a  '+clase+'  href="'+dirUrl+'actividades/agregar/Diligencia/'+ RamosNombre.toUpperCase()+'/'+IDSRamo+'/Existente?idCliente='+IDCli+'-'+Documento+'&idPoliza='+Documento+'&consultar=Renovacin&cliente=&estatus&=&ramo=&subramo=&promotor=&grupo&subgrupo=&poliza">Diligencia</a>';  
  cadString+='</div>';
