                        ...
                        if(requeriment.length > 0){
                            ...
                            var layouts = requeriment.reduce((acc, curr) => {
                                ...
                                acc += `<tr>
                                    <td>
                                        <div class="row">
                                            <div class="col-md-12">${(curr.docName).replace("_", " ")}&nbsp${curr.required == `SI` ? `<span class="label label-danger">Requerido</span>` : ``}</div>
                            ...
                            var dissabledButton_ = requeriment.reduce((acc, curr) => {
                                if(curr.required == "SI" && curr.attachment.length > 0){
                                    acc++;
                                }
                                return acc;
                            }, 0);
                            var uploadsRequired = requeriment.reduce((acc, curr) => {
                            ...
                            console.log(uploadsRequired,dissabledButton_);
                            ...
                            generalDataContent += `
                                ...
                                ${dissabledButton_ == uploadsRequired ? `<hr><div class="text-center"><button class="btn btn-success btn-sm release-agent" data-person="${pass1[i].idPerson}">Liberar agente para inducción</button></div>` : ""}
                            `;
