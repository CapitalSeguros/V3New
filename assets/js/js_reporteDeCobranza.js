                ...
                $.each(object_container, function(mes,datos){
                    ...
                    opciones_li+=`
                        <li class="nav-item">
                            ...
                            <a class="nav-tab-link" aria-current="page" href="javascript: void(0)" role="tab" data-toggle="tab" onclick="muestra_contenido(`+mes+`)"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>&nbsp`+meses_obj[mes]+`</a>
                        </li>
                    `;
