...
cx.stroke();
  ...
  for(var y=0;y<longitud;y++)
  {
	...
	for(var j=pr.length;j>-1;j-- ){	
 	 ...
 	 //cx.strokeText(presupuesto.charAt(j),hastaX-70,n=n-10);	
 	 cx.fillText(pr.charAt(j),hastaX-70,n=n-14);	
    // cx.stroke();	
	}
	n=220;
	 var pr=formatoMoneda(monto);
		for(var j=pr.length;j>-1;j-- ){
				// cx.lineWidth=1;
				 //cx.font = "16px Comic Sans MS";
                 //cx.fillStyle = "red";
				 	 //cx.strokeText(monto.charAt(j),hastaX-40,n=n-10);	
