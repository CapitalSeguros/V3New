(function ($) {
	...
	function _eventCreateUpdate(organizer){
		...
		var emailsCollected = [...emailsJson.Correo, ...emailsJson.correo_externo];
		
		if(emailsCollected.length > 20){

			alert(`Ha superado la cantidad requerida de usaurios ${emailsCollected.length} de 20`);
			return false;
		}
