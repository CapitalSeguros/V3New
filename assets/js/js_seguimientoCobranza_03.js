...
$( function(){
	...
	var vistas_sin_flotante=["directorio","capacita","ver","actividades"];
	...
	if(vistas_sin_flotante.includes(vista_indice)){
		...
		if(document.body.contains(flotante__) && flotante__.style.display=="block"){ //Object.keys(sessionStorage).length>0
