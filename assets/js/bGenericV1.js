...
for(var i=0;i<longitud;i++){if(parseFloat(arreglo1[i])>parseFloat(mayorPresupuesto)){mayorPresupuesto=parseFloat(arreglo1[i])}}
...
for(var i=0;i<14;i++)
 ...
 cx.stroke();	
  ...
  for(var y=0;y<longitud;y++)
  {
	...
	/*ESTE CODIGO IMPRIME TODO EL MONTO EN LAS BARRAS */
  }
}	
