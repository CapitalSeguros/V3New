...
document.getElementById("fCorte").value=(anio.toString()+mesS+diaS.toString());
...
document.getElementById("fCorte").value=fecha_inicial;
if(compruebaVariable==1){
     ...
     document.getElementById("fCorte").value=document.getElementById("fechaIniO").value;
    }
/*======================================================================================*/
function buscar()
{
