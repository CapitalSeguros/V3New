...
class Contenedor extends React.Component{
    ...
    render(){
        ...
        //console.log(this.state.responsables_table);
        ...
        return(
            ...
            <ul className="nav nav-tabs" id="tab_c" role="tablist">
                ...
                <li className="nav-item">
                    <a className="nav-link" id="t_requisito" href="#req" data-toggle="tab" data-trs="5" role="tab" aria-controls="req" aria-selected="false">Requisitos</a>
                </li>
            </ul>
                    ...
                    <div id="req" className="tab-pane fade" role="tabpanel" aria-labelledby="t_requisito">
                        <div class="card mt-3 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <select name="tipo_registro" id="tipo_registro" className="form-control" onChange={this.handleChangeTypeRegister.bind(this)}>
                                    <option value="0">Seleccione</option>
