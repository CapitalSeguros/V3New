    ...
    render(){
        ...
        for(var a in _capa){    
            ...
            for(var b in s_c){
                ...
                const d_s_c =<div className="mt-3"><a href="javascript: void(0)" onClick={this.obtenerInformacionCapacitacion.bind(this, _idPersona, a, b)} >{s_c[b].nombre_certificado}</a></div>
                div_s_c.push(d_s_c);
            }
