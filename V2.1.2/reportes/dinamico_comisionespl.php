...
$dg = new C_DataGrid($sqlConsulta, "idComisionesPl", "Reporte_Comisiones_Pendiente_Liquidar");
$dg -> set_query_filter($sqlFiltroNivel);  //   = "";"CLIENTE_NOMBRE!=''"
...
// hide a column
$dg -> set_col_hidden("idComisionesPl");
