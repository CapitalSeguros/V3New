...
$sqlConsulta2 = "
	Select 
		* 
		, Concat('Poliza') As `NewPoliza`
	From 
		`cobranzapendiente_comentarios`
				";
//print_r(array("poliza"));
/*
foreach(array("poliza") as $poliza){
	echo $poliza;
}
*/
$sdg = new C_DataGrid($sqlConsulta2, array("poliza"), "Reporte_Cobranza_Pendiente_Comentario");
...
//$polizaComentario = "8191977"; //--> "8191977"
//$sdg -> set_col_edittype("poliza", "text", $polizaComentario, false);
$sdg -> set_col_edittype("origen", "select", "G:Cobranza; R:Renovacion", false);
