...
--					`SUBGRUPO` Like '%".str_replace($quitarCosas, $ponerCosas, strstr($filtroSubGrupo, '[',0))."%'
			...
			while($rowActividadesTodas = mysql_fetch_assoc($resActividadesTodas)){
				...
				$fechaTerminoX = explode('-',$rowActividadesTodas['fechaTermino']);
				$fechaTerminoExcel = $fechaTerminoX[2]."/".$fechaTerminoX[1]."/".$fechaTerminoX[0];
				
				$fechaCotizacionX = explode('-',$rowActividadesTodas['fechaCotizacion']);
				$fechaCotizacionExcel = $fechaCotizacionX[2]."/".$fechaCotizacionX[1]."/".$fechaCotizacionX[0];
				
				$fechaRecotizacionX = explode('-',$rowActividadesTodas['fechaRecotizador']);
				$fechaRecotizacionExcel = $fechaRecotizacionX[2]."/".$fechaRecotizacionX[1]."/".$fechaRecotizacionX[0];
				
				$fechaRecotizacion2X = explode('-',$rowActividadesTodas['fechaRecotizador2']);
				$fechaRecotizacion2Excel = $fechaRecotizacion2X[2]."/".$fechaRecotizacion2X[1]."/".$fechaRecotizacion2X[0];
				
				$fechaRecotizacion3X = explode('-',$rowActividadesTodas['fechaRecotizador3']);
				$fechaRecotizacion3Excel = $fechaRecotizacion3X[2]."/".$fechaRecotizacion3X[1]."/".$fechaRecotizacion3X[0];
