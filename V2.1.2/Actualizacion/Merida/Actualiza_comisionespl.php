...
$file = "../../../syncronizacion/Merida/entrada/comisionespl.txt"; //Definicion de archivo y ruta a cargar
...
DreQueryDB("Truncate Table `comisionespl`");
