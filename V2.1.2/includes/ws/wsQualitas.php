...
$idCliente = $idEmpresa;
$idUsuario = $idUsuario;
$descripcion = "[".$cotizacion->DatosVehiculo->ClaveAmis."]-"."*".$wsMarca."*".$cotizacion->DatosVehiculo->DescripcionVehiculo;//$wsMarca." - ".$wsModelo;
$modelo = $wsYear;
$uso = $tipo_uso;
$aseguradora = "QUALITAS";
$prima_danosMateriales = "Convenido";
$prima_roboTotal = "Convenido";
$prima_rc = "$3,000,000.00";
$prima_gastosMedicos = "$300,000.00 x TOTAL";
$prima_asesoriaJuridica = "AMPARADA";
$prima_asistenciaVial = "AMPARADA";
$prima_extensionRc = "AMPARADA";
$prima_muertaAccConducto = "$100,000.00";
