...
// Envio de Correo--->
	...
	$asunto = "Cancelacion de Cita para el: ".DreFechaEsp($rowInfoConfirmarCita['fechaStart']).substr($rowInfoConfirmarCita['fechaStart'],7,10)."Hrs   Terminando el: ".DreFechaEsp($rowInfoConfirmarCita['fechaEnd']).substr($rowInfoConfirmarCita['fechaEnd'],7,10)."Hrs";
