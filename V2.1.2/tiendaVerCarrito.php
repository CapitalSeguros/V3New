...
$seccion = "tienda";
	...
	if(count($_SESSION['tiendaCapsys']) <= 0){ header('Location: tienda.php'); }
...
<table height="100%" cellpadding="0" cellspacing="0" align="center" class="TablePrincipal">
    ...
    <tr valign="top" align="center" bgcolor="#FFFFFF">
		...
		<td width="950" class="TextoTitulosSeccion" align="left">
			...
			<br><br>
				* En la liquidaci&oacute;n semanal del vendedor se descontar&aacute; un m&aacute;ximo de $65 con un cr&eacute;dito total en la tienda por hasta $1,000
			<br><br>
			</font>
		</td>
		<td width="25"></td>
    ...
    <tr valign="top" align="center" bgcolor="#FFFFFF">
		...
		<td height="100%" valign="top" align="right">
			<?php require('includes/tiendaHeaderCarrito.php'); ?>
		</td>
		<td></td>
	</tr>
    <tr valign="top" align="center" bgcolor="#FFFFFF">
		...
		<td height="100%" valign="top">
			<?php require('require/tiendaVerCarrito_interior.php'); ?>
		</td>
		<td></td>
	</tr>
	<tr bgcolor="#FFFFFF">
