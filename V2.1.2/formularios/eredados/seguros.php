...
$seccion  = "seguros";
$idioma = "sp";
$titulo = "Seguros | GAP Seguros y Fianzas";
?>
      ...
      <tr>
        ...
        <td width="730" valign="top">
        	<table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
            	<tr>
                	<td class="Titulo_Seccion" valign="top"><?php echo $titulo_seccion[$idioma][$seccion]; ?>&nbsp;</td>
            	</tr>
<?php 
	$query_detalle_seccion = "Select * From `texto_secciones` Where `seccion` = '$seccion' and `idioma` = '$idioma'";
