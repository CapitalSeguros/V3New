...
$tipo = "Seguro Gastos Medicos Mayores";
$queryAddProspeccion = "
		INSERT INTO `prospecciones` 
			(`tipo`, `nombre`, `apellidos`, `telefono`, `email`, `edad_contratante`, `sexo`, `coverturaInternacional`, `deducible`, `nivelHospitalario`, `formaPago`, `nombreFam1`, `sexoFam1`, `parentescoFam1`, `edadFam1`, `nombreFam2`, `sexoFam2`, `parentescoFam2`, `edadFam2`, `nombreFam3`, `sexoFam3`, `parentescoFam3`, `edadFam3`, `comentarios`, `residencia`, `coaseguro`)
			VALUES ('$tipo', '$nombre', '$apellidos', '$telefono', '$email', '$edad_contratante', '$sexo', '$coverturaInternacional', '$deducible', '$nivelHospitalario', '$formaPago', '$nombreFam1', '$sexoFam1', '$parentescoFam1', '$edadFam1', '$nombreFam2', '$sexoFam2', '$parentescoFam2', '$edadFam2', '$nombreFam3', '$sexoFam3', '$parentescoFam3', '$edadFam3', '$comentarios', '$residencia', '$coaseguro')";
...
$seccion = "gastos_medicos";
$email_subject = "Formulario de Seguro Gastos Medicos Mayores desde Web GapSeguros";
$email_message = "";
...
$message = "";
        ...
        $message = $message . "<strong>Formulario de Seguro Gastos M&eacute;dicos Mayores</strong><br>";
		...
		$message = $message . "<strong>Cobertura Internacional:</strong> ".$coverturaInternacional." <strong>Deducible:</strong> ".$deducible."<br>";
		$message = $message . "<strong>Nivel Hospitalario:</strong> ".$nivelHospitalario." <strong>Forma de Pago:</strong> ".$formaPago."<br>";
		$message = $message . "<strong>Coaseguro:</strong> ".$coaseguro."<br />";
		$message = $message . "<strong>Residencia:</strong> ".$residencia."<br />";
...
<script language="javascript" type="text/javascript">
	...
	window.open('seguros_gastos_medicos.php','_self');
</script>
<?php
} else {
