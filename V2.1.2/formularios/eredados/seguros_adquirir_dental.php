...
<form name="formSegDental" method="post" action="seguros_adquirir_dental_query.php">
  <table border="0" cellspacing="2" cellpadding="5" width="95%" align="center">
    <tbody>
      ...
      <tr>
        <td colspan="4">Cuenta con Gastos M&eacute;dicos Mayores :
          <select  name="gmm" id="gmm" >
            <option value="">-- Seleccione --</option>
      ...
      <tr>
        <td colspan="4" align="right"><font style="font-size:12px;"><em>TODOS los campos son requeridos. &nbsp;</em></font>
          <input type="button" onclick="validarSegDental();" value="enviar" /></td>
      </tr>
      <tr>
