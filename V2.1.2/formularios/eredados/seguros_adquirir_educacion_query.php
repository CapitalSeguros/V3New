...
$tipo = "Seguro Educacion";
$queryAddProspeccion = "
		INSERT INTO `prospecciones` 
			(`tipo`, `nombre`, `apellidos`, `calle`, `noint`, `noext`, `cruzamientos`, `colonia`, `ciudad`, `estado`, `codigopostal`, `telefono`, `email`, `fechanacimiento`, `rfc`, `edad_contratante`, `edad_menor`, `sexo`, `costoUniversidad`, `moneda`, `fuma`, `comentarios`)
			VALUES ('$tipo', '$nombre', '$apellidos', '$calle', '$noint', '$noext', '$cruzamientos', '$colonia', '$ciudad', '$estado', '$codigopostal', '$telefono', '$email', '$fechanacimiento', '$rfc', '$edad_contratante', '$edad_menor', '$sexo', '$costoUniversidad', '$moneda', '$fuma', '$comentarios')";
...
$seccion = "educacion";
$email_subject = "Formulario de Seguro Educacion desde Web GapSeguros";
$email_message = "";
...
$message = "";
        ...
        $message = $message . "<strong>Formulario de Seguro Educaci&oacute;n</strong><br>";
		...
		$message = $message . "<strong>Edad del Contratante:</strong> ".$edad_contratante." <strong>Edad del Menor:</strong> ".$edad_menor."<br>";
		$message = $message . "<strong>Costo Universidad:</strong> ".$costoUniversidad." <strong>Moneda:</strong> ".$moneda."<br>";
		$message = $message . "<strong>Sexo:</strong> ".$sexo." <strong>Fuma:</strong> ".$fuma."<br>";
...
<script language="javascript" type="text/javascript">
	...
	window.open('seguros_educacion.php','_self');
</script>
<?php
} else {
