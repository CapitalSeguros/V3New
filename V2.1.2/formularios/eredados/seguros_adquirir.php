...
$idioma = "sp";
extract($_REQUEST);
$titulo = "Adquirir Seguros | GAP Seguros y Fianzas";
?>
      ...
      <tr>
        ...
        <td width="730" valign="top">
        	<table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
            	<tr>
                	<td class="Titulo_Seccion" valign="top"><?php echo $titulo_seccion[$idioma][$seccion]." > ".$titulo_seguro[$idioma][$tipoSeguro]; ?>&nbsp;</td>
            	</tr>
            	<tr>
                	<td>&nbsp;</td>
            	</tr>
            	<tr>
                	<td class="Texto"><?php
						if($tipoSeguro == ""){
							...
							window.location = "http://www.gapseguros.com/sp/seguros.php";
							alert('Seleccione un Seguro');
                            </script>
							<?php 
							//header("Location : http://www.gapseguros.com/sp/seguros.php");
						} else {
							require('seguros_adquirir_'.$tipoSeguro.'.php'); 
						}
					?></td>
            	</tr>
        	</table>
