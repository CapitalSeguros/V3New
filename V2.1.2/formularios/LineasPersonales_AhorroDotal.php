...
<form name="formLineasPersonales" id="formLineasPersonales" method="post" action="includes/guardar.php?tipoGuardar=formularios">    
	...
	<tr>
	  ...
	  <td><input name="fecha_nacimiento" type="text" id="fecha_nacimiento" value="<?php echo $rowLineasPersonales_accidentesPersonales['fecha_nacimiento'] ?>" maxlength="30" <?php echo campoBloqueado($rowDatosFormulario['estatus']); ?> readonly/>
	...
	<tr>
	  ...
	  <td><input name="fecha_nacimiento_conyuge" type="text" id="fecha_nacimiento_conyuge" value="<?php echo $rowLineasPersonales_accidentesPersonales['fecha_nacimiento_conyuge'] ?>" maxlength="30" <?php echo campoBloqueado($rowDatosFormulario['estatus']); ?> readonly/>
	...
	<tr>
	  <td align="right">Plazo ahorro a&ntilde;os:</td>
	  <td><input name="plazo_ahorro" type="text" id="plazo_ahorro" value="<?php echo $rowLineasPersonales_accidentesPersonales['plazo_ahorro'] ?>" maxlength="30" <?php echo campoBloqueado($rowDatosFormulario['estatus']); ?>/></td>
    </tr>
	<tr>
