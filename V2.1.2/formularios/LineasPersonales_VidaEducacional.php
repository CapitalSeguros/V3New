...
<form name="formLineasPersonales" id="formLineasPersonales" method="post" action="includes/guardar.php?tipoGuardar=formularios">    
	<tr>
	  <td align="right">Nombre del menor:</td>
	  <td><input name="nombre_menor" type="text" id="nombre_menor" value="<?php echo $rowLineasPersonales_accidentesPersonales['nombre_menor'] ?>" size="50" maxlength="30" <?php echo campoBloqueado($rowDatosFormulario['estatus']); ?>/></td>
    </tr>
	<tr>
	  <td align="right">Fecha nac. menor:</td>
	  <td><input name="fecha_nacimiento_menor" type="text" id="fecha_nacimiento_menor" value="<?php echo $rowLineasPersonales_accidentesPersonales['fecha_nacimiento_menor'] ?>" maxlength="30" <?php echo campoBloqueado($rowDatosFormulario['estatus']); ?>/>
      <img src="img/cal.gif" id="fecha_nacimiento_menor_Btn"  title="Clic">
      </td>
    </tr>
	<tr>
