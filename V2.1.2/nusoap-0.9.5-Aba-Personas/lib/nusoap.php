...
class nusoap_base {
    ...
    */
	...
	'<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tem="http://tempuri.org/" xmlns:abas="http://schemas.datacontract.org/2004/07/Abaseguros.PersonaConnect">'.
	$headers.
	"<soapenv:Body>".
		$body.
	"</soapenv:Body>".
...
//		                		$this->schemas[$ns]->imports[$ns2][$ii]['loaded'] = true;
								$this->schemas[$ns][$ns2]->imports[$ns2][$ii]['loaded'] = true; // Linea con Ajuste JJHE
