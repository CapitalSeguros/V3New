...
<script language="javascript" type="text/javascript"> 
	...
	var segundos = 5; //Segundos de la cuenta atras
	var urlRedireccion = "monitorCotizadores.php"; //Pagiana a la que redireccionara a X segundos
	
	function RedireccionamientoTiempo(){  // segundos, urlRedireccion
		var t = setTimeout("RedireccionamientoTiempo()",1000);  
