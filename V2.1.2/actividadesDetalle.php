...
$seccion = "actividades";
	...
	$sqlValidamosActividad = "
		Select 
			Count(*) As `existeActividad`
		From
			`actividades`
		Where
			`recId` = '$recId'
							 ";
	$resValidamosActividad = DreQueryDB($sqlValidamosActividad);
	$rowValidamosActividad = mysql_fetch_assoc($resValidamosActividad);
	if((int)$rowValidamosActividad['existeActividad'] == 0 ){
		header("Location: actividades.php?actividad=FALSE");
	}
...
<table height="100%" cellpadding="0" cellspacing="0" align="center" class="TablePrincipal">
    ...
    <tr valign="top" bgcolor="#FFFFFF">
		...
		<td height="100%" valign="top">
			<?php require('require/actividadesDetalle_interior.php'); ?>
		</td>
		<td></td>
	</tr>
	<tr bgcolor="#FFFFFF">
