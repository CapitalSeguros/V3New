...
class nusoap_base {
    ...
    */
	...
	'<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tem="http://tempuri.org/" xmlns:abas="http://schemas.datacontract.org/2004/07/Abaseguros.AutoConnect">'.
	$headers.
	"<soapenv:Body>".
		$body.
	"</soapenv:Body>".
