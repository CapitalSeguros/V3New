...
class  Holiday
{
    ...
    public function holiday2($ano = '')
    {
        ...
        $this->festivos[$ano][9][16]  = true;        // Independencia 16 de Septiembre
        ...
        $this->calcula_emiliani(2, 5);                // Dìa de la consitución mexicana.
        $this->calcula_emiliani(3, 21);                // Benito Juarez Marzo 19
        ...
        $this->calcula_emiliani(11, 20);                //Día de la Revolución
        //  $this->calcula_emiliani(11, 2);                // Todos los santos Nov 2
