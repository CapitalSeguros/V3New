...
function __construct()
{
  ...
  $this->CI->load->model('permisooperativo', 'po');
...
$array_permisos = $this->CI->po->obtenerPermisosPolizas();
$condiciones_extra = "";
if(in_array('001', $array_permisos)) $condiciones_extra = " ! Periodo;0;0;1;1;VDatRecibos.Periodo";
if(in_array('002', $array_permisos)) $condiciones_extra = " ! Periodo;5;0;1;1;VDatRecibos.Periodo";
$respuesta=array();
$tableInfo=array();
        $datos['TipoEntidad']='0';
        $datos['TypeDestinoCDigital']='CONTACT';
...
{
  case 'cancun':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;1;1;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! Despacho;0;3;3;1;DatDocumentos.IDDespacho' . $condiciones_extra;
    break;
  case 'fianzas':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;2;2;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status' . $condiciones_extra;
  break;
case 'institucional':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;1;1;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! despacho;2;0;2|7;2|7;DatDocumentos.IDDespacho ! gerencia;0;9;9;1;DatDocumentos.IDGerencia ! grupo;1;0;12;0;1;DatDocumentos.IDGrupo ! subramo;1;0;20;0;0;DatDocumentos.IDSRamo' . $condiciones_extra;
  break;
  case 'merida':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;1;1;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! despacho;2;0;2|7;2|7;DatDocumentos.IDDespacho ! gerencia;1;0;9;0;1;DatDocumentos.IDGerencia ' . $condiciones_extra;
  break;
case 'grupocer':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;1;1;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! grupo;0;0;12;0;1;DatDocumentos.IDGrupo ! VendedorID;0;0;7;0;0;CatVendedores.IdVend' . $condiciones_extra;
  break;
case 'grupoflotillas':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;0;1;1;1;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! grupo;1;0;12;0;1;DatDocumentos.IDGrupo ! VendedorID;0;0;7;0;0;CatVendedores.IdVend ! subramo;0;0;20;0;0;DatDocumentos.IDSRamo' . $condiciones_extra;
  break;
case 'todos':
$datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;2;0;1|2;1|2;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status' . $condiciones_extra;
  break;

  default:
  $vendedor=$this->CI->tank_auth->get_IDVend();
  $datos['ConditionsAdd']='Desde|Hasta;3;0;'.$array['fechaInicial'].'|'.$array['fechaFinal'].';0;-1;VDatRecibos.'.$array['tipoFecha'].' ! Documento;2;0;1|2;1|2;DatDocumentos.TipoDocto ! Status;0;0;0;0;VDatRecibos.Status ! VendedorID;2;0;'.$vendedor.';'.$vendedor.';CatVendedores.IdVend' . $condiciones_extra;
    break;
...
//-----------------------------------------------------------
function polizasPorCliente($IDCli,$Status='')
{

  $filtroStatus='';
  $filtroSR='';
  if($Status!=''){$filtroStatus=' ! Status;2;0;'.$Status.';0;-1;DatDocumentos.Status';}
 // if($SR!=''){$filtroSR=' ! SubRamo;1;0;'.$SR.';0;-1;DatDocumentos.IDSRamo';}
  $datos['TipoEntidad']='0';
  $datos['TypeDestinoCDigital']='CONTACT';
  $datos['IDValuePK']='0';
  $datos['ActionCDigital']='GETFiles';
  ...
  $datos['KeyCode']='HWS_DOCTOS';
  $datos['Page']='1';
  $datos['ItemForPage']='100000';
  $datos['InfoSort']='VDatDocumentos.IDDocto';
  $datos['IDRelation']='0';
  $datos['ConditionsAdd']='Cliente Id;0;0;'. $IDCli .';'. $IDCli .';0;-1;DatDocumentos.IDCli '.$filtroStatus.$filtroSR;
