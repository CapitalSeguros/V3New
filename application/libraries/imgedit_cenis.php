...
class Imgedit_cenis {
    ...
    function createWelcomeTemplate($photo, $id, $name, $initDate, $email, $job ,$_description, $template){
        ...
        try{
            ...
            $dirPath =$_SERVER["DOCUMENT_ROOT"]."/V3/assets/plantillas_ingreso/plantillas_nuevas_personas/";
            $filename = "person_".$id."_".$template.".png";
            $createFolders = true;
            $backgroundColor = null; // transparent, only for PNG (otherwise it will be white if set null)
            $imageQuality = 95; // useless for GIF, usefull for PNG and JPEG (0 to 100%)
            ...
            return "assets/plantillas_ingreso/plantillas_nuevas_personas/person_".$id.".png";
