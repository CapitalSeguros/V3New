...
public function obtenerRenovacionesFecha($vendedor=null,$fechaI,$fechaF,$IDDocto=null,$status=null){    
...
//----------------------------------------------------------------------------------------------------
function polizas_emitidas_asesores(){ //funcion que devuelve de Sicas las polizas emitidas (reportes/operaciones/polizas).
