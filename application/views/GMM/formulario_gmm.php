...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones"><?=$titulo?> Siniestro de GMM</h3>
        </div>
...
<section class="container">
    <div style="float: left; width: 100%;">
        <div class="panel panel-default">
            <form action="<?= base_url() ?>GMM/AccionesGMM" method="POST" id="form_gmm" name="form_gmm" data-toggle="validator" autocomplete="off">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input  type="text" class="form-control" id="telefono_asegurado" name="telefono_asegurado" placeholder="Telefono" value="<?=isset($poliza['Telefono1'])?(json_encode($poliza['Telefono1'])):''?>" readonly />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                   ...
                   <!--  <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4" id="g_fecha_aviso">
                            <div class="form-group">
                                ...
                                <input  type="date" class="form-control" id="fecha_aviso" name="fecha_aviso" placeholder="Fecha del aviso" max="<?=$fecha?>" value="<?=isset($registro[0]['inicio_ajuste'])?date("Y-m-d", strtotime($registro[0]['inicio_ajuste'])):''?>" />
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input  type="text" class="form-control" id="responsable" name="responsable" placeholder="Usuario Responsable" value="<?=isset($complemento['general']->usuario_responsable)?$complemento['general']->usuario_responsable:$usuario?>" readonly />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input onkeyup="javascript:this.value=this.value.toUpperCase();"  type="text" class="form-control" id="titular" name="titular" placeholder="Titular" value="<?=isset($complemento['general']->titular)?$complemento['general']->titular:''?>" />
                                <span class="error" id="e_titular"></span>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Inciso</label>
                                <input onkeyup="javascript:this.value=this.value.toUpperCase();"  type="text" class="form-control" id="inciso_u" name="inciso_u" placeholder="Inciso" value="<?=isset($complemento['general']->inciso)?$complemento['general']->inciso:'01'?>" />
                                <span class="error" id="e_inciso_u"></span>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Certificado</label>
                                <input onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" id="certificado" name="certificado" placeholder="Certificado" value="<?=isset($complemento['general']->certificado)?$complemento['general']->certificado:''?>" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Afectado</label>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <!-- <input onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" id="parentesco" name="parentesco" placeholder="Parentesco" value="<?=isset($complemento['general']->parentesco)?$complemento['general']->parentesco:''?>" /> -->
                                <select name="parentesco" id="parentesco" class="form-control">
                                    <option value="">Seleccione uno</option>
                                    <?php foreach($parentescos as $value): ?>
                                        <option value="<?=$value['nombre'] ?>" <?=$value['nombre']==isset($complemento['general']->parentesco)?'selected':''?>><?=$value['nombre'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <span class="error" id="e_parentesco"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <strong><p>Datos del coordinador</p><hr></strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <strong><p>Datos del envio de correo</p><hr></strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Correo electrónico</label>
                                <input type="text" class="form-control" id="correo_asegurado_notificacion" name="correo_asegurado_notificacion" placeholder="Correo asegurado notificación" value="<?=isset($registro[0]['correo_asegurado_notificacion'])?$registro[0]['correo_asegurado_notificacion']:''?>" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script src="<?=base_url()?>assets/gap/js/registro_gmm.js"></script>
<script>
$(document).ready(function(){
    <?php if(isset($registro[0]['id_siniestro'])) : ?>
        $('select[name=tipo_tramite]').val(<?=$registro[0]['tipo_tramite']?>);
        $('select[name=estatus_siniestro]').val('<?=$registro[0]['siniestro_estatus']?>');
        $('select[name=tipo_poliza]').val('<?=$registro[0]['tipo_poliza']?>');
    <?php endif; ?>
