...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Tipos de padecimientos</h3>
        </div>
        ...
        <form id="form_cobertura" action="<?= base_url() ?>GMM/AccionesTiposCobertura" method="POST" autocomplete="off">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalLabel">Tipo de padecimiento</h4>
                            ...
                            <div class="col-md-12">
                                <div>
                                    <div class="media-body">
                                        <h4 class="media-heading"  style="padding-left: 15px;"><strong>Padecimiento: ${row.nombre}</strong></h4>
                                        <div class="Siniestro-body">
                                            <div class="box first" style="padding-left: 15px;"> Descripcion: ${row.descripcion}</div>
                                            <div class="box first" style="padding-left: 15px;"> Tipo: ${row.Tipo}</div>
                                        </div>
                                    </div>
                                </div>  
                            </div>     
