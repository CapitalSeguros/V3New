...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.css">
 ...
 <div style="margin-left: 2%;padding-top: 1%;"><h4>Cobranza Efectuada</h4></div>
	<div class="well" style="width: 100;">
		<table style="width: 40%">
			<tr>
				<td><b><i class="fa fa-tag"></i>Total Cobranza Efectuada: </b> <?php echo ($totalEfectuadaPagado);?></td>
			</tr>
		</table>	
	</div>
<div>
	 <table class="table table-responsive table-hover" id="table_id_efectuada" style="font-size: 10px;width: 100%">
		<thead>
			<tr>
				<th>ID_Recibo</th>
				<th>Documento</th>
		...
		<tbody>
			<?php 
				$ct=0;
				foreach($efectuadaCobranza as $rowCP){
				 	$ct++;
			?>
			<tr>
