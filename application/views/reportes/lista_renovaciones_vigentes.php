...
<button type="button" class="btn btn-primary" name="button" id="button" onclick="exportTableToExcel('reporte_vigente')" style="border-radius: 8px;"><i class="fa fa-file-text"></i> Exportar</button>
</div>
...
<div class="panel-body">
	...
	<table style="width: 100%">
		<tr>
			<td><span><i class="fa fa-th-list"></i> Status de polizas: </span><b>VIGENTES</b></td>
		</tr>
	</table>
</div>
