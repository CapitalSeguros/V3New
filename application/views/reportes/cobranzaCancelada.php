...
<?= link_tag('assets/css/reportesGenericoV1.css'); ?>
<script type="text/javascript">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-7 col-xs-7">
				<ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a>Cob. Cancelada</a></li>
                </ol>
            </div>
        </div>
		<hr /> 
	...
	<section class="container-fluid"><!-- container-fluid -->
		...
		<div class="row">
			<form action="<?=base_url();?>cobranzaCancelada/traeDatos" method="POST" class="form">
				...
				<div class="col-sm-4 col-md-4">
					<div class="form-group">
						...
						<button type="submit" class="btn btn-primary" name="button" id="button" value="Exportar" onclick="descargarExcel('0','CobCan')" style="border-radius: 8px;"><i class="fa fa-file-text"></i> Exportar</button>
					</div>
				</div>
			</form>
		</div><!-- /row -->
	...
	?>
		<div class="row">
        	<div class="col-sm-4 col-md-4">
				<div class="form-group">
					<div id="filtro" style="display:inline"></div>
