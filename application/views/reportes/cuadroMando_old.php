...
function getDiasHabiles($fechainicio, $fechafin, $diasferiados = array()) {
   ...
   //Fin de Modificacion
    ...
    //Porcentajes de rotacion
    $RotComercial=(($rotacionComercial[0]-$rotacionComercial[1])/$rotacionComercial[2])*100;
    $RotOperativo=(($rotacionOperativo[0]-$rotacionOperativo[1])/$rotacionOperativo[2])*100;
    $RotAdministrativo=(($rotacionAdministrativo[0]-$rotacionAdministrativo[1])/$rotacionAdministrativo[2])*100;
    $RotGerencial=(($rotacionGerencial[0]-$rotacionGerencial[1])/$rotacionGerencial[2])*100;
    $RotOperativoCorporativo=(($rotacionOperativoCorporativo[0]-$rotacionOperativoCorporativo[1])/$rotacionOperativoCorporativo[2])*100;
    $RotOperativoFianzas=(($rotacionOperativoFianzas[0]-$rotacionOperativoFianzas[1])/$rotacionOperativoFianzas[2])*100;
    $RotTodos=(($rotacionTodos[0]-$rotacionTodos[1])/$rotacionTodos[2])*100;
?>
<style type="text/css">
#loader {
    position: fixed;
...
<?php if($usermail!="GERENTEOPERATIVO@AGENTECAPITAL.COM"){
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="well">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="glyphicon glyphicon-indent-right"></i> Porcentaje de Rotación <?php echo mesLetra(date('m')).", ".date('Y');?>
                    </div>
                    <div id="grafico" style="width: 100%;height:auto;padding: 1%;">
                ...
                <div class="well" style="background-color: #fff;">
                     <table style="width: 100%;" border="0">
                         ...
                         <tbody>
                            <tr>
                                 <td>&nbsp;Todos</td>
                                 <td style="text-align: center;"><?php echo $RotTodos;?></td>
                             </tr>
                             <tr>
                                 <td>&nbsp;Comercial</td>
                                 <td style="text-align: center;"><?php echo $RotComercial;?></td>
                             </tr>
                              <tr>
                                 <td>&nbsp;Operativo</td>
                                 <td style="text-align: center;"><?php echo $RotOperativo;?></td>
                             </tr>
                              <tr>
                                 <td>&nbsp;Administrativo</td>
                                 <td style="text-align: center;"><?php echo $RotAdministrativo;?></td>
                             </tr> 
                             <tr>
                                 <td>&nbsp;Gerencial</td>
                                 <td style="text-align: center;"><?php echo $RotGerencial;?></td>
                             </tr>
                              <tr>
                                 <td>&nbsp;Operativo Coorportivo</td>
                                 <td style="text-align: center;"><?php echo $RotOperativoCorporativo;?></td>
                                
                             </tr>
                              <tr>
                                 <td>&nbsp;Operativo Fianzas</td>
                                <td style="text-align: center;"><?php echo $RotOperativoFianzas;?></td>
                             </tr>
                         </tbody>
                     </table>
                     </div>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['Puntualidad', 'Prestamos', 'Vacaciones', 'Permisos','Incapacidad','Cambio Puesto','Ajuste Sueldo','Calificacion','Capacitaciones'],
        datasets: [{
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['Todos','Comercial', 'Operativo', 'Administrativo', 'Gerencial','Operativo Coorporativo','Operativo Fianzas'],
        datasets: [{
            label: '% de Rotación: <?php echo mesLetra(date('m')).', '.date('Y');?>',
            data: [<?php echo $RotTodos;?>,<?php echo $RotComercial;?>,<?php echo $RotOperativo;?>,<?php echo $RotAdministrativo;?>,<?php echo $RotGerencial;?>,<?php echo $RotOperativoCorporativo;?>,<?php echo $RotOperativoFianzas;?>],
            backgroundColor: [
                'rgba(255, 99, 50, 0.6)',
                'rgba(255, 206, 86, 0.6)',
                'rgba(54, 162, 235, 0.6)',
