...
<button type="button" class="btn btn-primary" name="button" id="button" onclick="exportTableToExcel('reporte_norenovada')" style="border-radius: 8px;"><i class="fa fa-file-text"></i> Exportar</button>
</div>
...
<div class="panel-body">
	...
	<table style="width: 100%">
		<tr>
			<td><span><i class="fa fa-th-list"></i> Status de polizas: </span><b>NO RENOVADAS</b></td>
		</tr>
	</table>
</div>
<div style="width:1800;height: 30px;border:solid;overflow:hidden;" id="scrollCabecera2">
...
<div onscroll="moverScroll()" id="scrollTabla2" style="width:1000;overflow-x:scroll;overflow-y: scroll;height: 250px;border:solid;">
