...
<div class="divMenu">
 <div>
 	<div  class="divMenuBoton" >     
       ...
       <label  for="archivoProc"  >Recibo</label> 
 	...
 	<div class="divMenuBoton"> <form id="formDocumentoComprobante" action="javascript: enviarArchivoAJAX('formDocumentoComprobante','subirComprobante')" style="display: inline-flex;">
       <label  for="archivoProc"  >Comprobante</label> 
 	...
 	<div class="divMenuBoton" ><label onclick="enviarCorreos('','cbSeleccionCP','bodyTablaCobPen')">Correo-Pendientes</label></div>
 	<div class="divMenuBoton" ><label onclick="enviarCorreos('','cbSeleccionCA','bodyTablaCobAtrasada')">Correo-Atrasados</label></div>
 	<div class="divMenuBoton ocultarObjeto"  ><label onclick=" borraReciboPagado()">Borrar</label></div>
 	<div class="divMenuBoton" ><label onclick="agregarComentario('')">Agregar comentario</label></div>
 	<div class="divMenuBoton" ><label onclick="enviarWhats('')">Whats</label></div>
 	<div class="divMenuBoton" ><label onclick="exportarExcel('')">Exp. Cob. Pen.</label></div>
...
<div class="container">
	...
	<label>Cobranza:<select class="form-control" name="opcion" value="institucional">
		<option value="merida" <? if($opcion=='merida'){echo('selected="selected"' ) ;} ?> >Merida</option>
		<option value="institucional" <? if($opcion=='institucional'){echo('selected="selected"')  ;} ?> >Canal Institucional Merida</option>
		<option value="cancun"  <? if($opcion=='cancun'){echo('selected="selected"')  ;} ?>>Institucional Cancun</option>
		<option value="fianzas"  <? if($opcion=='fianzas'){echo('selected="selected"')  ;} ?>>Fianzas</option>
		<option value="grupocer"  <? if($opcion=='grupocer'){echo('selected="selected"')  ;} ?>>Grupo CER</option>
		<option value="grupoflotillas"  <? if($opcion=='grupoflotillas'){echo('selected="selected"')  ;} ?>>Grupo Flotillas</option>
		<option value="todos" <? if($opcion=='todos'){echo('selected="selected"')  ;} ?>>Todos</option>
	</select></label>
    <label>Fecha:<select name="opcionFecha" class="form-control">
    	...
    	<label>Fecha incial:<input type="text" name="fechaInicial" class="form-control fechaBusqueda" id="fechaInicial" autocomplete="off"></label><label>Fecha final:<input type="text" name="fechaFinal" id="fechaFinal" class="form-control fechaBusqueda" autocomplete="off"></label>
...
<div class="contMenuFlotanteMinimizado" id="divMenuFlotante"><div><button class="buttonContMenuFlotante" onclick="maxminContMenuFlotante()"></button></div><hr><div><h3 id="labelNombreClienteMF"></h3><div><button onclick="verOcultarPanel(0)" class="btn btn-primary">Documentos</button><button onclick="verOcultarPanel(1)" class="btn btn-primary">Alta Tarjeta</button><button onclick="verOcultarPanel(2);mostrarTarjeta('')" class="btn btn-primary">Tarjetas</button><button onclick="verOcultarPanel(3);mostrarHistorial('')" class="btn btn-primary">Historial</button><button onclick="verOcultarPanel(4);mostrarComentarios('')" class="btn btn-primary">Comentarios</button></button><button onclick="verOcultarPanel(5)" class="btn btn-primary">Pago</button></div><hr>
<div class="panelMenuFlotante" id="divLinksDocumentos" name="panelMenuFlotante"></div><div class="panelMenuFlotante ocultarObjeto" id="divTarjetaClienteAlta" name="panelMenuFlotante">
		...
		<table class="table">
		<tr>
		<td align="left"><label>Numero de Tarjeta:</label></td>
	    ...
	    <tr>
         ...
         <tr>
		<td align="left"><label>Año:</label></td>
		<td>
         ...
         <tr>
         <td align="left"><label>Codigo de seguridad:</label></td>
         ...
         <tr>
         <td align="left"><label>Titular de la Tarjeta</label></td>
        ...
        <tr>
         <td align="left"><label>Tipo de tarjeta:</label></td>
         <td><select id="tipoTarjeta" name="tipoTarjeta" class="form-control"><option value="Visa">Visa</option><option value="Master Card">Master Card</option>
         <option value="American express">American Express</option>
             </select>
           </td>
          </tr>
         <tr>
       <td align="left"><label>Banco Emisor</label></td>
       <td><input type="text" id="bancoTarjeta" name="bancoTarjeta" class="form-control input-sm" placeholder="Banco emisor"></td>
   </tr>
   <tr>
       <td align="left"><label>Tipo de Aplicacion de pago:</label></td>
       <td><select id="tipoPagoTarjeta" name="tipoPagoTarjeta" class="form-control input-sm">
       ...
       <tr>
          <td></td>
          <td align="right"><button class="btn btn-primary" onclick="guardarTarjeta('')">Guardar</button></td>
        </tr>
      </table>
  ...
  <div class="panelMenuFlotante ocultarObjeto" id="divTarjetaClientes" name="panelMenuFlotante">
  	...
  	<table class="table">
        ...
        <tr><td>Numero de tarjeta</td><td><input type="text" id="numeroTarjeta2" class="form-control"></td></tr>
        <tr><td>Vencimiento</td><td><input type="text" id="vencimiento2" class="form-control"></td></tr>
        <tr><td>Año</td><td><input type="text" id="anio2" class="form-control"></td></tr>
        <tr><td>Codigo de seguridad</td><td><input type="text" id="codigoSeguridad2" class="form-control"></td></tr>
        <tr><td>Titular de tarjeta</td><td><input type="text" id="titularTarjeta2" class="form-control"></td></tr>
        <tr><td>Tipo de tarjeta</td><td><input type="text" id="tipoTarjeta2" class="form-control"></td></tr>
        <tr><td>Banco</td><td><input type="text" id="banco2" class="form-control"></td></tr>
        <tr><td>Tipo de Pago</td><td><input type="text" id="tipoPagoTarjeta2" class="form-control"></td></tr>
        <tr><td colspan="2"><button class="btn btn-danger" onclick="cancelarTarjeta('')">Cancelar Tarjeta</button></td></tr>
  	</table>
  </div>
...
<table id="tablaExportar" border="2"></table>
...
function enviarWhats(datos){
	if(datos=="")
	{
	  ...
	  if(rowSeleccionado.length>0)
	  {
	     ...
	     var params =params+'&telefono='+rowSeleccionado[0].getAttribute('data-telefono');
	     ...
	     let nombre=rowSeleccionado[0].getAttribute('data-nombre');
            	// Celular:9993359531   Telefono1:9991271803  Telefono1:   9992009665:9992009665  Celular:999 3230718
    	//alert('Escoger poliza para el envio del whats');
    	let celular='Celular:9993359531';//rowSeleccionado[0].getAttribute('data-telefono').replace(' ','');
    	if(celular!='')
    	{  
              if(rowSeleccionado[0].getAttribute('data-href')==""){alert('No hay un recibo para enviar'); return 0;}
    	        var params =params+'&linkLargo='+'www.googl.com';
    	  ...
    	  else
    	  {
           ...
           if(dato.length==2)
           {
              if(dato[0].toUpperCase()=='CELULAR') 
              {
              	...
              	else{alert('No se pudo procesar el envio reportarlo a sistemas') ; }
              }
              else
              {
              	if((parseInt(dato[1]))==dato[1])
       ...
       else {alert("Para guardar un whats necesitas escoger una recibo con numero de celular");}
      }
...
function aplicarPago(datos)
{
  ...
  params=params+'&Fpago='+document.getElementById('textFecPago').value;  
    ...
    params=params+'&TCDocto='+document.getElementById('selectMonedaDocto').value;
...
function imprimirCobranzaPendiente($cobranzaPendiente,$classNombre,$idBody,$filtros,$opcionFecha){
            ...
            document.getElementById('bodyTablaCobPen').rows[respuesta.rowIndex].cells[2].classList.add('divSDCP');	 
	 	    ...
	 	    document.getElementById('bodyTablaCobPen').rows[respuesta.rowIndex].setAttribute('data-class','divSDCP');
              ...
              { let bandEntrada=0;
                ...
                /* if(respuesta.children[i].isFolder)
                 {
            
                    
                    if(('Recibo_'+respuesta.serie)===respuesta.children[i].text){
                    	banderaFolderRecibo=1;
                    	 banderaCierre=1;
                    	cadena=cadena+'<li class="liArchivos"><ul class="ulDocumentos" ><div class="iconocarpetasub"><label><h4>'+respuesta.children[i].text+'</h4></label></div>'
                    	bandRecibo1="divConDocRecibo";
                    	bandRecibo2="divCDRCP";                    	
                    }
                    else{banderaFolderRecibo=0;}

                 }
                 else
                 {  
                  let clase="";                          	                        	
                  if(idRecibo_periodo==respuesta.children[i].text){dataHref=respuesta.children[i].href;}
                  if(banderaFolderRecibo===1)
                  {
                 	let extension=respuesta.children[i].href.split('.').pop();                 	
                 	extension=extension.toUpperCase();                 	
                 	switch(extension)
                    ...
                    cadena=cadena+'<li class="liArchivos"><div class="'+clase+' iconogenerico"><a href="'+respuesta.children[i].href+'" target="_blank" >'+respuesta.children[i].text+'</a><button class="btn btn-primary btnEmail" href="'+respuesta.children[i].href+'" onclick="">Enviar Email</button></div></li>';   
                  }           
                 }*/
...
if(navigator.userAgent.indexOf('Chrome')>-1 || navigator.userAgent.indexOf('Safari')>-1 || navigator.userAgent.indexOf('OPR')>-1){
  ...
  tableHTML = '<table id="miTabla" border="2">'+tableSelect.innerHTML+'</table>';    	
}
...
.divConDocRecibo{width: 25px; height:25px;background: url(<?echo(base_url().'assets/images/iconocarpetarecibo.png') ;?>) no-repeat;}
...
.divMenuBoton > label{min-width:50;min-height: 50px;width: 70px;height: 50px;background: #00b900; text-align: center;color: white}
.divMenuBoton > form > label,input{min-width:50;width: 70px;height: 50px;background: #00b900; text-align: center; color:white;}
