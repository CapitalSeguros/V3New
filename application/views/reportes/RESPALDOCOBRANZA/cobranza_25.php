...
<div class="contMenuFlotanteMinimizado" id="divMenuFlotante"><div><button class="buttonContMenuFlotante" onclick="maxminContMenuFlotante()">&#128070</button></div><hr><div><h3 id="labelNombreClienteMF"></h3><div><button onclick="verOcultarPanel(0)" class="btn btn-primary">DOCUMENTOS</button><button onclick="verOcultarPanel(1)" class="btn btn-primary">ALTA TARJETA</button><button onclick="verOcultarPanel(2);mostrarTarjeta('')" class="btn btn-primary">TARJETAS</button><button onclick="verOcultarPanel(3);mostrarHistorial('')" class="btn btn-primary">HISTORIAL</button><button onclick="verOcultarPanel(4);mostrarComentarios('')" class="btn btn-primary">COMENTARIOS</button></button><button onclick="verOcultarPanel(6)" class="btn btn-primary">SOLIC. DE COBRO</button></button>
 ...
 <div class="panelMenuFlotante"  id="divSolicitudDeCobro" name="panelMenuFlotante">
            ...
            <div class="row">
             ...
             <div class="col-md-3 col-sm-3">
             	<button onclick="GuardarSolicitudDeCobro('')" class="btn btn-danger btn-xs">Guardar Solicitud</button>
             	
             	
             </div>
             <div class="col-md-3 col-sm-3"><button  class="btn btn-warning btn-xs" onclick="cambiarStatus('',1)">Pasar Agente</button></div>
             	<div class="col-md-3 col-sm-3"><button  class="btn btn-warning btn-xs" onclick="cambiarStatus('',5)">Pasar Ejecutivo</button></div>
