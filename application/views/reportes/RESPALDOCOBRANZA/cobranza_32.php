      ...
      console.log(respuesta);
       ...
       let cantidad=respuesta.children.length;
              ...
              { let bandEntrada=0;
               ...
               console.log(document.getElementById('bodyTablaCobPen').rows[respuesta.rowIndex]);
            ...
            document.getElementById('bodyTablaCobPen').rows[respuesta.rowIndex].cells[2].classList.add('divSDCP');	 
	 	    ...
	 	    document.getElementById('bodyTablaCobPen').rows[respuesta.rowIndex].setAttribute('data-class','divSDCP');
              ...
              { let bandEntrada=0;
                 ...
                 //{
                   let clase="";
                 	let extension=respuesta.children[t].href.split('.').pop();                 	
                 	extension=extension.toUpperCase();                 	
                 	switch(extension)
                 	{
                 		case 'PDF':clase='iconopdf';break;
       ...
       var respuesta=JSON.parse(this.responseText); 
	 	...
	 	else
	 	{
             let cantidad=respuesta.children.length
               ...
               let banderaCierre=0;
               let banderaFolderRecibo=0;    
               console.log(respuesta.children);          
              for(let i=0;i<cantidad;i++)
              { let bandEntrada=0;
                 ...
                 //{ 
                   ...
                   let clase="";
                   console.log(respuesta.children[i]);
