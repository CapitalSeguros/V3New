...
<div class="divMenuBoton" ><label onclick="enviarWhats('')">Whats</label></div>
	...
	<?}else{?>
<div class="divMenuBoton" ><label style="background-color: #c1bdbd" title="No tienes saldo">Whats</label></div>
 	<div class="divMenuBoton" ><label  style="background-color: #c1bdbd" title="No tienes saldo">SMS</label></div>
