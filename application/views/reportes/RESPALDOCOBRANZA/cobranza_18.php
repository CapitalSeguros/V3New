...
<?}?>
 ...
 <?if($this->tank_auth->get_usermail()=="SISTEMAS@ASESORESCAPITAL.COM" || $this->tank_auth->get_usermail()=="DIRECTORGENERAL@AGENTECAPITAL.COM" || $this->tank_auth->get_usermail()=="AUDITORINTERNO@AGENTECAPITAL.COM") {?>
  <div class="divMenuBoton" ><button id="btnBuscarPoliza" onclick="buscarPoliza('')">Buscar Poliza</button>
    ...
    <div class="divMenuBoton" ><button id=	"btnBuscarPoliza" onclick="buscarPorCliente('')">Buscar por Cliente</button>
 	    ...
 	    <div class="divMenuBoton" ><button id="btnBuscarPoliza" onclick="cerrarModal('divModalParaFacturar')">Cancelacion</button>
...
function traerRecibosPagados(datos)
{
...

	{
		  	...
		  	let cantDatos=datos.TableInfo.length;
  	let tabla='<table class="table"><tr colspan="6" ><td align="left"></td></tr>';
