 ...
 <div>
 	<div  class="divMenuBoton" >     
       ...
       <label  for="archivoProc" id="labelArchivoProc"  >Recibo</label> 
         <input type="file"  name="DocumentoFiles" class="btnLateralCobranza" id="DocumentoFilesRecibo" onchange="if(!this.value.length)return false;document.getElementById('formDocumentoRecibo').submit();" style="opacity: 0; position: relative; left: -70px "/>
 	...
 	<div class="divMenuBoton"> <form id="formDocumentoComprobante" action="javascript: enviarArchivoAJAX('formDocumentoComprobante','subirComprobante')" style="display: inline-flex;">
       <label  for="archivoProc"  id="labelArchivoComprobante">Comprobante</label> 
         <input type="file"  name="DocumentoFiles" id="DocumentoFiles" class="btnLateralCobranza" onchange="if(!this.value.length)return false;document.getElementById('formDocumentoComprobante').submit();" style="opacity: 0;position: relative; left: -70px  "/>
...
<? if($idVendedor==0){?>
 	<div class="divMenuBoton" ><button id="btnWhats" class="btnLateralCobranza" onclick="enviarWhats('')">Whats</button></div>
...
<div class="container">
	...
	<ul class="tabs">
		...
		<li class="tab-link" data-tab="tab-3"><h4 style="font-size: 16px;">ACTIVIDADES</h4></li>
		<!--***Miguel 22/01/2021-->
		<?php
		if($this->tank_auth->get_userprofile() == "2" || $this->tank_auth->get_userprofile() == "3" || $this->tank_auth->get_userprofile() == "4"){
		?>
                 <li class="tab-link" data-tab="tab-4" onclick="abrirReporte()"><h4 style="font-size: 16px;">REPORTE COBRANZA</h4></li>
		<li class="tab-link" data-tab="tab-5" onclick="abrirReporteKPI()"><h4 style="font-size: 16px;">REPORTE COBRANZA KPI</h4></li>
		<?php }?>
...
<div>
<button onclick="ventanaSolicitudDeCobro()">Solicitud de Cobro</button>
</div>
</div>
...
<!-- MIGUEL 16/09/2020-->
<div id="tab-4" class="tab-content"><div id="pantalla"></div></div>
<div id="tab-5" class="tab-content"><div id="pantallaKPI"></div></div>
<div id="tab-6" class="tab-content">
	...
	<div class="row">
		...
		<button class="btn btn-primary" onclick="polizaNoRenovada()">No Renovar</button>
      ...
      <table border="1" id="">
	    <thead>
		  <tr valign="top">
			...
			<!--th class="divTD25"></th-->
			<!--th class="divTD100 ocultarObjeto">Recibo</th-->
			<!--th class="divTD75"><div>Periodo</div><div></div></th>
			<th class="divTD150"><div>Endoso</div><div></div></th-->
			...
			<!--th class="divTD125"><div><?=$opcionFecha ?></div><div></div></th>
			<th class="divTD125"><div>Compania</div><div></div></th>
			<th class="divTD125"><div>Conducto</div><div></div></th>
			<th class="divTD125">Prima total</th>
			<th class="divTD150">Pref. Comunic.</th>
			<th class="divTD150">Hr. Comunic.</th>
			<th class="divTD150">Dia Comunic.</th-->
 ...
 <div id="divModalSolicitudDeCobro" class="modalCierraCont">
 	<div style="display: flex;flex-direction: column; position: relative;top:20%;left: 25%;width: 50%">
    	...
    	<div><button onclick="cerrarModal('divModalSolicitudDeCobro')"  style="color: white;background-color:red; border:double;position: relative;width: 30px; height: 5px">X</button></div>
       	...
       	<div  id="divSolicitudDeCobro" class="cssRenovacionPoliza">
       		<div class="row">
       		 <div class="col-md-3 col-sm-3"><label>Aplicacion de Pago</label></div>
       		 <div class="col-md-1 col-sm-1"><input type="checkBox" name="checkSolicitudDeCobro" value="0"></div>
       		 <div class="col-md-6 col-sm-6"><input type="text" id="comentarioSolicitudDeCobro0" style="text-align: left" placeholder="agregar comentario"></div>
       		</div>
       		<div class="row">
       		<div class="col-md-3 col-sm-3"><label>Rehabilitacion de poliza</label></div>
       		<div class="col-md-1 col-sm-1">	<input type="checkBox" name="checkSolicitudDeCobro" value="1" ></div>
          	<div class="col-md-6 col-sm-6">		<input type="text" id="comentarioSolicitudDeCobro1" style="text-align: left" placeholder="agregar comentario"></div>
            </div>
            <div class="row">
       		<div class="col-md-3 col-sm-3"><label>Cobro de recibo</label></div>
       		<div class="col-md-1 col-sm-1">	<input type="checkBox" name="checkSolicitudDeCobro" value="2" ></div>
       		<div class="col-md-3 col-sm-3">	<input type="text" id="comentarioSolicitudDeCobro2" style="text-align: left" placeholder="agregar comentario"></div>
       	   </div>
       	   <div class="row">
             
       		<div class="col-md-3 col-sm-3"><label>Solicitud de referencia</label></div>
       		<div class="col-md-1 col-sm-1"><input type="checkBox" name="checkSolicitudDeCobro" value="3" ></div>
       		<div class="col-md-6 col-sm-6"><input type="text" id="comentarioSolicitudDeCobro3" style="text-align: left" placeholder="agregar comentario"></div>       		
       	</div>

       		
       		<div class="row">
             <div class="col-md-3 col-sm-3"><button onclick="GuardarSolicitudDeCobro('')" class="btn btn-danger btn-xs">Guardar Solicitud</button></div>
         </div>
...
<div class="alerta" id="alerta">
    <div class="notificacion">
        <i class="fa fa-bell"></i>Notificaciónes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#" onclick="cerrarAlerta()" class="cerrar"><i class="fa fa-times-circle fa-2x"></i></a>
    </div>
    <div class="cobranzaEfectuada"><div class="badge badge-success"><?php echo $getAllCobranzaEfectuada;?></div>&nbsp;Cobranza Efectuada</div>
    <div class="cobranzaPendiente"><div class="badge badge-success"><?php echo $getAllCobranzaPendiente;?></div>&nbsp;Cobranza Pendiente</div>
    <div class="cobranzaAtrasada"><div class="badge badge-success"><?php echo $getAllCobranzaAtrasada;?></div>&nbsp;Cobranza Atrasada
	</div>
    <div class="renovacionPendiente"><div class="badge badge-success"></div>&nbsp;Renovaciones
        <div id="infoRenovacionDiv" class="renovPendRow" style="display: block;overflow: scroll;color: red;height: 80px;font-size: 9px"></div>
    </div>
</div>
...
function ventanaRenovacion()
{
  ...
  {	
   ...
   //document.getElementById('spanNombreAgente').value=clase[0].getAttribute('');
...
setInterval("buscarComentariosRenovacion('')",30000);
...
function GuardarSolicitudDeCobro(datos='')
{
  ...
  let cadena='';
   ...
   if(cadena==''){cerrarModal('divModalSolicitudDeCobro');}
   	else
   	{
   		let params='datos='+cadena+'&idDocto='+iddoctoSolicitudComentario.value+'&idRecibo='+idreciboSolicitudComentario.value+'&documento='+documentoSolicitudComentario.value;
  ...
  {
  	let cadena=datos.documento+'<br>'+'<button class="btn-chico" onclick="traerComentarioSolicitudCobro(\'\','+datos.idDocto+',\''+datos.documento+'\')">&#9998</button>';
...
if((int)$cobranzaPendiente->TableControl->MaxRecords>0)
 {
  foreach ($cobranzaPendiente->TableInfo as  $value) {
     ...
     {      
  	...
  	if($value->cobranzaConSolicitud>0 || $value->cobranzaSinSolicitud>0 || $value->cobranzaComenatarios>0){$btnSolCobranza='<button class="btn-chico" onclick="traerComentarioSolicitudCobro(\'\','.$value->IDDocto.',\''.$value->Documento.'\')">&#9998</button>';}
   ...
   $info.='<td class="divTD150"   data-value="'.$value->Documento.'">'.$value->Documento.'<br>'.$btnSolCobranza.'</td>';
...
function aplicarFiltro(objeto,tabla,select,clase){	
	...
	for(let i=0;i<totalRows;i++){
		if(tablaFiltro.rows[i].getAttribute('data-value')!='-1'){
...
function traerComentarioSolicitudCobro(datos='',idDocto='',documento='')
{
  if(datos=='')
  {
   var params = 'idDocto='+idDocto;
  ...
  else
  {
   ...
   tabla=tabla+'</table>';
   divComentariosSCContenido.innerHTML=tabla;
...
function manejoDeTabs(tab_id)
{
        ...
        switch(tab_id)
        {
        	...
        	break;
        	case 'tab-2':bodyTableComentario='';;break;
        	case 'tab-3':bodyTableComentario='';;break;
        	case 'tab-5':bodyTableComentario='bodyTablaRenovaciones';break;
        	case 'tab-6':              
...
function abrirReporte(){
    ...
    ajax=objetoAjax();   
    var URL=document.getElementById('base').value+"cobranza/reporteCobranza";
    ajax.open("GET", URL);
...
function abrirReporteKPI(){
 	divResultado = document.getElementById('pantallaKPI'); 
    ajax=objetoAjax();   
    var URL=document.getElementById('base').value+"cobranza/reporteCobranzaKPI";
    ajax.open("GET", URL);
    ajax.onreadystatechange=function() {
        if (ajax.readyState==4) {
           divResultado.innerHTML = ajax.responseText
...
function abrirConsulta(){
	...
	var fCorte=document.getElementById('fCorte').value;
 	divResultado = document.getElementById('pantalla'); 
    ajax=objetoAjax();   
    var URL=document.getElementById('base').value+"cobranza/reporteCobranza?fIni="+fIni+"&fFin="+fFin+"&fCorte="+fCorte;
    ajax.open("GET", URL);
    ajax.onreadystatechange=function() {
        if (ajax.readyState==4) {
           divResultado.innerHTML = ajax.responseText
...
function abrir_pestania_reporte_cobranza(){
     document.getElementById('cobranza').style.display='block';
     document.getElementById('reporte').style.display='none';    
}

function abrir_pestania_reporte(){
    document.getElementById('cobranza').style.display='none';
    document.getElementById('reporte').style.display='block';
 } 

function consultaKpi(){
	var fechInicial=document.getElementById('fechInicial').value;
	var fechFinal=document.getElementById('fechFinal').value;
	divResultado = document.getElementById('pantallaKPI'); 
    ajax=objetoAjax();   
    var URL=document.getElementById('base').value+"cobranza/reporteCobranzaKPI2?fechInicial="+fechInicial+"&fechFinal="+fechFinal;
    ajax.open("GET", URL);
    ajax.onreadystatechange=function() {
        if (ajax.readyState==4) {
           divResultado.innerHTML = ajax.responseText
...
function cerrarDivRojo(){
	document.getElementById('divRojo').style.display='none';
}

function cerrarDivAmarillo(){
	document.getElementById('divAmarillo').style.display='none';
}

function cerrarDivNegro(){
	document.getElementById('divNegro').style.display='none';
}

function mostrarDivTodo(){
...
function mostrarDivNegro(){
	document.getElementById('todos').style.display='none';
	document.getElementById('divAmarillo').style.display='none';
	document.getElementById('divRojo').style.display='none';
	document.getElementById('divNegro').style.display='block';
}
function imprimirReporte(tabla){
...
//****************************
<?
  /*if($cargaAutomatica==2){echo('document.getElementById("formCobranzaPendiente").submit();');}
  else{echo('traerRenovaciones("");');}*/
?>
traerRenovaciones('');
</script>
 <style type="text/css">
