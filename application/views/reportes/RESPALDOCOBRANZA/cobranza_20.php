...
<!-- Div de Notificaciones Flotante-->
<div class="alerta" id="alerta">
	...
	<div class="cobranzaAtrasada"><div class="badge badge-success"><?php echo $getAllCobranzaAtrasada;?></div>&nbsp;Cobranza Atrasada
        ...
        <div class="renovacionPendiente" id='estadisticasRenovaciones'><div class="badge badge-success"></div>&nbsp;Renovaciones
        <div id="infoRenovacionDivBorrar" class="renovPendRow" style="display: block;overflow: scroll;color: red;height: 80px;font-size: 9px"></div>
    </div>
</div>
<!--fin-->
<div class="divMenu">
 <div>
 	...
 	<div class="divMenuBoton"  ><button id="btnCorreoPendiente" onclick="enviarCorreos('','cbSeleccionCP','bodyTablaCobPen')">Correo</button></div>
<? if($idVendedor==0){?>
...
<?}?>
  ...
  <div class="divMenuBoton" ><button id="btnBuscarPoliza" onclick="buscarPoliza('')">Buscar Poliza</button>
    ...
    <div class="divMenuBoton" ><button id=	"btnBuscarPolizaCliente" onclick="buscarPorCliente('')">Buscar por Cliente</button>    	
 	</div>
    <div class="divMenuBoton" ><button id=	"btnRenovacion" onclick="ventanaRenovacion('')">Renovacion</button></div>
<?if($permisoCancelarCobranza==1) {?> 	    <div class="divMenuBoton" ><button id="btnBuscarPoliza" onclick="cerrarModal('divModalParaFacturar')">Cancelacion</button>

 	</div>
 <? } ?>
 <div class="divMenuBoton" ><button id=	"btnActividades">Actividades</button>
...
<div class="alerta" id="alerta">
    ...
    <div class="cobranzaEfectuada"><div class="badge badge-success"></div>&nbsp;Cobranza Efectuada</div>
    <div class="cobranzaPendiente"><div class="badge badge-success"></div>&nbsp;Cobranza Pendiente</div>
    <div class="cobranzaAtrasada"><div class="badge badge-success"></div>&nbsp;Cobranza Atrasada
    </div>
...
function ventanaCancelarRenovacion()
{
  ...
  {	
   ...
   //document.getElementById('selectVendedorRenovar').value=clase[0].getAttribute('data-idvend');
...
function mostrarComentariosRenovacion(datos,objeto=null)
{
	...
	else
	{
      ...
      let table='<table class="table"><tbody><tr><td colspan="4">'+datos.Documento+'</td></tr>';
      for(let i=0;i<cantDatos;i++)
      {
        table=table+'<tr><td>'+datos.datos[i].nombres+' '+datos.datos[i].apellidoPaterno+' '+datos.datos[i].apellidoMaterno+'</td><td>'+datos.datos[i].comentario+'</td><td>'+datos.datos[i].fecha+'</td><td>'+datos.datos[i].email+'</td></tr>';
      }
 ...
 req.open('POST', url, true);
   ...
   req.onreadystatechange = function (aEvt) 
  {
    ...
    if (req.readyState == 4) {    	
      ...
      if(req.status==500){alert('El proceso presento un error favor de notificar a sistemas error 006');}      
   }
...
function manejoDeTabs(tab_id)
{
        switch(tab_id)
        {
        	case 'tab-1':
             ...
             document.getElementById('btnBuscarPolizaCliente').removeAttribute('disabled');
             document.getElementById('btnBuscarPolizaCliente').removeAttribute('style');
             ...
             document.getElementById('btnAgregarComentario').removeAttribute('disabled');
             document.getElementById('btnAgregarComentario').removeAttribute('style');
             document.getElementById('btnRenovacion').setAttribute('disabled',true);
             document.getElementById('btnRenovacion').setAttribute('style','background-color: #c1bdbd');
             document.getElementById('btnActividades').setAttribute('disabled',true);
             document.getElementById('btnActividades').setAttribute('style','background-color: #c1bdbd');
        	...
        	case 'tab-2':
             ...
             document.getElementById('btnActividades').setAttribute('disabled',true);
             document.getElementById('btnActividades').setAttribute('style','background-color: #c1bdbd');
             document.getElementById('btnBuscarPolizaCliente').setAttribute('disabled',true);
             document.getElementById('btnBuscarPolizaCliente').setAttribute('style','background-color: #c1bdbd');
         ...
         document.getElementById('btnCorreoPendiente').setAttribute('disabled',true);             
            ...
            // document.getElementById('btnCorreoAtrasado').setAttribute('style','background-color: #c1bdbd');
             ...
             document.getElementById('btnAgregarComentario').removeAttribute('disabled');
             document.getElementById('btnAgregarComentario').removeAttribute('style');
             document.getElementById('btnRenovacion').removeAttribute('disabled');
             document.getElementById('btnRenovacion').removeAttribute('style');
            ...
            // document.getElementById('btnCorreoAtrasado').setAttribute('style','background-color: #c1bdbd');
             ...
             document.getElementById('btnRenovacion').removeAttribute('disabled');
             document.getElementById('btnRenovacion').removeAttribute('style');
             document.getElementById('btnActividades').removeAttribute('disabled');
             document.getElementById('btnActividades').removeAttribute('style');
             document.getElementById('btnBuscarPoliza').setAttribute('disabled',true);
             document.getElementById('btnBuscarPoliza').setAttribute('style','background-color: #c1bdbd');
             document.getElementById('btnBuscarPolizaCliente').setAttribute('disabled',true);
             document.getElementById('btnBuscarPolizaCliente').setAttribute('style','background-color: #c1bdbd');
