...
<div class="divMenu">
 <div>
 	...
 	<div class="divMenuBoton" ><label onclick="enviarSMS('','cbSeleccionCP','bodyTablaCobPen')">SMS</label></div>
 	<div class="divMenuBoton" ><label onclick="exportarExcel('')">Exp. Cob. Pen.</label>

 	</div>
  <div class="divMenuBoton" ><label onclick="buscarPoliza('')">Buscar Poliza</label>
...
<div class="container">
	...
	<label>Cobranza:<select class="form-control" name="opcion" value="institucional">
		...
		<option value="cancun"  <? if($opcion=='cancun'){echo('selected="selected"')  ;} ?>>Cancun</option>
		<option value="fianzas"  <? if($opcion=='fianzas'){echo('selected="selected"')  ;} ?>>Fianzas</option>
		<option value="grupocer"  <? if($opcion=='grupocer'){echo('selected="selected"')  ;} ?>>Institucional Corporativa<!--Grupo CER--></option>
		<option value="grupoflotillas"  <? if($opcion=='grupoflotillas'){echo('selected="selected"')  ;} ?>>Flotillas Institucionales</option>
...
function buscarPoliza(datos)
{
  ...
  else
  {
      ...
      tabla=tabla+'<tr ondblclick="agregarParaCobranzaEfectuada(this)" class="tablaBuscarPoliza" data-iddocto="'+datos.TableInfo[i].IDDocto+'" data-serie="'+datos.TableInfo[i].Serie+'" data-IDRecibo="'+datos.TableInfo[i].IDRecibo+'" data-email="'+datos.TableInfo[i].EMail1+'" data-periodo="'+datos.TableInfo[i].Periodo+'" data-nombre="'+datos.TableInfo[i].NombreCompleto+'" data-IDCli="'+datos.TableInfo[i].IDCli+'" data-documento="'+datos.TableInfo[i].Documento+'" data-idmon="'+datos.TableInfo[i].IDMon+'" data-moneda="'+datos.TableInfo[i].Moneda+'" data-primatotal="'+primaTotal+'" data-tcday="'+datos.TableInfo[i].TCDay+'" data-endoso="'+endoso+'" data-idendoso="'+datos.TableInfo[i].IDEnd+'" data-telefono="'+datos.TableInfo[i].Telefono1+'" >';
      ...
      tabla=tabla+'<td class="divTD150"><div class="divCell">'+datos.TableInfo[i].EMail1+'</div></td>';
      tabla=tabla+'<td class="divTD150"><div class="divCell">'+datos.TableInfo[i].Telefono1+'</div></td>';
