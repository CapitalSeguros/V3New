...
<div class="alerta" id="alerta">
    <div class="notificacion">
        <table width="100%">
            <tr>
                <td style="text-align: left;"><i class="fa fa-bell"></i>KPI Cobranza</td>
                <td style="text-align: right;"> <a href="#" onclick="cerrarAlerta()" class="cerrar"><i class="fa fa-times-circle fa-2x"></i></a></td>
            </tr>
            <tr style="font-size: 11px;">
                <td colspan="2" style="text-align: left;">
                    Desde: <b>01-<?=date('m-Y')?></b> Hasta: <b><?=date('d-m-Y')?></b></td>
                </td>
            </tr>
        </table>
    </div>
    <div class="cobranzaEfectuada"><div class="badge badge-success"><?php echo $semaforo_cobranza[2]?></div>&nbsp; >6 p/vencer </div>
    <div class="cobranzaPendiente"><div class="badge badge-success"><?php echo $semaforo_cobranza[1]?></div>&nbsp; <5 dias p/vencer</div>
    <div class="cobranzaAtrasada"><div class="badge badge-success"><?php echo $semaforo_cobranza[0]?></div>&nbsp; >10 dias vencida
    </div>
</div>
-->
