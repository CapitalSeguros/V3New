    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-7 col-xs-7">
            <ol class="breadcrumb text-right">
                ...
                <li class="active">Repositorio imagenes - Modificar imagenes</li>
            </ol>
        </div>
    </div>
    <hr /> 
...
?>
 ...
 <section class="page-section">
    <div class="container">
        ...
        <!-- -->
        <?php
            $ListaImagenesMkt = $this->capsysdre_imagenes->ListaImagenesMkt($row->idCategoria);
            if($ListaImagenesMkt){
            foreach($ListaImagenesMkt->result() as $rowImagenes){
        ?>
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-8">
                        <?=urldecode($rowImagenes->nombre)?>
                    </div>
                    <div class="col-sm-1 col-md-1">
                        <img class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/imagenes/".$rowImagenes->img_link?>" />
                    </div>
                    
                    <div class="col-sm-1 col-md-1">
                        <a href="<?=base_url()."imagenesMkt/imagenesEditar?idImagen=".$rowImagenes->idImagen?>" title="Editar">
                            <span class="glyphicon glyphicon-pencil"></span>
                        </a>
                        <a href="<?=base_url()."imagenesMkt/BorrarImagen?idImagen=".$rowImagenes->idImagen?>" title="Eliminar">
