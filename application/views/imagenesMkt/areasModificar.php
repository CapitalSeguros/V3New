	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-7 col-xs-7">
			<ol class="breadcrumb text-right">
                ...
                <li class="active">Repositorio imagenes - Modificar &Aacute;reas</li>
			</ol>
		</div>
	</div>
	<hr /> 
...
<section class="page-section">
	<div class="container">
      ...
      <div class="col-sm-1 col-md-1">
				<img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$row->img_link_portada?>" />
            </div>
			<div class="col-sm-1 col-md-1">
				<img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$row->img_link_color?>" />
            </div>
            <div class="col-sm-1 col-md-1">
				<img style="background-color: black;" class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$row->img_link_blanco?>" />
            </div>
			<div class="col-sm-1 col-md-1" style="text-align:center;">
            	<a href="<?=base_url()."imagenesMkt/areaEditar?idArea=".$row->idArea?>" title="Editar">
                	<span class="glyphicon glyphicon-pencil"></span>
                </a>
            	<a href="<?=base_url()."imagenesMkt/BorrarArea?idArea=".$row->idArea?>" title="Eliminar">
