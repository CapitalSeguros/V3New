	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-7 col-xs-7">
			<ol class="breadcrumb text-right">
                ...
                <li class="active">Repositorio imagenes - Editar &Aacute;reas</li>
			</ol>
		</div>
	</div>
	<hr /> 
...
<section class="page-section">
	<div class="container">
		...
		<form
        	...
        	name="formEdicionAreas" id="formEdicionAreas"
            method="post" enctype="multipart/form-data"
            action="<?=base_url();?>imagenesMkt/EdicionArea" 
        >
		<div class="row">
			<div class="col-sm-4 col-md-4">
                ...
                <input 
                    ...
                    value="<?=urldecode($ListaAreasImagenes[0]->nombre)?>"
                />
            </div>
			<div class="col-sm-3 col-md-3">
                ...
                <input 
                    ...
                    value="<?=$ListaAreasImagenes[0]->posicion?>"
                />
            </div>
            <div class="col-sm-5 col-md-5">
                <img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$ListaAreasImagenes[0]->img_link_portada?>" />
                <input
                    type="file"
			...
			<div class="col-sm-5 col-md-5">
				<img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$ListaAreasImagenes[0]->img_link_color?>" />
            	<input
            		type="file"
            ...
            <div class="col-sm-5 col-md-5" >
				<img style="background-color: black;" class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/areas/".$ListaAreasImagenes[0]->img_link_blanco?>" />
            	<input
            		type="file"
            ...
            <div class="col-sm-2 col-md-2">
            	<input
                    ...
                    value="<?=$ListaAreasImagenes[0]->idArea?>"
                />
				<input 
                	type="button"
                    value="Guardar" class="btn btn-primary btn-sm"
					onclick="document.formEdicionAreas.submit();"
				/>
                <!--
                <input
                	type="submit" 
