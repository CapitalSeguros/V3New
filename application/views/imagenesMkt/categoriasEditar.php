	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-7 col-xs-7">
			<ol class="breadcrumb text-right">
                ...
                <li><a href="<?=base_url()."imagenesMkt/categoriasModificar"?>">Repositorio imagenes - Modificar Categor&iacute;as</a></li>
                <li class="active">Repositorio imagenes - Editar Categor&iacute;as</li>
			</ol>
		</div>
	</div>
	<hr /> 
...
<section class="page-section">
	<div class="container">
		...
		<form
            ...
            action="<?=base_url();?>imagenesMkt/EdicionCategoria" 
        >
		<div class="row">
			<div class="col-sm-5 col-md-5">
                ...
                <input 
                    ...
                    value="<?=urldecode($ListaCategoriasImagenes[0]->nombre)?>"
                />
            </div>
			<div class="col-sm-1 col-md-1">
                ...
                <input 
                    ...
                    value="<?=$ListaCategoriasImagenes[0]->posicion?>"
                />
            </div>
			<div class="col-sm-5 col-md-5">
				<img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/categorias/".$ListaCategoriasImagenes[0]->img_link?>" />
            	<input
            		type="file"
            ...
            <div class="col-sm-1 col-md-1">
            	<input
                    ...
                    value="<?=$ListaCategoriasImagenes[0]->idCategoria?>"
                />
				<input 
                	type="button"
