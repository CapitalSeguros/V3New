    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-7 col-xs-7">
            <ol class="breadcrumb text-right">
                ...
                <li class="active">Repositorio imagenes - Agregar Categor&iacute;as</li>
            </ol>
        </div>
    </div>
    <hr /> 
...
<section class="page-section">
	<div class="container">
		...
		<form
            ...
            action="<?=base_url();?>imagenesMkt/AgregarCategoria" 
        >
		<div class="row">
...
<script>
    function GuardarCategoria(){
        ...
        imgCategoria=document.getElementById("imgCategoria").value;
        ...
        $.ajax({
            data: parametros,
            url: <?php echo('"'.base_url().'imagenesMkt/AgregarCategoria"'); ?>,
            method: 'POST',
            success: function(data) {
              console.log(data);
              if(data){
                 swal("La categoria se ha sido guadado con exito!");
              }else{
                swal("Error","Hubo un problema al guardar la categoria","error");
              }
            }
        });
    }
