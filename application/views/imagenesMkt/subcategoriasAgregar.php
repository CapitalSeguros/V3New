    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-7 col-xs-7">
            <ol class="breadcrumb text-right">
                ...
                <li><a href="<?=base_url()."imagenesMkt/subcategoriasModificar"?>">Repositorio imagenes - Modificar Subcategoria</a></li>
                <li class="active">Repositorio imagenes - Agregar Subcategoria</li>
            </ol>
        </div>
    </div>
    <hr /> 
...
<section class="page-section">
	<div class="container">
		...
		<form
        	...
        	name="formAgregarSubcategoria" id="formAgregarSubcategoria"
            method="post" enctype="multipart/form-data"
            action="<?=base_url();?>imagenesMkt/AgregarSubcategoria" 
        >
		<div class="row">
            ...
            <div class="col-sm-1 col-md-1">
				<input 
                    ...
                    onclick="document.formAgregarSubcategoria.submit();"
                />
