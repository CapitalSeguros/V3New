	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-7 col-xs-7">
			<ol class="breadcrumb text-right">
                ...
                <li class="active">Repositorio imagenes - Modificar Subcategorias</li>
			</ol>
		</div>
	</div>
	<hr /> 
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-1 col-md-1">
				<img  class="img-fluid" src="<?=base_url()."assets/img/imagenesMkt/subcategorias/".$row->img_link?>" />
            </div>
			<div class="col-sm-1 col-md-1" style="text-align:center;">
            	<a href="<?=base_url()."imagenesMkt/subcategoriasEditar?idSubcategoria=".$row->idSubcategoria?>" title="Editar">
                	<span class="glyphicon glyphicon-pencil"></span>
                </a>
            	<a href="<?=base_url()."imagenesMkt/BorrarSubcategoria?idSubcategoria=".$row->idSubcategoria?>" title="Eliminar">
