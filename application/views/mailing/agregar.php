					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab">
						...
						<div class="bhoechie-tab-content active">
                            ...
                            <?
								//print_r($campaigns);
							?>
									<?php echo form_open(base_url('mailing/agregadoCampaign')); ?>
                                        ...
                                        <h1>
                                        	<?
												if($padre == NULL){
											?>
                                            <input type="text" class="form-control" placeholder="Nombre" name="nombre" id="nombre" required="required" /> 
                                        	<?
												} else {
											?>
                                            <input type="text" class="form-control" placeholder="Nombre" name="nombre" id="nombre" readonly="readonly" value="<?= $nombre; ?>" />
										...
										<div class="form-group">					
											...
											?>
                                            <input type="text" class="form-control" placeholder="Correos" name="correos" id="correos" required="required" /> 
							...
							?>
                                        <div class="form-group" align="left" style="width:25%; text-align:left;">
                                        	<label>Clasificacion para el Tipo de Prospecto</label>			
                                        	<select class="form-control" id="tipo_prospecto" name="tipo_prospecto" required="required" readonly="readonly" disabled="disabled">
                                            	<option value="">-- Seleccione --</option>
                                            	<option value="0" <?= ($tipo_prospecto == "0")? "selected" : ""; ?>>Persona</option>
                                            	<option value="1" <?= ($tipo_prospecto == "1")? "selected" : ""; ?>>Generico</option>
                                            </select>
                                        </div>
                            <?
							}
