...
<div style="height: auto; width: 90%;"  class="center-block">
	  <label class="Responsivo lbEtiqueta " style=" margin-left: 60%" >Agentes temporales</label>
<form action="<?=base_url();?>persona/agenteTemporal"  method="post" id="formBuscarAgente">

<select class="objetosResponsivos"  name="idPersonas" id="idPersonas" >
		 <option value="-1">Selecciona Agente Temporal </option>
	<?php 
...
<form action="<?=base_url();?>persona/agenteTemporal"  method="post">
	<input type="hidden" name="idPasarAgente" id="idPasarAgente">
<button class="objetosResponsivos  btn-secondary" >Pasar a agente</button> 
</form>
</div>
<div style="height: auto; width: 90%;"  class="center-block">
<form action="<?=base_url();?>persona/agenteTemporal"  method="post" id="formDatosAgentes">
...
<div class="ResponsivoDiv"><label class="Responsivo lbEtiqueta">Tipo de Agente<div><select   type="text" name="personaTipoAgente" id="personaTipoAgente"></select></div></label></div>
</div>
</div>
...
<script>
 ...
 for(var i=0;i<cantidad;i++){
 	...
 	if(object.parentNode.childNodes[i].nodeName=="DIV"){console.log(object.parentNode.childNodes[i].nodeName);
