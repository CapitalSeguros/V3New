...
<!--* Fisica -->
		...
		<div class="row">
        	...
        	<div class="col-sm-2 col-md-2" align="right">
            <label class="labelResponsivo">	Poliza Captura Emision:</label>
            </div>
        	<div class="col-sm-10 col-md-10" align="left">
            	<input id="numeroImpresoCaptura" placeholder="Escriba Aqui el Numero Impreso en la Poliza que Esta Enviando a Captura (Obligatorio)"
                    required="" 
                	type="text"
                ...
                />
                <font color='red'>
                    <label class="labelResponsivo">⇐ Este Campo es Obligatorio o no será atendida la Captura de Emision</label>
                </font>
            </div>
        ...
        <div class="row">
			<div class="col-sm-12 col-md-12">
                <input type="hidden" name="oldValueRFC" value="<?=$rfcCliente?>" style="width:100%;" id="oldValueRFC"/>
...
?>
        ...
        <div class="row">
                    ...
                    ?>
            <div class="col-sm-2 col-md-2" align="right">
            <label class="labelResponsivo"> RFC: </label>
            </div>
            <div class="col-sm-10 col-md-10">
                <input type="text" value="<?=$rfcCliente?>" style="width:100%;" id="rfcCliente" name="rfcCliente"/>
                <a class="label label-info" href="https://agsc.siat.sat.gob.mx/PTSC/ValidaRFC/index.jsf" target="_blanck">VALIDADOR DE RFC</a>-<a href="https://consisa.com.mx/rfc" class="label label-info" target="_blanck">CREAR RFC PROVISIONAL</a>       
            </div>
        ...
        <div class="row" align="right">
            ...
            -->
                <input type="button" value="Cancelar" onclick="window.open('<?=$urlCancelar?>','_self');" id="cancelarActividad"/>
                <input type="submit" value="<? echo "Guardar ".$this->uri->segment(3); ?>" id="guardarForm" onclick="verificarDatos(event,this)"/>
            </div>
        </div>
<?
		}
?>
    ...
    <script type="text/javascript">
        function verificarDatos(event,objeto)
        {
            ...
            if(document.getElementById('rfcCliente').value=='')
            {
            ...
            {  
                ...
                let parametros=`rfcCliente=${document.getElementById('rfcCliente').value}&entidad=${document.getElementById('TipoEnt').value}`
