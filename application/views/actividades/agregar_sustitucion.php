...
<!--* Fisica -->
		...
		<div class="row">
        	...
        	<div class="col-sm-10 col-md-10">
                    ...
                    <?=($idPoliza != "" && isset($idPoliza))?'SUSTITUCION DE LA POLIZA: '.$idPoliza.' <br/> POR LA POLIZA: ':''?>
                    </textarea>
...
<script type="text/javascript">
	function asignaPolzai(argumento,nombreCompania,idCompania){
		...
		document.getElementById('datosExpres').value = "SUSTITUCION DE LA POLIZA: " + argumento + "<br />POR LA POLIZA: ";
