...
<div id="Modalcontenido" class="modal-contenido"  >
  <table class="table">
    <div><thead><tr><th colspan="2" name="cabezetaBsuquedaTH">    <button onclick="abrirCerrar(true)" style="color: white;float:right;background-color:red; border:double; position:relative; top:0px">Cerrar</button>  </th></tr><tr><th name="cabezetaBsuquedaTH"><div style="display:flex"><input type="text" name="" id="buscarPorClieteText" placeholder="BUSCAR POR CLIENTE" class="form-control"><button class="btn btn-info tipoImage" ti="1" onclick="buscarPorCliente('')"></button></div></th>
    </tr>
    <tr id="buscarPorPolizaTR"><th name="cabezetaBsuquedaTH"><div style="display:flex"><input type="text" name="" id="buscarPorPolizaText" placeholder="BUSCAR POR POLIZA" class="form-control"><button class="btn btn-info tipoImage" ti="2" onclick="buscarPorPoliza('')"></button></div></th></tr>
  </thead>
...
<div id="cruceDeCarteraDiv"  data-visible="0" data-tipovista="emi">
  ...
  <div componentediv='1'><select name="cruce" id="cruce" class="form-control"><option value="ESCOGER">Escoger tipo cliente</option><option value="FALSE">Referido</option><option value="TRUE">Cruce de cartera</option></select></div>
</div>
...
<div  labeldiv='1' class="label label-info"><label>Companias</label></div>
...
<div  id="informacionCotizacionDiv"  data-visible="1" data-tipovista="cot">
  <div labeldiv='1' class="label label-info" style="white-space:break-spaces"><label>Le recordamos que para poder tramitar su cotización exprés Necesitamos:</label></div>
  <div componentediv='1' class="comentariosCotizacion" style="display: flex;flex-direction: row;justify-content: space-around;flex-wrap: wrap;">    
...
<div  id="informacionCCDiv"  data-visible="1" data-tipovista="cc">
  <div labeldiv='1' class="label label-info" style="white-space:break-spaces"><label>Informacion necesaria:</label></div>
  <div componentediv='1' >    
...
.comentariosCotizacion>div{margin-top:20px}
.tipoImage{
...
.tipoImage[ti='1']{background-image: url(../assets/images/buscarCliente.png);}
.tipoImage[ti='2']{background-image: url(../assets/images/buscarDocumento.png);}
.tipoImage[ti='3']{background-image: url(../assets/images/buscar.png);}
</style>
<script>
...
function crearComponentes(id='',tipo='',divContenedor='',titleLabel='')
{
 ...
 switch (divContenedor) {
  case 'serieClienteDiv':
    ...
    btn.classList.add('tipoImage')
    btn.setAttribute('ti',3);
  ...
  switch (tipoActividad) {
    ...
    case 'Cotizacion':
      ...
      case 'Emision':
        ...
        parametros+=`&cruce=${document.getElementById('cruce').value}`;
        ...
        parametros+=`&entidad=${clienteGlobal.TipoEnt_TXT}`;
...
{
    console.log(datos);
    fallaCrearActividad(datos.errorVacio,datos.errorEstructura);
    
    if(!datos.success){document.getElementById('guardarActividadButton').disabled=false}
    else
    {
      document.getElementById('guardarActividadButton').disabled=true;
    }

}
function fallaCrearActividad(error,errorEstructura='')
{
  ...
  {
    console.log(val);
    document.getElementById(errorParam[val]).classList.add('errorVacio');
  }
...
const errorParam={IDCli:"nombreClienteDiv",datosExpres:"comentariosDiv",IDVend:"agentesDiv",rfcCliente:"datosDeFacturaDiv",polizaNew:"polizaCapturaEmisionDiv",poliza:"polizaDiv",cbCompania:"divEleccionCompania",SerieAuto:"serieClienteDiv",pagoFormas:"formasDePagoDiv",pagoConducto:"conductoDePagoDiv",selectCompania:"companiaEleccionDiv",cruce:"cruceDeCarteraDiv",numeroTarjeta:"datosTarjetasDiv",mesTarjeta:"datosTarjetasDiv",yearTarjeta:"datosTarjetasDiv",titularTarjeta:"datosTarjetasDiv",tipoTarjeta:"datosTarjetasDiv",bancoTarjeta:"datosTarjetasDiv",tipoPagoTarjeta:"datosTarjetasDiv",rfcFactura:"datosDeFacturaDiv"};
