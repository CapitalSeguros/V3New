...
<script type="text/javascript">
	...
	function funcionDefaultGDD(){devolverDocumentoActividad(); devolverBitacoraDeActividad()}
</script>
	...
	<div class="panel panel-default">
        ...
        <div class="row">
			...
			<div class="form-group col-sm-6 col-md-6" align="right">
            	<div><label><strong>Status</strong></label></div>
				<div>
				<div class="gifParaCapa" style="display: none" id="capaStatusActividad"></div>	
                 <div><label id="statusActividadLabel" data-text="<?=$infoFolioActividad->Status?>"><?=$this->capsysdre_actividades->Status($infoFolioActividad->Status)?></label></div>
                </div>
            </div>
        </div>
...
<section class="container-fluid">
	<form id="frmClient" action="<?php echo base_url();?>actividades/updateClient">
        <div class="row">
			...
			<!--div class="form-group col-sm-6 col-md-6"><h3><label class="label label-success"><a href="<?=base_url()?>actividades/ver/<?=$infoFolioActividad->folioActividad?>?servidor=0">REGRESAR A LA VERSION ANTERIOR</a></label></h3></div-->
		</div>
...
<!-- Documentos Fianzas -->
<? 
	if($infoFolioActividad->ramoActividad == "FIANZAS"){ 
?>
        <div class="row">
			<div class="form-group col-sm-12 col-md-12">
				<hr class="hrConsultaActividades" data-text='AGREGAR_DOCUMENTOS_FIANZAS' data-hr=''>
			</div>
		</div>
        <div class="row">
			<div class="form-group col-sm-12 col-md-12">
        		<div>
        			<div class="gifParaCapa" style="display: none" id="capaGuardarDocumentos"></div>
        			<div><? $this->load->view('generales/guardarDocumentosFianzas'); ?></div>
        		</div>
			</div>
		</div>
        <div class="row">
			<div class="form-group col-sm-12 col-md-12">
				<hr class="hrConsultaActividades">
			</div>
		</div>
<?
	} /* !FIANZAS */
...
<!-- !Documentos Fianzas -->
        ...
        <hr class="hrConsultaActividades" data-text='AGREGAR DOCUMENTOS' data-hr=''>
        <div>
        <div class="gifParaCapa" style="display: none" id="capaGuardarDocumentos"></div>
        <div><?php $this->load->view('generales/guardarDocumentosDiversos');?></div>
        </div>
<script type="text/javascript">
abrirVentanaGeneralesGD();
IDDoctoGeneralesGD="<?=$infoFolioActividad->idSicas;?>";
IDClienteGDD="<?= $infoFolioActividad->idCliente; ?>";
tipoActividadGDD="<?=$infoFolioActividad->tipoActividad?>";
polizaGDD="<?=$infoFolioActividad->poliza;?>"
folioActividadGDD="<?=$infoFolioActividad->folioActividad?>"
            	<? if($infoFolioActividad->tipoActividadSicas=="ot"){?>
						TypeDestinoCDigitalGDD	= "DOCUMENT";
						IDValuePKGDD				= "<?=$infoFolioActividad->idSicas;?>"
						folderDestinoGDD			= "";
					<? } else { ?>
						TypeDestinoCDigitalGDD	= "CLIENT";
						IDValuePKGDD				= "<?=$infoFolioActividad->idCliente;?>";
						FolderDestinoGDD			= "<?="Target_".$infoFolioActividad->tipoActividad;?>";
						<? if($infoFolioActividad->poliza!=""){ ?>
						FolderDestinoGDD			+= `\\<?=$infoFolioActividad->poliza ;?>`;
        ...
        <hr class="hrConsultaActividades" data-text='DOCUMENTOS' data-hr=''>
        
        <div style="display: flex;flex-direction: column;position: relative;min-height: 300px;overflow: scroll;" class="contieneDocumentosDiv">
        	<div class="gifParaCapa" style="display: none" id="capaDocumentos">capa</div>
        	<div style="display: flex;position: absolute;width: 100%">
        		<div style="display: flex;flex-direction: column;flex:2;border-right: solid black 2px">
        			<div style="position: sticky;top: 0px"><label class="label label-info">DOCUMENTOS ACTIVIDAD</label></div>
        			<div id="contieneArchivosDoc"></div>
        		</div>
        		<div style="display: flex;flex-direction: column;flex:1;border-right: solid black 1px">
        			<div style="position: sticky;top: 0px"><label class="label label-info">DOCUMENTOS CLIENTES</label></div>
        			<div id="contieneArchivosCli"></div>
        		</div>
        		       	<div style="display: flex;flex-direction: column;flex:2">
        		<div style="position: sticky;top: 0px"><label class="label label-info">DOCUMENTOS ENDOSO</label></div>
        		<div id="contieneArchivosEndoso"></div>
        	</div>
        	</div>
...
<!-- Comentarios Actividad -->
		...
		>
		 <input type="hidden" name="peticionAJAX" value="1" />
        ...
        <div>
        	<hr class="hrConsultaActividades" data-text="COMENTARIO" data-hr="">
			<div class="form-group col-sm-12 col-md-12">
            	<!--label>Comentario</label-->
               
                <? if ($infoFolioActividad->Status!='6')   
                { ?>
                <div class="gifParaCapa" style="display: none;" id="capaComentarios"></div>
				<textarea name="Comentario" id="Comentario" style="width:100%;" rows="5">
                </textarea>
        ...
        <div class="row">
			<div class="form-group col-sm-12 col-md-12" align="right">
                ...
                { ?>
                		...
                		/-->
                		    <button class="btn btn-primary btn-sm manejoActividad" onclick="event.preventDefault();if(document.getElementById('Comentario').value==''){alert('AGREGAR INFORMACION');return 0;};document.formActividadVer_AgregaSeguimiento.enviar.value=0;document.formActividadVer_AgregaSeguimiento.oldPosicion=0;guardarArchivosGeneralesGD('','formActividadVer_AgregaSeguimiento',event,'actividades/agregarSeguimiento','devolverBitacoraDeActividad','capaComentarios')">Guardar Comentarios</button>

                		<input
                			type="submit" value="Enviar Comentario [En Curso]"
							onclick="event.preventDefault();if(document.getElementById('Comentario').value==''){alert('AGREGAR INFORMACION');return 0;};document.formActividadVer_AgregaSeguimiento.enviar.value=5;document.formActividadVer_AgregaSeguimiento.oldPosicion=5;guardarArchivosGeneralesGD('','formActividadVer_AgregaSeguimiento',event,'actividades/agregarSeguimiento','devolverBitacoraDeActividad','capaComentarios')"
                    		id="5"
							class="btn btn-primary btn-sm manejoActividad"
                		/>
                	<?
					...
					?>
                		...
                		<input
							...
							onclick="event.preventDefault();if(document.getElementById('Comentario').value==''){alert('AGREGAR INFORMACION');return 0;};document.formActividadVer_AgregaSeguimiento.enviar.value=6;document.formActividadVer_AgregaSeguimiento.oldPosicion=6;guardarArchivosGeneralesGD('','formActividadVer_AgregaSeguimiento',event,'actividades/agregarSeguimiento','devolverBitacoraDeActividad','capaComentarios')"
                    		id="6"
							class="btn btn-primary btn-sm manejoActividad"
                		/>
                		<!--input
        ...
        <hr class="hrConsultaActividades">
        <style type="text/css">
        	.hrConsultaActividades{background-color: #413a64;border-top-right-radius: 8px;height: 8px;width: 100%;margin-top: 5%;margin-bottom: 21px;border-top-left-radius: 8px;}
        	.hrConsultaActividades[data-hr='']:before{top:-13px;font-size: 100%;background-color: white;position: relative;border-top-right-radius: 8px;border:solid;}
        	.hrConsultaActividades[data-text='OPCIONES']:before{content: 'OPCIONES DE ACTIVIDADES';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='BITACORA']:before{content: 'BITACORA DE ACTIVIDAD';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='DOCUMENTOS']:before{content: 'DOCUMENTOS ACTIVIDAD Y CLIENTE';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='AGREGAR DOCUMENTOS']:before{content: 'AGREGAR DOCUMENTOS PARA LA ACTIVIDAD Y EL CLIENTE';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='COMENTARIO']:before{content: 'AGREGAR COMENTARIOS PARA LA ACTIVIDAD';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='CALIFICACIONES']:before{content: 'CALIFICACION DE LA ACTIVIDAD';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='PREFERENCIAS']:before{content: 'PREFERENCIAS DEL CLIENTE';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='INFORMACIONEXTRA']:before{content: 'INFORMACION ADICIONAL';background-color: #99dee9;color:black;}
        	.hrConsultaActividades[data-text='COMPANIAS']:before{content: 'COMPANIAS';background-color: #99dee9;color:black;}
			.hrConsultaActividades[data-text='INFORMACIONTARJETAS']:before{content: 'INFORMACION DE TARJETAS';background-color: #99dee9;color:black;}
			
        	.hrConsultaActividades[data-text='AGREGAR_DOCUMENTOS_FIANZAS']:before{content: 'AGREGAR DOCUMENTOS FIANZAS';background-color: #99dee9;color:black;}



        </style>
<?php if(isset($permisos['modificarActividad'])){ ?>
<hr class="hrConsultaActividades" data-text='OPCIONES' data-hr=''>
<div class="gifParaCapa" style="display: none;" id="opcionesActividadesGifDiv"></div>
<div style="display: flex;flex-direction: column;">
	<div></div>
	<div style="display: flex;flex-direction: row;justify-content: space-between;flex-wrap: wrap;">
		 <div><label>Cambiar estado
		 	  <select class="form-control input-sm" id="selectStatusSicas"> 
                          ...
                          <?php }else{ ?><option value="<?= $value->idStatus; ?>"><?= $value->Nombre; ?></option> <?php } }?>
           				</select>
           			</label>
           		</div>
          <div>
           		<label>Motivo del cambio<select id="selectMotivoCambio" class="form-control input-sm"><option value='-1'></option><option value="1">Completa</option><option value="2">No se especifica el tipo de producto a cotizar</option><option value="3">Falta de Informacion</option><option value="4">Documentacion Faltante</option><option value="5">El numero de seria ya se encuentra amparado</option><option value="6">La cotizacion no coincide con la emision solicitada</option><option value="8">No terminan el proceso de cotización a emision</option><option value="9">Solicitar autorización de costos o detalles de la póliza diferente a cotizacion</option><option value="10">Actividad no corresponde al ramo correcto</option><!--option value="7">Otros</option--></select></label>
           	</div>
         ...
         <div>
                       ...
                       <div> <label>Captura<input id="cbPasarCaptura" type="checkbox" class="form-control" <?=$checked?> style="height: 25px"></label> </div>
         ...
         <div>         	                  
           			 <?php if(($infoFolioActividad->tipoActividad=="Emision" || $infoFolioActividad->tipoActividad=="Cotizacion") && !empty($infoDocumento)){ 
           			 	...
           			 	<div><label>Fecha Emision:<input class="formEnviar fechaPersona form-control"  type="text"  id="fechaEmision" autocomplete="off" value="<?=$miFecha?>"></label></div>
								<?php } else{ ?> 
									<div><label>Fecha Emision:<input class="formEnviar fechaPersona form-control" type="text"  id="fechaEmision" autocomplete="off" value="<?=date("d-m-Y")?>"></label></div>
								<?php }?>
         </div>
         ...
         <div>
           		 ...
           		 ?>
           	        <div><label>Concepto(pasar a captura)<input type="checkbox" onclick="agregarDiagonal(this)" <?=$checkedConcepto?>><input type="text" class="form-control input-sm" id="textConceptoSicas" style="width:300px" data-oldvalue="<?=$infoDocumento[0]->Concepto?>" value="<?=$infoDocumento[0]->Concepto?>"></label></div><br>
					<?php } else{ ?> 
						<div><label>Concepto<input type="text" class="form-control input-sm" id="textConceptoSicas" style="width:300px" value=""></label></div><br>
					<?php }?>
    ...
    <div>
     ...
     <div style="display: flex;flex-wrap: wrap;flex-direction: row">
           	<div ><label>Pasar a cobranza:<input type="text" name="comentarioParaCobranza" id="comentarioParaCobranza" class="form-control"></label></div>
           	    <div ><input type="checkbox" name="cbPasarCobranza" id="cbPasarCobranza" style="position: relative;top: 30%;left: 30%;height: 30px;width: 30px"></div>    
        ...
        <div style="display: flex;justify-content: space-between;flex-wrap: wrap;">
                ...
                <!--button class="btn btn-primary btn-sm" onclick="actualizarDatosEnSicas('<?=$folioActividad;?>','<?=$infoFolioActividad->idSicas;?>','<?=$infoFolioActividad->tipoActividadSicas;?>','<?=$infoFolioActividad->ClaveBit;?>')">Guardar</button>
 	    			...
 	    			<div><button class="btn btn-primary btn-sm" onclick="actualizarDatosEnSicas_('<?=$folioActividad;?>','<?=$infoFolioActividad->idSicas;?>','<?=$infoFolioActividad->tipoActividadSicas;?>','<?=$infoFolioActividad->ClaveBit;?>')">Guardar</button></div>
                <? if($infoFolioActividad->actividadImportante==1)
                { ?>
                	<div>
                <button class="btn btn-danger" style="margin-left: 10%" onclick="eliminarImportante('<?=$folioActividad;?>','<?=$infoDocumento[0]->IDDocto;?>')">No importante</button>
              </div>
                <?php } ?>
...
<?php if(isset($permisos['modificarActividad'])){ ?>
        <div  style="display: flex;flex-direction: column;">
         ...
         <hr class="hrConsultaActividades" data-text="COMPANIAS" data-hr="">
		    <div style="position: relative;width: 100%;display: flex;flex-direction: column;" >
		    	<div class="gifParaCapa" style="display: none" id="traerCompaniasGifDiv"></div>
               <div><?php echo(imprimirPromotorias($promotorias,$infoFolioActividad->folioActividad,$IDValuePK,$FolderDestino,$TypeDestinoCDigital)); ?></div>
               <div id="contienePromotoriasDiv" style="display: flex;flex-direction: column;"></div>
                              <div style="display: flex;">
            ...
            <hr class="hrConsultaActividades">
            <div class="form-group col-sm-12 col-md-12"><?php echo(imprimirDatosAdicionales($cliente)); ?></div>
             <div class="form-group col-sm-12 col-md-12">
...
<?php if(isset($permisos['calificarActividad'])){ if($actividadCalificada==0){?>
	<hr class="hrConsultaActividades" data-text="CALIFICACIONES" data-hr="">
	        <div style="display: flex;flex-direction: column;margin-top: 20px;position: relative;height: 50%">
        <div class="gifParaCapa" style="display: none" id="capaCalificaAgente">capa</div>
        <div style="position: absolute;z-index: 1;width: 100%;height: 100%;">
         
			<div ><?= imprimirCalificaciones($calificaciones); ?>
				
				<button class="btn-danger" onclick="guardarCalificacionAJAX('','capaCalificaAgente','<?=$folioActividad;?>',<?=$infoFolioActividad->IDVend;?>,'<?=$infoFolioActividad->tipoActividad;?>',<?=$infoFolioActividad->idInterno?>)">Guardar</button>
			</div>
...
?>
      ...
      <hr class="hrConsultaActividades" data-text="INFORMACIONTARJETAS" data-hr="">
 <div class="row" style="">
         <div  class="form-group col-sm-12 col-md-12">
...
<hr class="hrConsultaActividades" data-text="INFORMACIONEXTRA" data-hr="">
        <div class="row">
			<div class="form-group col-sm-12 col-md-12">
            	<label >
...
<hr class="hrConsultaActividades" data-text='BITACORA' data-hr=''>
<div id="bitacoraActividadesDiv" style="background-color: white;display: flex;flex-wrap: wrap;flex-direction: column;margin-left: 1%;margin-right: 1%">
...
<style type="text/css">
	#tab_doc{background-color: white;overflow: scroll;height: 305px;}
</style>
...
function agregarCompania_(IDSRamo,folioActividad,tipoActividad){
...
function imprimirAgregarCompania($datos,$folioActividad,$IDSRamo,$tipoActividad){			
		$option='<div style="flex:5"><select id="selectAgregarCompania" class="form-control input-sm"><option id="-1">Escoger compania</option>';
		foreach ($datos as $value) {$option.='<option value="'.$value->idPromotoria.'">'.$value->Promotoria.'</option>';
			}	
		$option.='</select></div><div style="flex:1"><button onclick="agregarCompania(\'\',\'traerCompaniasGifDiv\','.$IDSRamo.',\''.$folioActividad.'\',\''.$tipoActividad.'\')" class="btn btn-primary btn-sm">Agregar compania</button></div>';
		return $option;
}
...
function imprimirCalificaciones($datos){
	...
	foreach ($datos as  $value) {
		$tabla.='<tr>';
		$tabla.='<td><label>'.$value->calificacionAgente.'</label></td>';
		$tabla.='<td idCalificacion="'.$value->idCalificacionAgente.'" calificacion="1" onclick="califica(this)"  class="estrellaChecked tdCalificacion"></td>';
		$tabla.='</tr>';
	}
	$tabla.='</table>';
	return $tabla;
...
function imprimirDatosAdicionales($datos){
	$informacion='<hr class="hrConsultaActividades" data-text="PREFERENCIAS" data-hr=""><table border="1">';
if(count($datos)>0){
...
$informacion.='</table><hr class="hrConsultaActividades">';
	return $informacion;
}
...
function peticionAJAX_VER(controlador,parametros,funcion,capa='')
{
  ...
  {   
    ...
    {    	
      if(req.status == 200)    
      {   if(funcion=='refrescarInformacionDeVista'){}
...
function guardarCalificacionAJAX(datos='',capa,folioActividad,IDVend,tipoActividad,idInterno)
{
 if(datos=='')
 {

    	objetosForm=document.getElementsByClassName('tdCalificacion');objetos="";cant=objetosForm.length;cadena="";
  for(var i=0;i<cant;i++){cadena=cadena+objetosForm[i].getAttribute('idCalificacion')+"-"+objetosForm[i].getAttribute('calificacion')+";"; }
  	let params='';
    params='calificaciones='+cadena+'&folioActividad='+folioActividad+'&IDVend='+IDVend+'&tipoActividad='+tipoActividad+'&idInterno='+idInterno+'&peticionAJAX=1';
    peticionAJAX_VER('actividades/guardarCalificacion',params,'guardarCalificacionAJAX',capa);
 }
 else
 {
 	if(datos.success)
 	{
 		...
 		let padre=document.getElementById(capa).parentNode.parentNode;
 		padre.removeChild(document.getElementById(capa).parentNode);
 	}
    else{alert('PROBLEMAS EN EL GUARDADO')}
 }
}
function traerCompanias(datos='')
{
  if(datos=='')
  {
  	let tipoActividad="<?=$infoFolioActividad->tipoActividad;?>";
  	let folioActividad="<?=$infoFolioActividad->folioActividad;?>"
    let params=`tipoActividad=${tipoActividad}&folioActividad=${folioActividad}`;
    peticionAJAX_VER('actividades/obtenerPromotoriaPorActividad',params,'traerCompanias','traerCompaniasGifDiv')
  }
  else
  {
  	devolverDocumentoActividad();
  	let promotorias='';
  	let promotoriasForm='';
  	let folioActividad="<?=$infoFolioActividad->folioActividad;?>";
  	let IDValuePK="<?=$infoFolioActividad->idSicas;?>";
  	datos.promotorias.forEach(p=>{
  		let contiene='';
  		if(p.numArchivos>0){contiene=`<label class="label label-info"> YA CUENTA CON ARCHIVO</label>`}
      promotorias+=`<div style="display:flex"><label  style="flex:3">${p.Promotoria}${contiene}</label><input type="file" style="flex:3" name="DocumentoFiles-${p.idRelActividadPromotoria}">$<input type="text" value="${p.montoRAP}" style="flex:1" name="monto-${p.idRelActividadPromotoria}"></div><hr style="width:100%;margin-top:10px">`;
  	})
  	if(promotorias!='')
  	{
  		promotorias+=`<input type="hidden" name="folioActividad" value="${folioActividad}">`;
  		promotorias+=`<input type="hidden" name="TypeDestinoCDigital" value="DOCUMENT">`;
  		promotorias+=`<input type="hidden" name="IDValuePK" value="${IDValuePK}">`;
  		promotorias+=`<input type="hidden" name="FolderDestino" value="">`;
  		
  		promotoriasForm=`<form id="documentosMontoPromotoriaForm">${promotorias}</form><div style="text-align:center;margin-bottom:21px"><input type="submit" class="btn btn-primary" onclick="guardarArchivosGeneralesGD('','documentosMontoPromotoriaForm',event,'actividades/guardadDocumentoMontoPromotoria','traerCompanias')"></div>`
  	}
  	document.getElementById('contienePromotoriasDiv').innerHTML=promotoriasForm;
  }
}
function agregarCompania(datos='',capa,IDSRamo,folioActividad,tipoActividad)
{
	if(datos=='')
	{let idPromotoria=document.getElementById('selectAgregarCompania').value;
    if(idPromotoria>0){
		
		let params=`peticionAJAX=1&idPromotoria=${idPromotoria}&folioActividad=${folioActividad}&IDSRamo=${IDSRamo}&tipoActividad=${tipoActividad}`;
         peticionAJAX_VER('actividades/agregarCompaniaAdicional',params,'agregarCompania',capa);
     }
      else{alert("Escoger compania");}
	}
	else
	{
      alert(datos.mensaje);
      if(datos.success){traerCompanias();}     
	}
}
	function guardarArchivosGeneralesGD(datos='',form,e,controlador,funcion,capa='')
	{  
        ...
        {   
         ...
         var respuesta=JSON.parse(this.responseText);             
          alert('DATOS GUARDADOS CON EXITO');
           if(capa!=''){document.getElementById(capa).style.display='none';if(capa=='capaComentarios'){document.getElementById('Comentario').value='';}}       
           if(funcion=='traerCompanias'){window[funcion]();}    
           else{window[funcion](respuesta);}
...
function devolverDocumentoActividad(datos='')
{
 if(datos=='')
 {
    let IDCli="<?=$infoFolioActividad->idCliente?>";//28009;
    let idSicas="<?=$infoFolioActividad->idSicas?>";//15615
    let tipoActividad="<?=$infoFolioActividad->tipoActividad?>";
    let tipoTarea="<?=$infoFolioActividad->tipoActividadSicas?>";
     let poliza="<?=$infoFolioActividad->poliza?>"
     let folioActividad="<?=$infoFolioActividad->folioActividad?>"
    let params=`IDCli=${IDCli}&idSicas=${idSicas}&tipoActividad=${tipoActividad}&poliza=${poliza}&tipoTarea=${tipoTarea}&folioActividad=${folioActividad}`;
    peticionAJAX_VER('actividades/devolverDocumentoPromotoria',params,'devolverDocumentoActividad','capaDocumentos');
 }
 else
 { 		
 	let docC='';
 	let docD='';
 	let docE='';
 	let email="<?=$ClienteContact["cliente"]->EMail1?>";
 	let telefono1="<?= str_replace("Telefono1:","",$contacto->Telefono1); ?>";
    let monto=parseFloat(datos.saldo);
 	if(typeof(datos.verDocumentosClientes.children)=='object'){
 	datos.verDocumentosClientes.children.forEach(v=>{if(!v.isFolder){docC+=`<div style="margin-top:15px"><i class="fa fa-file-text"
 	style="font-size:30px" aria-hidden="true"></i><a href="${v.href}" target="_blank">${v.text}</a></div>`;}
 	})
   }
   document.getElementById("contieneArchivosCli").innerHTML=docC;

   if(typeof(datos.verDocumentosActividad.children)=='object')
   {  
   	   
   	   for(doc in datos.verDocumentosActividad.children )
   	   {
   	   	
   	   	if(datos.verDocumentosActividad.children[doc].Tipo==1)
      		{   
               docD+=`<div style="display:flex; margin-top:15px">`;
      			if(monto >= 5)
      			 {                  
    	            /*docD+=`<div style="flex:1"><button type="button" class="btn btn-primary linkSms" title="Clic - Enviar SMS" onclick="generaLinkEnvio('linkSms', '${telefono1}', '', '${datos.verDocumentosActividad.children[doc].href}')">
                    	<span class="fa fa-mobile" aria-hidden="true"></span>
                    </button></div>                  
                    <div style="flex:1"><button type="button" class="btn btn-primary linkWhatSapp" title="Clic - Enviar WhatSapp" onclick="generaLinkEnvio('linkWhatSapp', '${telefono1}', '', '${datos.verDocumentosActividad.children[doc].href}')">
                    	<span class="fa fa-whatsapp" aria-hidden="true"></span>
                    </button></div>
                    
    	            <div style="flex:1"><button type="button" class="btn btn-primary linkCorreo" title="Clic - Enviar Correo Electrónico" onclick="generaLinkEnvio('linkCorreo', '', '${email}', '${datos.verDocumentosActividad.children[doc].href}')">
                    	<span class="fa fa-envelope-o" aria-hidden="true"></span>
                    </button></div>`;*/
                  }
      			docD+=`<div style="flex:12"><i class="fa fa-file-text"
 	style="font-size:30px" aria-hidden="true"></i><a  href="${datos.verDocumentosActividad.children[doc].href}" target="_blank">${datos.verDocumentosActividad.children[doc].text}</a></div></div>`;
            }
   	   }

   }
   document.getElementById("contieneArchivosDoc").innerHTML=docD;
      if(typeof(datos.verDocumentosEndoso)=='object')
   {
       /*datos.verDocumentosEndoso.forEach(v=>{
       	console.log(v)
       })*/
       for(doc of datos.verDocumentosEndoso)
       {
       	          docE+=`<div style="display:flex; margin-top:15px">`;
      			if(monto >= 5)
      			 {                  
    	            /*docE+=`<div style="flex:1"><button type="button" class="btn btn-primary linkSms" title="Clic - Enviar SMS" onclick="generaLinkEnvio('linkSms', '${telefono1}', '', '${doc.href}')">
                    	<span class="fa fa-mobile" aria-hidden="true"></span>
                    </button></div>                  
                    <div style="flex:1"><button type="button" class="btn btn-primary linkWhatSapp" title="Clic - Enviar WhatSapp" onclick="generaLinkEnvio('linkWhatSapp', '${telefono1}', '', '${doc.href}')">
                    	<span class="fa fa-whatsapp" aria-hidden="true"></span>
                    </button></div>
                    
    	            <div style="flex:1"><button type="button" class="btn btn-primary linkCorreo" title="Clic - Enviar Correo Electrónico" onclick="generaLinkEnvio('linkCorreo', '', '${email}', '${doc.href}')">
                    	<span class="fa fa-envelope-o" aria-hidden="true"></span>
                    </button></div>`;*/
                  }
      			docE+=`<div style="flex:12"><i class="fa fa-file-text"
 	style="font-size:30px" aria-hidden="true"></i><a href="${doc.href}" target="_blank">${doc.text}</a></div></div>`;
       }

   }
   document.getElementById("contieneArchivosEndoso").innerHTML=docE;
 }
}//devolverDocumentoActividad


function actualizarDatosEnSicas_(folioActividad,IDDocto,tipoActividadSicas,ClaveBit)
{
	let params='';
	let arrayParams=new Object();
 if(document.getElementById('selectStatusSicas').value==6)
 {if(!finalizarActividad){alert('No tiene permisos para finalizar la actividad');return 0;}}
 
	if(document.getElementById('selectStatusSicas').value==1)
	{
		if(document.getElementById('selectMotivoCambio').value==-1){alert('Para pasarlo a agente gap escoge un motivo de cambio');return 0;}
        if(document.getElementById('selectMotivoCambio').value==1)
        {
        	if(tipoActividadParaCaptura!='Cotizacion')
			{  let band=0;
	     ...
	     //crearObjetosParaForm(document.getElementById('selectMotivoCambio').value,"motivoCambio");
	     arrayParams.motivoCambio=document.getElementById('selectMotivoCambio').value;
	 }
	if(document.getElementById('textConceptoSicas'))
		{
			//crearObjetosParaForm(document.getElementById('textConceptoSicas').value,"Concepto");
			arrayParams.Concepto=document.getElementById('textConceptoSicas').value;
		}
	if(document.getElementById("cbPasarCaptura")){
		if(document.getElementById("cbPasarCaptura").checked){
	//crearObjetosParaForm(document.getElementById('cbPasarCaptura').value,"cambioPropietario");	
         arrayParams.cambioPropietario=document.getElementById('cbPasarCaptura').value;
		...
		if(document.getElementById('fechaEmision'))
			{
				//crearObjetosParaForm(document.getElementById('fechaEmision').value,"FEmision");
				arrayParams.FEmision=document.getElementById('fechaEmision').value;
			}
    //crearObjetosParaForm(ClaveBit,"ClaveBit");
    arrayParams.ClaveBit=ClaveBit;
	//crearObjetosParaForm(tipoActividadSicas,"tipoActividadSicas");
     arrayParams.tipoActividadSicas=tipoActividadSicas;
    //crearObjetosParaForm(document.getElementById('selectStatusSicas').value,"Status");
    arrayParams.Status=document.getElementById('selectStatusSicas').value;
    //crearObjetosParaForm(folioActividad,"folioActividad");
    arrayParams.folioActividad=folioActividad;
    //crearObjetosParaForm(IDDocto,"IDDocto");
    arrayParams.IDDocto=IDDocto;
    //crearObjetosParaForm(document.getElementById('textComentario').value,'textoComentario');
    arrayParams.textoComentario=document.getElementById('textComentario').value;
    //crearObjetosParaForm(document.getElementById('idInternoActividadCobranza').value,'idInterno');
    arrayParams.idInterno=document.getElementById('idInternoActividadCobranza').value;
    //crearObjetosParaForm(document.getElementById('usuarioCreacionActividadCobranza').value,'usuarioCreacion');
    arrayParams.usuarioCreacion=document.getElementById('usuarioCreacionActividadCobranza').value
    //crearObjetosParaForm(document.getElementById('usuarioResponsableActividadCobranza').value,'usuarioResponsable');
    arrayParams.usuarioResponsable=document.getElementById('usuarioResponsableActividadCobranza').value
    if(document.getElementById('cbPasarCobranza').checked)
    {
     //crearObjetosParaForm(document.getElementById('comentarioParaCobranza').value,'comentarioParaCobranza');
     arrayParams.comentarioParaCobranza=document.getElementById('comentarioParaCobranza').value;
     //crearObjetosParaForm(document.getElementById('cbPasarCobranza').value,'pasarCobranza');
     arrayParams.pasarCobranza=document.getElementById('cbPasarCobranza').value;
     if(document.getElementById('comentarioParaCobranza').value==''){alert('PARA PASAR A COBRANZA AGREGAR EL COMENTARIO DE LO REQUERIDO');return 0; }
    }
    
    band=0;
    for(arreglo in arrayParams)
    {
    	
    	if(band==0){params=`${arreglo}=${arrayParams[arreglo]}`;}
    	else{params+=`&${arreglo}=${arrayParams[arreglo]}`;}
        band=1;
    }
        let confirmacion = confirm("DESEA CONTINUAR CON EL GUARDADO DE DATOS");
    if(confirmacion)
    {
    	params+=`&ClaveBit=<?=$infoFolioActividad->ClaveBit?>&peticionAJAX=true`
    peticionAJAX_VER('actividades/modificarActividad',params,'devolverBitacoraDeActividad','opcionesActividadesGifDiv');
    }
    else{alert('GUARDADO DE DATOS CANCELADO')}
                          //if(!confirmacion){return 0;} 
     //enviarFormGenerales('actividades/modificarActividad');
    
}
function refrescarInformacionDeVista(datos)
{
  ...
  datos.verBitacoraActividad.forEach(v=>{
  	//let fechaArray=v.FechaHora.split('T');
	let fechaArray=v.FechaHora.split(' ');
  	let horaArray=fechaArray[1].split('-');
  	let diaMesAnioArray=fechaArray[0].split('-');
      bitacora+=`<div><div style="font-size:18px;font-weight:600">Hora: ${horaArray[0]}  Fecha:${diaMesAnioArray[2]}/${meses[diaMesAnioArray[1]-1]}/${diaMesAnioArray[0]}</div><div style="margin-top:13px;margin-bottom:13px">${v.Comentario}</div></div><hr style="height:3px;width:100%;background-color:#7785b7">`;
  })

    datos.verBitacoraActividadCotizacion.forEach(v=>{
  	  	let fechaArray=v.FechaHora.split(' ');
 
  	let diaMesAnioArray=fechaArray[0].split('-');
      bitacora+=`<div><div style="font-size:18px;font-weight:600">Hora: ${fechaArray[1]}  Fecha:${diaMesAnioArray[2]}/${meses[diaMesAnioArray[1]-1]}/${diaMesAnioArray[0]}</div><div style="margin-top:13px;margin-bottom:13px">${v.Comentario}</div></div><hr style="height:3px;width:100%;background-color:#7785b7">`;

  })
  document.getElementById('bitacoraActividadesDiv').innerHTML=bitacora;
  document.getElementById('statusActividadLabel').innerHTML=datos.actividad.Status_Txt;
    		if(document.getElementById('statusActividadLabel').dataset.text!=datos.actividad.Status)
  		{
  			alert('LA ACTIVIDAD A CAMBIANDO A:' + datos.actividad.Status_Txt);
  			document.getElementById('statusActividadLabel').dataset.text=datos.actividad.Status;
  		}
  if(document.getElementById('selectStatusSicas'))
  	{

  		document.getElementById('selectStatusSicas').value=datos.actividad.Status;
  	}
}
...
function devolverBitacoraDeActividad()
{
   	...
   	let params=`peticionAJAX=1&ClaveBit=<?=$infoFolioActividad->ClaveBit?>&folioActividad=<?=$infoFolioActividad->folioActividad?>&idInterno=<?=$infoFolioActividad->idInterno?>`;
    peticionAJAX_VER('actividades/devolverBitacoraDeActividad',params,'refrescarInformacionDeVista','');
 }
devolverDocumentoActividad();
traerCompanias();
devolverBitacoraDeActividad();
if(document.getElementById('barraDeCerradoGDD')){document.getElementById('barraDeCerradoGDD').parentElement.removeChild(document.getElementById('barraDeCerradoGDD'))}
if(document.getElementById('Comentario')){
$(document).ready(function(){
  $("#Comentario").on('paste', function(e){
    e.preventDefault();
    alert('Esta acción está prohibida');
  })
  
  $("#Comentario").on('copy', function(e){
    e.preventDefault();
    alert('Esta acción está prohibida');
  })
})
}
document.getElementsByTagName("body")[0].style.marginLeft='1%';
</script>
<style type="text/css">
...
<script type="text/javascript">
	/*let hCA=document.getElementsByClassName('hrConsultaActividades');
	for(clase of hCA )
	{
        if(clase.dataset.text){
        	clase.addEventListener('click',function(){
        		console.log(clase.nextElementSibling)
        		clase.nextElementSibling.classList.toggle('ocultarElemento');
        	})
...
<script type="text/javascript">
	                	<? if($infoFolioActividad->motivoCambio==1){ ?>
                        // <label class="label label-warning">LA ACTIVIDAD ESTA MARCADA COMO COMPLETA ACLARACIONES COMINICARSE //AL EJECUTIVO</label>
                	
if(document.getElementById('contenedorArchivosGeneralesGDInput'))
{
 document.getElementById('guardarArchivosGeneralesDiversos').parentElement.parentElement.innerHTML=`<label class="label label-warning">LA ACTIVIDAD ESTA MARCADA COMO COMPLETA ACLARACIONES COMINICARSE AL EJECUTIVO</label>` 
}
	<? } ?>
</script>
