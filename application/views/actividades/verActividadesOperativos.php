				...
				<table class="table table-striped table-bordered table-sm">
					<thead>
						...
						<tr scope="row" bgcolor="#A391C0" valign="top">
							...
							<th scope="col">Fecha recepcion</th><!--  width="100" -->
							<th scope="col">Promotorias</th><!--  width="100" -->
							<th scope="col">Estado</th><!--  width="100" -->
...
//fp = fopen('resultadoJason.txt', 'a');fwrite($fp, print_r($ActividadesTrabajandose->result(), TRUE));fclose($fp);
						foreach($ActividadesTrabajandose as $row){
							$contCheckbox++;
					...
					?>
						...
						<tr scope="row" style="font-size:12px;">
							...
							<td scope="col">
								<?=$this->capsysdre_actividades->fechaHoraEspActividades($row->fechaActualizacionStatus,'')?>
                            </td>
                            	<td scope="col"  class="divPromotoria">
                            	<div>Aseguradoras</div> <p><?=$row->promotorias ;?></p>
                            </td>
                            							<td scope="col">
								<?=$row->Status_Txt?>
                            </td>
...
<? if($ActividadesCerrar>0){ ?>
<style>
	.modal-contenido{background-color:none;width: 100px;height: 100%;padding: 5% 10%;margin: 10% auto;position: relative;z-index: 1000;}
...
<script type="text/javascript">
	...
	function abrir(){document.getElementById("miModal").classList.remove("modalCierra");document.getElementById("miModal").classList.add("modalAbre");document.getElementById("Modalcontenido").style.display="block";}
	abrir();
...
?>
<script type="text/javascript">function actualizar(){location.reload(true);}setInterval("actualizar()",300000);</script>
<style type="text/css">
 ...
 .divPromotoria p {display: none;color: white;background-color:#0857b9;height: 100px; width: 300px}
 .divPromotoria div {color: white; background-color: #03345b;height:}
 .divPromotoria:hover {cursor:pointer;}
 .divPromotoria:hover  p{display: block;height:100px; width: 300px} 
