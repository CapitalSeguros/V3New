...
<!--* Fisica -->
		...
		<div class="row">
        	...
        	<div class="col-sm-10 col-md-10">
                    ...
                    <?=($idPoliza != "" && isset($idPoliza))?'COBRANZA DE LA POLIZA '.$idPoliza:''?>
                    </textarea>
...
?>
            ...
            <br />
            	<div class="row">
					<div class="col-sm-4 col-md-4">
						Número de tarjeta
                    	<br />
    	    	        <input type="text" id="numeroTarjeta" name="numeroTarjeta" class="form-control input-sm" placeholder="Ingrese los 16 dígitos de la tarjeta"  />
        	        </div>
					<div class="col-sm-2 col-md-2">
						Vencimiento
                        <br />
                    	<select id="mesTarjeta" name="mesTarjeta" class="form-control input-sm">
					...
					<div class="col-sm-2 col-md-2">
                    	<br />
                    	<select id="yearTarjeta" name="yearTarjeta" class="form-control input-sm">
					...
					<div class="col-sm-2 col-md-2">
						Código de Seguridad
                    	<br />
                        <input type="text" id="ccv" name="ccv" class="form-control input-sm" />
                    </div>
                </div>
				...
				<div class="row">
                	<div class="col-sm-4 col-md-4">
                        ...
                        <br />
                    	<input type="text" id="titularTarjeta" name="titularTarjeta" class="form-control input-sm" placeholder="Como aparece en la tarjeta" />
                    </div>
                	<div class="col-sm-2 col-md-2">
                    	Tipo tarjeta
                        <br />
                    	<select id="tipoTarjeta" name="tipoTarjeta" class="form-control input-sm">
                	...
                	<div class="col-sm-2 col-md-2">
                    	Banco
                        <br />
                    	<input type="text" id="bancoTarjeta" name="bancoTarjeta" class="form-control input-sm" placeholder="Banco emisor" />
                    </div>
                	<div class="col-sm-2 col-md-2">
						Tipo de pago aplicación
                        <br />
                    	<select id="tipoPagoTarjeta" name="tipoPagoTarjeta" class="form-control input-sm">
        ...
        <div class="row" align="right">
			<div class="col-sm-12 col-md-12">
                <input type="button" value="Cancelar" onclick="window.open('<?=$urlCancelar?>','_self');" id="cancelarActividad"/>
                <input type="submit" value="<? echo "Guardar ".$this->uri->segment(3); ?>" id="guardarForm"/>
            </div>
        </div>
<?
		}
