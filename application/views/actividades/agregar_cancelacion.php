...
<!--* Fisica -->
		...
		<div class="row">
        	...
        	<div class="col-sm-10 col-md-10">
                    ...
                    <?=($idPoliza != "" && isset($idPoliza))?'CANCELACION DE LA POLIZA: '.$idPoliza:''?>
                    </textarea>
...
?>
		...
		<div class="row">
        	...
        	<div class="col-sm-10 col-md-10">
                ...
                <div>  <div class="col-sm-2 col-md-2" align="right">
                <label class="labelResponsivo">Polizas:</label>
            </div>
            <div  class="col-sm-10 col-md-10">
            <font color='red'>
                    <label class="labelResponsivo">Haga Doble click Sobre la poliza deseada para poder ver la Opcion de Guardar la Actividad</label><br>
            </font>

            <select size="10"   id="selectEndoso" style="width: 100%" <?  echo('onchange='."'".'asignaPolzai(this.value)'."'".'>') ?>>
            <? 
           ...
           if(!isset($permiteVerFol)){
            if(isset($muestraVendedores)){
             ...
             {
        echo('<option onclick='."'".'asignaPolzai("'.$dato->Documento.'"'.')'."'".'>');
                 echo($dato->Documento);
                echo('</option>');
             }           
             }
        ...
        <div class="row" align="right">
			<div class="col-sm-12 col-md-12">
                <input type="button" value="Cancelar" onclick="window.open('<?=$urlCancelar?>','_self');" id="cancelarActividad" />
                <input type="submit" id="guardarForm" value="<? echo "Guardar ".$this->uri->segment(3); ?>" id="guardarActividad"/>
            </div>
        </div>
<?
		}
...
<script type="text/javascript">
    ...
    function asignaPolzai(argumento){
       
   // document.getElementById('CKEDITOR').innerHTML="<p>fff</p>";
   
    document.getElementById('datosExpres').value="ENDOSO DE LA POLIZA: "+argumento;
