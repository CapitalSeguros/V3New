...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Causa siniestros autos</h3>
        </div>
...
<div class="modal fade" id="modal_tipos" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="form_cobertura" action="<?= base_url() ?>Siniestro_catalogos/AccionesCausasAutos" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select name="Tipo" id="Tipo" class="form-control" required oninvalid="this.setCustomValidity('Seleccione un tipo')" oninput="setCustomValidity('')">
                                     <option value="">Seleccione uno</option>
                                    <?php foreach($TiposA as $value): ?>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestro_catalogos/getTableData/8`,
                type: 'GET',
                dataSrc: 'data'
            },
                            ...
                            <div class="col-md-12">
                                <div >
                                    <div class="media-body">
                                        <h4 class="media-heading"  style="padding-left: 15px;"><strong>Causa: </strong>${row.nombre}</h4>
                                        <h5 class="media-heading"  style="padding-left: 15px;"><strong>Tipo: </strong>${row.tipo_nombre}</h5>
                                    </div>
                                </div>  
                            </div>     
                        </div>`;
        ...
        window.Editar = function (id) {
           ...
           // $('textarea[name=Descripcion]').val(oInci.descripcion);
            ...
            $('select[name=Tipo]').val(oInci.tipo_id);
