...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Coberturas GMM</h3>
        </div>
...
<div class="modal fade" id="modal_tipos" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="form_cobertura" action="<?= base_url() ?>Siniestro_catalogos/AccionesTramiteCGMM" method="POST" autocomplete="off">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <h4 class="modal-title" id="modalLabel">Tipo de cobertura</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input  type="text" class="form-control" id="Nombre" name="Nombre" placeholder="Cobertura" required oninvalid="this.setCustomValidity('Ingrese una cobertura')" oninput="setCustomValidity('')">
                      ...
                      <!--   <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion" required oninvalid="this.setCustomValidity('Ingrese una descripcion')" oninput="setCustomValidity('')"></textarea>
                            </div>
                        </div> -->
                       <!--  <div class="col-lg-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tipo</label>
                                <select class="form-control" name="tipo" id="tipo" required oninvalid="this.setCustomValidity('Seleccione una opcion')" oninput="setCustomValidity('')">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestro_catalogos/getTableData/9`,
                type: 'GET',
                dataSrc: 'data'
            },
                            ...
                            <div class="col-md-12">
                                <div >
                                    <div class="media-body">
                                        <h4 class="media-heading"  style="padding-left: 15px;"><strong>Cobertura: ${row.nombre}</strong></h4>
                                    </div>
                                </div>  
                            </div>     
                        </div>`;
        ...
        window.Editar = function (id) {
            ...
            $('select[name=tipo]').val(oInci.tipo_c);
            $('#modal_tipos').modal('show');
            return;
        }
        ...
        window.eliminar = function (id) {
            swal({
                ...
                if (value) {
                    $.ajax({
                        type: 'POST',
                        url: `${$path}Siniestro_catalogos/deleteTipoCoberturaGMM`,
                        data: {
                            "id": id,
                            //"Tipo":1
                        },
