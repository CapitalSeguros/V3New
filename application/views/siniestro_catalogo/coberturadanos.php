...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Tipos de coberturas Daños</h3>
        </div>
...
<div class="modal fade" id="modal_tipos" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="form_cobertura" action="<?= base_url() ?>Siniestro_catalogos/AccionesTramiteCDanos" method="POST" autocomplete="off">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestro_catalogos/getTableData/6`,
                type: 'GET',
                dataSrc: 'data'
            },
                                ...
                                <div>
                                    <div class="media-body">
                                        ...
                                        <div class="Siniestro-body">
                                            <div class="box first" style="padding-left: 15px;"> Descripcion: ${row.descripcion}</div>
                                            <div class="box first" style="padding-left: 15px;"> Tipo: ${row.tipo_c}</div>
                                        </div>
                                    </div>
                                </div>  
                            </div>     
        ...
        window.eliminar = function (id) {
            swal({
                ...
                if (value) {
                    $.ajax({
                        type: 'POST',
                        url: `${$path}GMM/deleteTipoCobertura`,
                        data: {
                            "id": id,
                            //"Tipo":1
                        },
