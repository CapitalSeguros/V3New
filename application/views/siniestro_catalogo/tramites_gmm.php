...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Tipos de trámites de GMM</h3>
        </div>
...
<div class="modal fade" id="modal_tipos" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="form_cobertura" action="<?= base_url() ?>Siniestro_catalogos/AccionesTramiteGmm" method="POST" autocomplete="off">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestro_catalogos/getTableData/4`,
                type: 'GET',
                dataSrc: 'data'
            },
        ...
        window.eliminar = function (id) {
            swal({
                ...
                if (value) {
                    $.ajax({
                        type: 'POST',
                        url: `${$path}Siniestro_catalogos/deleteTramiteGmm`,
                        data: {
                            "id": id,
                            //"Tipo":1
                        },
