...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Tipos de documentos</h3>
        </div>
...
<div class="modal fade" id="modal_tipos" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="form_cobertura" action="<?= base_url() ?>Siniestro_catalogos/AccionesTipoDocumento" method="POST" autocomplete="off">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestro_catalogos/getAllTiposDocumentos`,
                type: 'GET',
                dataSrc: 'data'
            },
                            ...
                            <div class="col-md-12">
                                <div >
                                    <div class="media-body">
                                        <h4 class="media-heading"  style="padding-left: 15px;"><strong>Documento: ${row.nombre}</strong></h4>
