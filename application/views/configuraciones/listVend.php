...
<section class="container-fluid breadcrumb-formularios">
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5"><h3 class="titulo-secciones">Lista de Vendedores</h3></div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-md-offset-8 col-sm-offset-8">
                            	<form id="form" method="GET" action="<?=base_url()?>configuraciones/listVend">
                            ...
                            <form id="ExportaAgentes" method="GET" action="<?=base_url()?>configuraciones/ExportaAgentes" style="float: left;">
                        ...
                        <div>
                            <form id="ExportaAgentes"  method="GET" action="<?=base_url()?>actualizaVendedores/descargarSicasVendedoresDos">
                                     <button class="btn btn-primary btn-sm"
                                            name="ExportaAgentes" id="ExportaAgentes"
                                        >
                                            Actuzaliza Agentes
                                   ...
                                   <input type="text" name="ultimoInsertado" value="<?php if(isset($ultimoInsertado)) {echo($ultimoInsertado);} ?>"/>
						...
						<table class="table" id='Mitabla' >
							...
							?>
										<tr>
											...
											<td><?=$row->email?></td>
											<td>
		                                    	<a href='<?=base_url()."configuraciones/editVend?idInterno=".$row->id?>'>
