    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select id="training-for-report" class="form-control">
                ...
                <div class="col-md-4">
                    <select id="sub-training-for-report" class="form-control">
                        <option value="">Seleccione</option>
                    </select>
                </div>
                <div class="col-md-2 mt-2">Seleccione una mes</div>
                <div class="col-md-2 mt-2">
                    <select id="month-for-report" class="form-control">
                        <option value="">Seleccione</option>
                ...
                <div class="col-md-2 mt-2">
                    <select id="year-for-report" class="form-control">
                        <option value="">Seleccione</option>
                ...
                <div class="col-md-2 mt-2 text-center">
                    <button class="btn btn-info btn-sm apply-search">Aplicar</button>
                </div>
            </div>
        </div>
    </div>
    <div class="content-training-1 mt-4"></div>
</div>