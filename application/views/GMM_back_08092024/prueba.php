...
<section class="container-fluid breadcrumb-formularios">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">GMM (GASTOS MEDICOS MAYORES) <?=var_dump($tipo)?></h3>
        </div>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="inicio_tramite" id="inicio_tramite" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
            ...
            initComplete: function() {
                ...
                <div class="row">
                    <div class="col-md-12 text-right" style="margin-top: 10px;">
                            <a class="btn btn-primary" data-permiso="permiso" data-accion-permiso="Nuevo" href="<?=base_url()?>GMM/RegistroGMM">Nuevo</a>
                    </div>
                </div>
                </div>`
                        ...
                        <div style="text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dp${row.id}">
                                        ...
                                        ${permisos.includes(row.estatus)|| row.nombre_tramite==null?``:`<li><a class="bn-bono-view"  style="cursor: pointer;" onclick='EditTramite(${row.id})' >Editar trámite</a></li>`}
                                        ${permisos.includes(row.estatus)|| row.estatus==null?`<li><a class="bn-bono-view"  style="cursor: pointer;" onclick="Tramite(${row.id})" >Nuevo tramite </a></li>`:``}
                                        ${/* row.estatus=="FINIQUITADO" */permisos.includes(row.estatus)|| row.nombre_tramite==null?``:`<li><a class="bn-bono-view"  style="cursor: pointer;" onclick='ChangeStatus(${row.id_tramite},${row.id_est_tra},${row.orden_tram},${row.id})' >Cambiar estatus</a></li>`}
             ...
             $.ajax({
                ...
                success: async function (data) {
                    ...
                    data.forEach((element,key) => {
                        ...
                        const kyesCAfectada = _.find(_cobertura, function (it) {
                            return it.id == element.info.cobertura_afectada;
                        });
                        console.log('keysCobertura',kyesCAfectada);
                        ...
                        element.documentos.forEach(elementdc => {
                           /*  dcc+=`<div class="box first" style="padding-left: 15px;cursor:pointer;">
                            <a data-nombre='${elementdc.nombre}' data-id='${elementdc.file_id}' class='js-preview-item' >${elementdc.nombre}</a>
                            </div>`; */
                            dcc+=`<div class="col-md-2">
                                    <div class="form-group">
        ...
        window.ChangeStatus=function(id_tramite,id,orden,idSiniestro){
            ...
            var IsFechaFin=`<div class="col-lg-12 hidden" id="cont_fecha">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id='fecha_fin' max=${moment().format('YYYY-MM-DD')}>
                                </div>
                            </div>`;
        ...
        $("#form_tramite").validate({
            ...
            submitHandler: function(form) {
                ...
                $('.fileD').each(function(index,value){
                    //console.log('filedoc',$(`#${value.name}`).prop('files'));
                   ...
                   /*  DocFiles.forEach((element,key) => {
                        console.log('filedoc',element);
                    }); */
