       ...
       /*  const preview = new FilePreview({
        ...
        const datatable = $('#example').DataTable({
            ...
            initComplete: function() {
                   let btnNuevo='';
                  if(IDVendVarGlobal==0){btnNuevo=`                    <div class="col-md-12 text-right" style="margin-top: 10px;">
                            <a class="btn btn-primary" href="<?=base_url()?>GMM/RegistroGMM" data-permiso="permiso" data-accion-permiso="Nuevo">Nuevo</a>
                    </div>`}
                var tmp = `
                <div>
                <div class="row">
