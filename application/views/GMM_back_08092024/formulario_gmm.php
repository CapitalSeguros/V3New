                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="correo_asegurado" name="correo_asegurado" placeholder="Correo electronico" value="<?=isset($poliza['EMail1'])?is_object($poliza['EMail1'])?'':$poliza['EMail1']:''?>" readonly/>
                            </div>
                        </div>
                    </div>
