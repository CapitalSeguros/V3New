...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/submarca`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="col-md-12">
                                   <div>
                                        <b> SubMarca: ${row.Nombre} | Marca: ${row.Marca}</b> 
        ...
        $(document).on('click', '#btnADD', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/submarca/0`,
                data: {
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/submarca/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#IdMarca").val(data.Datos.Registro.IdMarca);
                    $('#EstatusM').show();
                    $('#mdADD').modal('show');
                },
                error: function(data) {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/submarca_put/${id}`,
                        data: {
