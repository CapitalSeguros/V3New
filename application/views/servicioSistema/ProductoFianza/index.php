    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Producto Fianza</h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Estatus Documento</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Abreviacion</label>
                        <input type="text" class="form-control fieldForm" name="Abreviacion" id="Abreviacion" placeholder="Abreviacion">
                        <span id="e_Abreviacion" class="error"></span>
                    </div>
                    <div class="form-group" >
                        <label>Tipo Fianza</label>
                        <select class="form-control fieldForm" name="IdMarca" id="IdMarca">
                        </select>
                        <span id="e_IdMarca" class="error"></span>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/producto_fianza`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            <div class="col-md-12">
                                   <div>
                                        <b> Producto: ${row.Nombre} | Tipo Fianza: ${row.TFianza}</b> 
        ...
        $(document).on('click', '#btnADD', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/producto_fianza/0`,
                data: {

                },
                success: function(data) {
                    //Agrgamos las opciones del control
                    var html = '<option value="">Seleccione una opción </option>';
                    data.Datos.Marcas.forEach((element, key) => {
                        html += `<option value="${element.IDTFianza}">${element.Nombre}</option>`;
                    });
                    $("#IdMarca").html('');
                    $("#IdMarca").html(html);
                },
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/producto_fianza/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#IdItem").val(data.Datos.Registro.Id);
                    $("#Nombre").val(data.Datos.Registro.Nombre);//Abreviacion
                    $("#Abreviacion").val(data.Datos.Registro.Abreviacion);
                    //$("#Active").val(data.Datos.Registro.Active);
                    $("#IdMarca").val(data.Datos.Registro.Id_tipofianza);
                    //$('#EstatusM').show();
                    $('#mdADD').modal('show');
                },
                error: function(data) {
        ...
        $("#form_tramite").validate({
            ...
            messages: {
               ...
               /*  Active: {
                ...
                IdMarca: {
                    required: "Seleccione un tipo de fianza.",
                },
                Abreviacion: {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/producto_fianza_put/${id}`,
                        data: {
