    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Motivo Cancelación</h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" >
                        <label>Grupo</label>
                        <select class="form-control fieldForm" name="IdGrupo" id="IdGrupo">
                        </select>
                        <span id="e_IdGrupo" class="error"></span>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/motivocancelacion`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="col-md-12">
                                   <div>
                                        <b> Motivo: ${row.Nombre} | Estatus Cancelacion: ${row.EstatusCancelacion}</b> 
        ...
        $(document).on('click', '#btnADD', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/motivocancelacion/0`,
                data: {
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/motivocancelacion/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#Nombre").val(data.Datos.Registro.Nombre);
                    $("#Active").val(data.Datos.Registro.Active);
                    $("#IdGrupo").val(data.Datos.Registro.Id_Cancelacion);
                    $('#EstatusM').show();
                    $('#mdADD').modal('show');
                },
                error: function(data) {
        ...
        $("#form_tramite").validate({
            ...
            messages: {
                ...
                IdGrupo: {
                    required: "Seleccione una Estatus Cancelación.",
                },
            },
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/motivocancelacion_put/${id}`,
                        data: {
