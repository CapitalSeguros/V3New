    ...
    <section class="container-fluid breadcrumb-formularios">
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Despacho</h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Centro costos</label>
                        <input type="text" class="form-control fieldForm" name="CentroCosto" id="CentroCosto" placeholder="Centro Costos">
                        <span id="e_Nombre" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Oficina</label>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/despacho`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/despacho/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#CentroCosto").val(data.Datos.CentroCostos);
                    $("#Oficina").val(data.Datos.IdOficina);
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/despacho_put/${id}`,
                        data: {
        ...
        window.GetOficinas = function() {
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/oficinaDepartamento`,
                data: {},
                success: function(data) {
                    var dta = data.Datos;
                    var Options = `<option value=''>Seleccione una opcion</option>`;
                    dta.forEach(element => {
                        Options += `<option value='${element.Id}'>${element.RazonSocial}</option>`;
                    });
                    $("#Oficina").html('');
