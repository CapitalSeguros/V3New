    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">SubMarca</h3>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/subgrupo`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="col-md-12">
                                   <div>
                                        <b> SubGrupo: ${row.Nombre} | Grupo: ${row.Grupo}</b> 
        ...
        $(document).on('click', '#btnADD', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/subgrupo/0`,
                data: {
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/subgrupo/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#IdGrupo").val(data.Datos.Registro.IdGrupo);
                    $('#EstatusM').show();
                    $('#mdADD').modal('show');
                },
                error: function(data) {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/subgrupo_put/${id}`,
                        data: {
