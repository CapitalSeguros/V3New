    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Moneda</h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Moneda</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Prefijo</label>
                        <input type="text" class="form-control fieldForm" name="Prefijo" id="Prefijo" placeholder="Prefijo">
                        <span id="e_Alias" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Sufijo</label>
                        <input type="text" class="form-control fieldForm" name="Sufijo" id="Sufijo" placeholder="Sufijo">
                        <span id="e_Alias" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Descripcion</label>
                        <input type="text" class="form-control fieldForm" name="Descripcion" id="Descripcion" placeholder="Descripcion">
                        <span id="e_Alias" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Tipo cambio</label>
                        <input type="number" class="form-control fieldForm" name="TipoCambio" id="TipoCambio" placeholder="Tipo cambio">
                        <span id="e_Alias" class="error"></span>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/moneda`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/moneda/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#Nombre").val(data.Datos.Moneda);
                    $("#Sufijo").val(data.Datos.Sufijo);
                    $("#Prefijo").val(data.Datos.Prefijo);
                    $("#Descripcion").val(data.Datos.Descripcion);
                    $("#TipoCambio").val(data.Datos.TipoCambio);
        ...
        $("#form_tramite").validate({
            ...
            messages: {
                ...
                Prefijo: {
                    required: "Seleccione un Prefijo.",
                },
                Sufijo: {
                    required: "Seleccione un Sufijo.",
                },
                Descripcion: {
                    required: "Seleccione un Descripcion.",
                },
                TipoCambio: {
                    required: "Seleccione un Tipo Cambio.",
                },
                Active: {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/moneda_put/${id}`,
                        data: {
