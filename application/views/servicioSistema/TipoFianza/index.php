    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Tipo Fianza</h3>
            </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-condensed" id="polizas">
                                <thead>
                                    <tr>
                                        <th scope="col">Id</th>
                                        <th scope="col" style="width: 200px;">Registro</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/tipofianza`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                            ...
                            <div class="col-md-12">
                                   <div>
                                        ...
                                        <div style="text-align: right; margin-top: -30px;">
                                                    <div class="dropdown">
                                                        <button class="btn btn-link dropdown-toggle" type="button" id="dp${row.IDTemp}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" >
                                                            <i class="fa fa-ellipsis-v" aria-hidden="true"></i>
                                                        </button>
                                                        <ul class="dropdown-menu dropdown-menu-right"  aria-labelledby="dp${row.IDTemp}">
                                                            <li><a class="bn-bono-view"  style="cursor: pointer;" onclick="EditItem(${row.IDTemp})"  data-permiso="permiso" data-accion-permiso="Editar">Editar</a></li>
                                                            <li onclick="DeleteItem('${row.IDTemp}')" data-id="${row.IDTemp}"><a class="bn-bono-view"  style="cursor: pointer;"   data-permiso="permiso" data-accion-permiso="Editar">Eliminar</a></li>
                                                        </ul>
                                                    </div>
                                        </div>
                                   </div> 
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/tipofianza/${id}`,
                data: {

                },
                success: function(data) {
                    $("#IdItem").val(data.Datos.IDTemp);
                    $("#Nombre").val(data.Datos.Nombre);
                    $("#Abreviacion").val(data.Datos.Abreviacion);
        ...
        $("#form_tramite").validate({
            ...
            submitHandler: function(form) {
                ...
                if(data.objeto.IDTemp==""){
                    delete data.objeto.IDTemp;
                }
                $.ajax({
                    url: `${$pathServicio}catalogos/tipofianza`,
                    type: form.method,
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/tipofianza_put/${id}`,
                        data: {
