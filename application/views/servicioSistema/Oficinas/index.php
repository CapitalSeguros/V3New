    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Oficinas</h3>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fieldForm" name="Nombre" id="Nombre" placeholder="Razon Social">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/oficina`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/oficina/${id}`,
                data: {
        ...
        $("#form_tramite").validate({
            ...
            messages: {
                Nombre: {
                    required: "Ingrese una Razon Social.",
                },
                Alias: {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/oficina_put/${id}`,
                        data: {
