    ...
    <section class="container-fluid breadcrumb-formularios">
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Editar Compañia</h3>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fieldForm" name="Telefonos" id="Telefonos" placeholder="Nombre">
                        <span id="e_Alias" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Tipo Dirección</label>
                        <input type="text" class="form-control fieldForm" name="TipoDireccion" id="TipoDireccion" placeholder="Nombre">
                        <span id="e_Alias" class="error"></span>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/direcciones`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/direcciones/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#Nombre").val(data.Datos.Direccion);
                    $("#Telefonos").val(data.Datos.Telefonos);
                    $("#TipoDireccion").val(data.Datos.TipoDireccion);
        ...
        $("#form_tramite").validate({
            ...
            messages: {
                ...
                TipoDireccion: {
                    required: "Ingrese un Tipo de dirección.",
                },
                Active: {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/direcciones_put/${id}`,
                        data: {
