    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Forma Pago</h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Forma Pago</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fieldForm" name="Alias" id="Alias" placeholder="Nombre">
                        <span id="e_Alias" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Numero de pagos</label>
                        <input type="number" class="form-control fieldForm" name="NumPagos" id="NumPagos" placeholder="Numero de pagos">
                        <span id="e_NumPagos" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Temporalidad</label>
                        <input type="number" class="form-control fieldForm" name="Temporalidad" id="Temporalidad" placeholder="Temporalidad">
                        <span id="e_Temporalidad" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Periodo</label>
                        <select class="form-control fieldForm" name="Periodo" id="Periodo">
                            <option value="">Seleccione una opcion</option>
                            <option value="DIAS">Dias</option>
                            <option value="MESES">Meses</option>
                            <option value="ANOS">Años</option>
                        </select>
                        <span id="e_Periodo" class="error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Periodo de Gracia</label>
                        <input type="text" class="form-control fieldForm" name="PeriodoGracia" id="PeriodoGracia" placeholder="Periodo de Gracia">
                        <span id="e_PeriodoGracia" class="error"></span>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/formapago`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
        ...
        window.EditItem = function(id) {
            ...
            $.ajax({
                type: 'GET',
                url: `${$pathServicio}catalogos/formapago/${id}`,
                data: {
                ...
                success: function(data) {
                    ...
                    $("#Nombre").val(data.Datos.FormaPago);
                    $("#Alias").val(data.Datos.Alias);
                    $("#NumPagos").val(data.Datos.NumPagos);
                    $("#Temporalidad").val(data.Datos.Temporalidad);
                    $("#Periodo").val(data.Datos.Periodo);
                    $("#PeriodoGracia").val(data.Datos.PeriodoGracia);
        ...
        $("#form_tramite").validate({
            ...
            messages: {
                ...
                NumPagos: {
                    required: "Ingrese Numero de pagos.",
                },
                Temporalidad: {
                    required: "Ingrese la Temporalidad.",
                },
                Periodo: {
                    required: "Ingrese un Periodo.",
                },
                PeriodoGracia: {
                    required: "Ingrese un Periodo de Gracia.",
                },
                Active: {
            ...
            submitHandler: function(form) {
                ...
                data = {
                    "objeto": {
                        "Id": $("#IdItem").val(),
                        "FormaPago": $("#Nombre").val(),
                        "Alias": $("#Alias").val(),
                        "NumPagos": $("#NumPagos").val(),
                        "Temporalidad": $("#Temporalidad").val(),
                        "Periodo": $("#Periodo").val(),
                        "PeriodoGracia": $("#PeriodoGracia").val(),
                        "Active": $("#Active").val()
                    }
                };
                if (data.objeto.Id == "") {
        ...
        window.DeleteItem = function(id) {
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `${$pathServicio}catalogos/formapago_put/${id}`,
                        data: {
