    ...
    <section class="container-fluid breadcrumb-formularios">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-5 col-xs-5">
                <h3 class="titulo-secciones">Vendedores</h3>
            </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-10 text-right" style="margin-top: 15px;">
                            <a id="btnADD" class="btn btn-primary Nuevo" href="<?=base_url()?>/servicioSistema/VendedorAdd">Nuevo</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#polizas').DataTable({
            ...
            ajax: {
                url: `${$pathServicio}catalogos/vendedores`,
                type: 'GET',
                "data": function(d) {
                    return $.extend({}, d, {
                        "search": $("#txSearch").val(),
                            ...
                            <div class="col-md-12">
                                   <div>
                                        <div style="text-align: right;">
                                                    <div class="dropdown">
                                                        <button class="btn btn-link dropdown-toggle" type="button" id="dp${row.IDVend}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" >
                                                            <i class="fa fa-ellipsis-v" aria-hidden="true"></i>
                                                        </button>
                                                        <ul class="dropdown-menu dropdown-menu-right"  aria-labelledby="dp${row.IDVend}">
                                                            <li><a class="bn-bono-view"  style="cursor: pointer;" href="${$path}servicioSistema/VendedorEdit/${row.IDVend}"  data-permiso="permiso" data-accion-permiso="Editar">Editar</a></li>
                                                        </ul>
                                                    </div>
                                        </div>
                                   </div> 
