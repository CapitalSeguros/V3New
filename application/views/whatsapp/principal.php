						...
						<div class="bhoechie-tab-menu menu-sidebar menu-sidebar-close" id="menuSms" style="height:550px">
							...
							<div class="list-group">
								...
								?>
									...
									if($userProfile ==4 || $userProfile ==3) {
									?>
							...
							<div class="col-sm-12 col-md-12" align="right">
								...
								?>
										<div class="btn-send">
											...
											$content = "<span class=\"glyphicon glyphicon-send\"></span> Enviar WhatsApp";
		...
		if(isset($Catalogo_Perfiles)):
			...
			?>
				<div class="bhoechie-tab-content table-responsive">
					<div class="form-group">
						<label>
							<input type="checkbox" class="client" data-alias="tablaVen-<?php echo $value["idTipoUser"]; ?>"> 
							Todos los <?php echo $item["Name"]; ?>
						</label>		
					<?php if( isset($item["Data"]) && $item["Data"] != NULL ): ?>		                       
						<table 
                        	class="table table-hover table-email-gap" 
                            id="tablaVenC-<?= $value["idTipoUser"]; ?>" 
...
<div class="modal cargando"><!-- Place at bottom of page --></div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("div.bhoechie-tab-menu>div.list-group>a").click(function(e) {	console.log(e)
				e.preventDefault();
