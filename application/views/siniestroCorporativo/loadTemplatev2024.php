                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?= !isset($siniestro_poliza["cliente"]) ? "" : $siniestro_poliza["cliente"] ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" id="cliente" name="cliente" placeholder="Cliente" data-toggle="tooltip" data-placement="top" title="Cliente">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" value="<?= !isset($siniestro_poliza["vendedor"]) ? "" : $siniestro_poliza["vendedor"] ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"])  ? "" : "inputdcss" ?>" placeholder="Vendedor" id="vendedor" name="vendedor" data-toggle="tooltip" data-placement="top" title="Vendedor">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">
                                                                    <i class="fa fa-search"></i>
                                                                </span>
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label >Inciso</label>
                                                        <input type="text" value="<?= !isset($siniestro_poliza["inciso"]) ? "" : $siniestro_poliza["inciso"] ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" placeholder="Inciso" id="inciso" name="inciso" data-toggle="tooltip" data-placement="top" title="Inciso">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" value="<?= !isset($siniestro_poliza["compania"]) ? "" : $siniestro_poliza["compania"] ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" placeholder="Compañia" id="compania" name="compania" data-toggle="tooltip" data-placement="top" title="Compañia">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">
                                                                    <i class="fa fa-search"></i>
                                                                </span>
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <div class="custom-date no-show">
                                                            <label>Desde</label>
                                                            <input type="date" value="<?= !isset($siniestro_poliza["f_inicio"]) ? "" : ($siniestro_poliza["f_inicio"] != "" ? date('Y-m-d', strtotime($siniestro_poliza["f_inicio"])) : "") ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" id="f_inicio" name="f_inicio" data-toggle="tooltip" data-placement="top" title="Desde">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <div class="custom-date no-show">
                                                            <label>Hasta</label>
                                                            <input type="date" value="<?= !isset($siniestro_poliza["f_fin"]) ? "" : ($siniestro_poliza["f_fin"] != "" ? date('Y-m-d', strtotime($siniestro_poliza["f_fin"])) : "") ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" id="f_fin" name="f_fin" data-toggle="tooltip" data-placement="top" title="Hasta">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        <label >Clave</label>
                                                        <input type="text" value="<?= !isset($siniestro_poliza["clave"]) ? "" : $siniestro_poliza["clave"] ?>" class="form-control form-control-sm siniestro-p <?= !isset($siniestro_poliza["id"]) ? "" : "inputdcss" ?>" placeholder="Clave" id="clave" name="clave" data-toggle="tooltip" data-placement="top" title="Clave">
                                                    </div>
                                                </div>
