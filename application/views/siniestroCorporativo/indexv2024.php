    ...
    <script>
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            <div class="col-md-12">
                                   ...
                                   <b> Nombre del Cliente:</b> ${row.cliente} | <b>Póliza:</b> ${row.poliza}| <b>Clave:</b> ${row.clave}| <b>Inciso:</b> ${row.inciso} | <b>Compañia:</b>  ${row.compania} </br>
                                   <b>Desde: </b> ${row.f_inicio==null || row.f_inicio=="0000-00-00 00:00:00"?'N/A':moment(row.f_inicio).format("DD/MM/YYYY")}  <b>Hasta:</b>${row.f_fin==null || row.f_fin=="0000-00-00 00:00:00"?'N/A':moment(row.f_fin).format("DD/MM/YYYY")} 
                                   </div>
                            </div>`
                        }
                    },
            ...
            window.test = function(row) {
                ...
                $('#inciso').val(dataelement.inciso).addClass('inputdcss');
                $('#compania').val(dataelement.compania).addClass('inputdcss');
                //console.log('Fecha',moment(dataelement.f_inicio).format("YYYY-MM-DD"))
                $('#f_inicio').val(moment(dataelement.f_inicio).format("YYYY-MM-DD")).addClass('inputdcss');
                $('#f_fin').val(moment(dataelement.f_fin).format("YYYY-MM-DD")).addClass('inputdcss');
                $('#clave').val(dataelement.clave).addClass('inputdcss');
                $('#vendedor').val(dataelement.vendedor).addClass('inputdcss');
                $('#cliente').val(dataelement.cliente).addClass('inputdcss');
