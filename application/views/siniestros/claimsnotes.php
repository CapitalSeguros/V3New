<?php
    ...
    //$this->load->view('siniestro_catalogo/sidemenu2', array("tipo" => "C_AUTOS"));
    $title_ =  "";
    switch($tipo){
        case "C_AUTOS": $title_ = "AUTOS";
        break;
        case "C_GMM": $title_ = "GMM";
        break;
        case "C_DANOS": $title_ = "DAÑOS";
        break;
    }
?>
...
<div class="container">
    ...
    <div style="float: left; width: 90%;">
        <div class="panel panel-body">
            <h4>Notas de siniestros tipo: <?=$title_?></h4>
            <?php if(!empty($notes)){
                                ...
                                <tbody>
                                    ...
                                    <? foreach($dnote as $dasssig){?>
                                        <tr class="text-center">
                                            ...
                                            <td></td>
                                            <td>
                                                <button type="button" class="btn btn-link btn-sm show-info" data-toggle="modal" data-target="#show-note" data-backdrop="" data-idnote="<?=$dasssig->id?>" data-policy="<?=$dasssig->poliza?>" data-controller="<?=str_replace("DAÑOS", "DANOS", $title_)?>">
                                                    Ver nota
                                                </button>
                                            </td>
                                        </tr>
