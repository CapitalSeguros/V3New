...
<section class="container-fluid breadcrumb-formularios">
	<div class="row">
		<div class="col-md-6 col-sm-5 col-xs-5">
			<h3 class="titulo-secciones">Tienda - Agregar Categor&iacute;as</h3>
		</div>
		<div class="col-md-6 col-sm-7 col-xs-7">
			<ol class="breadcrumb text-right">
				...
				<li class="active">Tienda - Agregar Categor&iacute;as</li>
			</ol>
		</div>
	</div>
	<hr /> 
...
<section class="page-section">
	<div class="container">
		...
		<form
            ...
            action="<?=base_url();?>tienda/AgregarCategoria" 
        >
		<div class="row">
