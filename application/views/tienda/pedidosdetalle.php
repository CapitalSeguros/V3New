                                                ...
                                                <th class="small-12 large-12 columns first last">
                                                    <table>
                                                        <tr>
                                                            <th>
                                                                <br>
                                                                <center data-parsed=""> <img src="http://agentecapital.com/wp-content/uploads/2015/09/Logo210.png" align="center" class="text-center"> </center>
                                                                <br>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <table class="table">
                                                                            ...
                                                                            <tfoot>
                                                                                <tr>
                                                                                    <td class="text-right" style="text-align:right;" colspan="6">
                                                                                       <span >Importe Total:  <?php echo '$'.number_format($totalPedido,2,'.',',');?></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tfoot>
                                                                        </table>
