...
<div class="well" style="margin-top: 10px;margin-right: 5px;margin-left: 5px; background: #fff;">
 ...
 <table style="width: 100%" border="0">
     <tr>
         ...
         <td align="right"><h5>Agente(s) Selecciónado(s) para Actualización Status</h5>&nbsp;</td>
     </tr>
 </table>
<div class="well">
    <table style="width: 50%;" border="0">
        <tr><td colspan="2"><h5>Realice Modificaciónes</h5></td></tr>
        <tr>
            <td style="text-align: right;">Status:&nbsp;</td>
            <td>
                <select name="status" id="status" class="form-control" style="font-size: 12px;height: 30px;">
        ...
        <tr>
            <td></td>
            <td>
                <button class="btn btn-primary btn-md" onclick="modificar_agentes_seleccionados()"><i class="fa fa-cogs"></i>&nbsp;Guardar Modificaciónes</button>
            </td>
        </tr>
    </table>
</div>
