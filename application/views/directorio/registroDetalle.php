	        ...
	        <div class="col-md-12">
	            <div class="row">
	                <div class="form-group col-md-6 col-sm-6 col-xs-4">
		                <a href="<?php echo base_url(); ?>directorio/GetPoliza?IDCli=<?php echo $IDCli; ?>&page=<?php echo $page; ?>" title="DOCUMENTOS" class="btn btn-default btn-sm">&nbsp;<i class="glyphicon glyphicon-inbox"></i>&nbsp;</a>
	            ...
	            <ul class="nav nav-tabs" role="tablist">
	                ...
	                <li role="presentation"><a href="#tab-03" aria-controls="tab-03" role="tab" data-toggle="tab">Direcciones</a></li>
	            </ul>
