...
<section class="container-fluid breadcrumb-formularios">
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5"><h3 class="titulo-secciones">Detalle directorio</h3></div>
        <div class="col-md-6">
            <ol class="breadcrumb text-right">
                <li><a href="./">Inicio</a></li>
                <li><a href="<?php echo base_url(); ?>directorio">Directorio</a></li>
                <li class="active">Detalle directorio</li>
            </ol>
        </div>
    </div>
        <hr /> 
	 	...
	 	<div class="row">
	        <div class="col-md-12">
	            ...
	            <ul class="nav nav-tabs" role="tablist">
	                ...
	                <li role="presentation"><a href="#tab-03" aria-controls="tab-03" role="tab" data-toggle="tab">Direcciones y Telefonos</a></li>
	            </ul>
	            ...
	            <div class="tab-content">
	            	<div role="tabpanel" class="tab-pane fade in active" id="tab-01">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="form-group col-md-3 col-sm-3 ctn-f <?php echo ($ClienteContact["cliente"]->TipoEnt == '1')?'entidad-moral':''; ?>">
	                            <label for="Celular">Apellido Paterno</label>
						...
						<div class="row">
	                        ...
	                        <div class="form-group col-md-3 col-sm-3">
	                            <label for="Correo1">Preferencia de Comunicacion</label>
	                            <div class="input-group">
	                                 <label class="form-control input-sm" disabled><?=$formasContacto->preferenciaComunicacion?></label>
	                            </div>
	                        </div>
	                       <div class="form-group col-md-3 col-sm-3">
	                            <label for="Correo1">Dia de Comunicacion</label>
	                            <div class="input-group">
	                             <label class="form-control input-sm" disabled><?=$formasContacto->horarioComunicacion?></label>
	                            </div>
	                        </div>
	                        <div class="form-group col-md-3 col-sm-3">
	                            <label for="Correo1">Horario de Comunicacion</label>
	                            <div class="input-group">
	                              <label class="form-control input-sm" disabled><?=$formasContacto->diaComunicacion?></label>
	                            </div>
	                        </div>	                        
						</div>
	                </div>
		            ...
		            <div role="tabpanel" class="tab-pane fade" id="tab-03">
		                <div class="row">
		                    <div class="form-group col-md-12 text-right">
		                        <a href="#"  class="btn btn-default btn-sm addDic ctl-save"  title="Agregar direcci�n" disabled >&nbsp;<i class="fa fa-plus-circle fa-lg"></i> Agregar direcci&#243;n</a>
		                    </div>
		                </div>
		                <div class="row">
