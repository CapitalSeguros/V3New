  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
		...
		<div class="modal-footer">
			<!-- INICIO | Tic Consultores | Miguel Avila | 30809/2021 -->
			<div id='nuevoSiniestro' style='padding-right: 41vw;'></div>
			<!-- Fin | Tic Consultores | Miguel Avila | 30809/2021 -->
...
<script>
	...
	$(document).ready(function(){
		$("tr").click(function(){
			...
			$.each(ajson,function(k,v){
				if(v.IDDocto == IDDocto){
					...
					////INICO |Tic Consultores | Miguel Avila | 30/09/2021
					NuevoSiniestro(v.RamosNombre,v.IDDocto);
					//FIN |Tic Consultores | Miguel Avila | 30/09/2021
					return;
				}
		...
		//INICO |Tic Consultores | Miguel Avila | 30/09/2021
		//funicion para generar la accion de registro de nuevo siniestro
		function NuevoSiniestro(Ramo,IDDocto){
			var base='<?= base_url()?>';
			var url='';
			switch (Ramo) {
				case 'Vehiculos':
					url=`Autos/RegistroAutos?documento=${IDDocto}`;
					break;
				case 'Daños':
					url=`Danos/RegistroDanos?documento=${IDDocto}`;
					break;
				case 'Beneficios':
				case 'Accidentes y Enfermedades':
				case 'Vida':
					url=`GMM/RegistroGMM?documento=${IDDocto}`;
					break;
			}
			if(url!=''){
				$("#nuevoSiniestro").html('');
				$("#nuevoSiniestro").html(`
					<a type="button" class="btn btn-primary" href="${base+url}" target="_blank">Nuevo Siniestro</a>
				`);
			}
		}
		// FIN|Tic Consultores | Miguel Avila | 30/09/2021
