...
<div class="table-resultados-modal view-search-polizas" id="search-polizas" style="left: 30%;top: 5%/*display:none*/;position: absolute;top:-180px;left: 12px">
    <div class="col-md-12" style="padding:0px;">
            ...
            <div class="modal-header" id="seccionSearch" style="height:60px; border-radius:5px; cursor:all-scroll;">
                <div class="input-group mb-3" id="busqueda">
                    <select class="input-group-text select-buscar" id="SelectSearch" title="Tipo de búsqueda" style="font-size:14px; border-top-right-radius:0px; border-bottom-right-radius:0px; width: 110px; text-align: left;">
                        ...
                        <option class="hidden" value="1">Número Cliente</option> <!-- Cambiar por empleado -->
                    ...
                    <div style="display: flex;flex-direction: row-reverse;">
                                               <a type="button" class="btn-seg-search btn-borrar" id="LimpiarBusqueda" title="Limpiar" style="width:25px; height:25px;">
                <i class="fa fa-eraser icon-borrar" aria-hidden="true" style="font-size:23px;"></i></a>
                  
                           <a type="button" class="btn-seg-search btn-panel" id="ViewPanelDetallesBusqueda" title="Info de resultado" data-toggle="collapse" href="#PanelDetallesBusqueda" aria-expanded="false" aria-controls="popup-causally" style="width:25px; height:25px;">
                <i class="fa fa-arrow-circle-right" id="icon-form" aria-hidden="true" style="font-size:25px;"></i>
      ...
      <a type="button" class="btn-seg-search btn-resultados" id="ViewPanelResultadosBusqueda" title="Resultados de búsqueda" data-toggle="collapse" href="#PanelResultadosBusqueda" aria-expanded="false" aria-controls="popup-causally">
                <i class="fa fa-arrow-circle-down" id="icon-result" aria-hidden="true" style="font-size:25px;"></i> 
            </a></div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content collapse" id="PanelResultadosBusqueda" style="width: 400px; margin-top:1px; visibility:visible;">
            ...
            <div class="modal-body table-responsive">
                <div class="col-md-12 segment-result" id="view-table-polizas" style="overflow:auto; padding:0px; height: 260px;">
                    <table class="table table-resultados" id="TableResultadosBusqueda" style="margin-bottom:0px;">
                        <thead id="TheadResultadosBusqueda" style="position:sticky; top:0px;">
                        </thead>
                        <tbody class="list-table-resultados-body">
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <div class="col-md-13" style="padding:0px;">
        ...
        <div class="table-polizas-modal collapse" id="PanelDetallesBusqueda" style="visibility:visible;">
            <div class="modal-content" style="width: 800px;height: 500px;margin-top: 0px;">
                <div class="modal-header" style="display: flex;flex-direction: row; align-items: center;"> <!-- height:150px; -->
                    <h4 id="TituloDetalles" style="margin-top: 0px;margin-bottom: 0px;"></h4>
                ...
                <div class="modal-body table-responsive" style="overflow: scroll;" id="Content-Info-Busqueda">
                    <!-- Solicitudes y Pólizas -->
                    <div class="col-md-12 hidden" id="VentPolizas" style="text-align:center; overflow:auto;">
                        ...
                        <div class="row"> <!-- Dos columnas -->
                            ...
                            <div class="col-md-5 second-column" style="text-align:end; height:400px;">
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Primera neta: </label>
                                    <input type="text" id="PrimeraNeta" class="form-control input-sm align-money" name="primeraMeta"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                        ...
                        <div class="row mg-row" style="margin-bottom:20px;">
                            <div class="col-md-12 container-table" style="">
                                <div class="col-md-12" style="overflow:auto; padding:0px; height: 260px;">
                                    <table class="table table-striped table-recibos" id="TableListaRecibos" style="margin-bottom: 0px;">
                        ...
                        <div class="row mg-row" style="margin-bottom:20px; overflow:auto;">
                            <div class="col-md-12 container-table">
                                <table class="table table-striped table-totales" id="TableTotales" style="height:200px; margin-bottom: 0px;">
                                    <thead style="position: sticky;top: 0px;">
                    ...
                    <div class="col-md-12 hidden" id="VentPolizas" style="text-align:center; overflow:auto;">
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">Tipo documento</label>
                                <input type="text" id="sTipoDocumento" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">Póliza maestra</label>
                                <input type="text" id="sPoliza" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">Estatus</label>
                                <input type="text" id="sEstatus" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">No. de Folio</label>
                                <input type="text" id="sFolio" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">Documento</label>
                                <input type="text" id="sDocumento" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">Inciso</label>
                                <input type="text" id="sInciso" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="text-bold">Anterior</label>
                                <input type="text" id="sAnterior" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="text-bold">Posterior</label>
                                <input type="text" id="sPosterior" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-7 dr">
                                <label class="title-item-consult">Cliente</label>
                                <input type="text" id="sCliente" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-3 dr">
                                <label class="title-item-consult">RFC</label>
                                <input type="text" id="sRFC" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Grupo</label>
                                <input type="text" id="sGrupo" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Subgrupo</label>
                                <input type="text" id="sSubGrupo" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Sub subgrupo</label>
                                <input type="text" id="sSSubGrupo" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:10px;">
                            <div class="col-sm-8 dr">
                                <label class="title-item-consult">Dirección</label>
                                <input type="text" id="sDireccion" class="form-control input-sm" style="width:100%;">
                            </div>
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Subramo</label>
                                <input type="text" id="sSubRamo" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row"> <!-- Dos columnas -->
                            <div class="col-md-6" style="margin-bottom:10px; width:50%; text-align:initial; padding-top:10px; padding-left: 0px;">
                                <div class="col-md-12 space-bottom">
                                    <label class="title-item-consult">Agente</label>
                                    <input type="text" id="sAgente" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-12 space-bottom">
                                    <label class="title-item-consult">Compañía</label>
                                    <input type="text" id="sCompania" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Ejecutivo</label>
                                    <input type="text" id="sEjecutivo" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Forma de pago</label>
                                    <input type="text" id="sPago" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Vendedor</label>
                                    <input type="text" id="sVendedor" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Moneda</label>
                                    <input type="text" id="sMoneda" class="form-control input-sm" style="width:100%;">
                                </div>
                            </div>
                            <div class="col-md-6 second-column" style="text-align:initial;">
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Desde</label>
                                    <input type="text" id="sDesde" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Hasta</label>
                                    <input type="text" id="sHasta" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Renovación</label>
                                    <input type="text" id="sRenovacion" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Fecha de antigüedad</label>
                                    <input type="text" id="sAntiguedad" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Captura</label>
                                    <input type="text" id="sCaptura" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6 space-bottom">
                                    <label class="title-item-consult">Envío</label>
                                    <input type="text" id="sEnvio" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6">
                                    <label class="title-item-consult">Recepción</label>
                                    <input type="text" id="sRecepcion" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-sm-6">
                                    <label class="title-item-consult">Emisión</label>
                                    <input type="text" id="sEmision" class="form-control input-sm" style="width:100%;">
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-12 dr">
                                <label class="title-item-consult">Concepto</label>
                                <input type="text" id="sConcepto" class="form-control input-sm" style="width:100%;">
                            </div>
                        </div>
                        <div class="row container-table" style="margin-bottom:20px;">
                            <div class="col-md-12 space-bottom">
                        ...
                        <div class="row"> <!-- Dos columnas -->
                            <div class="col-md-7" style="margin-bottom:10px; width:50%; text-align:initial; padding-top:10px; padding-left: 0px;">
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Referencia 1</label>
                                    <input type="text" id="sReferencia1" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Estatus de cobro</label>
                                    <input type="text" id="sCobro" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Referencia 2</label>
                                    <input type="text" id="sReferencia2" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Estatus usuario</label>
                                    <input type="text" id="sEstatusUsuario" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Referencia 3</label>
                                    <input type="text" id="sReferencia3" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Clasificación documento</label>
                                    <input type="text" id="sClasDoc" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Oficina</label>
                                    <input type="text" id="sOficina" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Gerencia</label>
                                    <input type="text" id="sGerencia" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Despacho</label>
                                    <input type="text" id="sDespacho" class="form-control input-sm" style="width:100%;">
                                </div>
                                <div class="col-md-6 space-bottom">
                                ...
                                <div class="col-md-6 space-bottom">
                                    <label class="title-item-consult">Tipo de conducto cobro</label>
                                    <input type="text" id="sTipoCondCobro" class="form-control input-sm" style="width:100%;">
                                </div>
                            </div>
                            <div class="col-md-5 second-column" style="text-align:end; height:400px;">
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Primera neta: </label>
                                    <input type="text" id="sPrimeraNeta" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Descuento: </label>
                                    <input type="text" id="sDescuento" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Recargos: </label>
                                    <input type="text" id="sRecargos" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Derechos: </label>
                                    <input type="text" id="sDerechos" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Subtotal: </label>
                                    <input type="text" id="sSubTotal" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">IVA: </label>
                                    <input type="text" id="sIVA" class="form-control input-sm align-money"/>
                                </div>
                                <div class="col-sm-12 sub-dr space-bottom">
                                ...
                                <div class="col-sm-12 sub-dr">
                                    <label class="title-sub-item-consult" style="padding-right:3px;">Prima Total: </label>
                                    <input type="text" id="sPrimaTotal" class="form-control input-sm align-money"/>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:20px;">
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Endoso</label>
                                <select  class="form-control input-sm mright" id="sEndoso" placeholder="Ninguno">
                                    <option value="1"></option>
                                </select>
                            </div>
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Tipo de pago</label>
                                <input type="text" id="sTipoPago" class="form-control input-sm mright"/>
                            </div>
                            <div class="col-sm-4 dr">
                                <label class="title-item-consult">Tipo de venta</label>
                                <input type="text" id="sTipoVenta" class="form-control input-sm mright"/>
                            </div>
                        </div>
                        <div class="row mg-row" style="margin-bottom:20px;">
                            <div class="col-md-12 container-table" style="">
                                <div class="col-md-12" style="overflow:auto; padding:0px; height: 260px;">
                                    <table class="table table-striped table-recibos" id="TableListaRecibosSerie" style="margin-bottom: 0px;">
                                        <thead style="position: sticky;top: 0px;">
                                            <tr style="background: #5286b5;">
                                                <th colspan="24">
                                                    <h5 style="margin:0px;">Lista de recibos</h5>
                                        ...
                                        <tbody class="list-table-recibos-serie-body" style="font-size:13px; height:140px;">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
<script type="text/javascript">
                ...
                success: (data) => {
                    ...
                    if (tipo == 2) {
                        ...
                        for(var c in r) {
                            ...
                            trtd += `
                                <tr class="filaResultados" data-id="${r[c].IDDocto}" data-clave="${r[c].Clave}" data-name="${r[c].Serie}" data-type="12" onclick="ClickResultado(this)" style="font-size:13px;">
                                    <td>${Documento}</td>
                                    <td>${Inciso}</td>
                                    <td>${Serie}</td>
                                    <td>${Cliente}</td>
                    ...
                    $('#TheadResultadosBusqueda').html(thead);
                ...
                if (tipo == 1) {
                    ...
                    trtd2 +=  `
                        ...
                        <tr style="font-size:13px;">
                            ...
                            <td class="align-money">${numberFormat.format(PPend)}</td> <!-- id="TotalNetaPendiente" -->
                    ...
                    $('#sTipoDocumento').val(TipoDocto_TXT);
                    //$('#sPoliza').val(doc.); //Pendiente
                    $('#sEstatus').val(Status_TXT);
                    //$('#sFolio').val(doc.FolioNo); //Pendiente FolioDocto solo en Recibos
                    $('#sDocumento').val(Documento);
                    $('#sInciso').val(Inciso); //Pendiente
                    $('#sAnterior').val(DAnterior);
                    $('#sPosterior').val(DPosterior);
                    $('#sCliente').val(NombreCompleto);
                    $('#sRFC').val(RFC);
                    $('#sGrupo').val(Grupo);
                    $('#sSubGrupo').val(SubGrupo);
                    $('#sSSubGrupo').val(SSGrupo);
                    //$('#sExpediente').val(doc.); //Pendiente
                    $('#sDireccion').val(Calle + Colonia + Poblacion + Ciudad + Pais);
                    $('#sSubRamo').val(SRamoNombre);
                    $('#sAgente').val(CAgente + AgenteNombre);
                    $('#sCompania').val(AgenteNombre);
                    $('#sEjecutivo').val(EjecutNombre);
                    $('#sPago').val(FPago);
                    $('#sVendedor').val(VendNombre);
                    $('#sMoneda').val(Moneda);
                    $('#sDesde').val(FDesde);
                    $('#sHasta').val(FHasta);
                    $('#sRenovacion').val(Renovacion);
                    $('#sAntiguedad').val(FAntig);
                    $('#sCaptura').val(FCaptr);
                    ...
                    $('#sPlan').val();
                    $('#sAseguradoPC').val();
                    $('#sReferencia1').val(Referencia1); //Pendiente
                    //$('#sCobro').val(doc.); //Pendiente
                    $('#sReferencia2').val(Referencia2); //Pendiente
                    $('#sEstatusUsuario').val(StatusUser_TXT);
                    $('#sReferencia3').val(Referencia3); //Pendiente
                    //$('#sClasDoc').val(doc.); //Pendiente
                    $('#sOficina').val(Referencia4); //Pendiente
                    $('#sGerencia').val(GerenciaNombre);
                    $('#sDespacho').val(DespNombre);
                    //$('#sLineaNegocio').val(doc.); //Pendiente
                    $('#sCondCobro').val(CCobro_TXT);
                    //$('#TsipoCondCobro').val(doc.); //Pendiente
                    $('#sPrimeraNeta').val(numberFormat.format(doc.PrimaNeta));
                    $('#sDescuento').val(numberFormat.format(doc.Descuento));
                    $('#sRecargos').val(numberFormat.format(doc.Recargos));
                    $('#sDerechos').val(numberFormat.format(doc.Derechos));
                    $('#sSubTotal').val(numberFormat.format(doc.STotal));
                    $('#sIVA').val(numberFormat.format(doc.Impuesto1));
                    $('#sAjuste').val(numberFormat.format(doc.ExtraPrima));
                    $('#sPrimaTotal').val(numberFormat.format(doc.PrimaTotal));
                    $('#sEndoso').val(Endoso); //Pendiente por el tipo de formato
                    $('#sTipoPago').val(doc.TipoPago);
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                for (var b in rcb) {
                    ...
                    //Todas las fecha las cambiar al estándar

                    var PrimaNetaRecibo = Number(rcb[b].PrimaNeta) * NumPagos;
                    PrimaPendiente = PrimaNetaRecibo;
                    console.log(PrimaNetaRecibo);
                    $('#SumaRecibos').text(numberFormat.format(PrimaNetaRecibo));
                    var PrimaTotalPendiente = PrimaNetaTotal - PrimaNetaRecibo;
    ...
    function valor(dato) {
        ...
        else if (dato == "[object Object]") {dato = "";}
        else {dato = dato;}
        return dato;
    }
