	...
	<div class="row">
		<div class="col-md-12">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#configuracion" aria-controls="configuracion" role="tab" data-toggle="tab">Configuración de agenda y disponibilidad</a></li>
				<li role="presentation"><a href="#administracion" aria-controls="administracion" role="tab" data-toggle="tab">Administración de citas</a></li>
			</ul>
		</div>
	</div>
</section>
...
<section class="container-fluid breadcrumb-formularios">
	<div class="row">
		<div class="col-md-6 col-sm-5 col-xs-5"><h3 class="titulo-secciones">Calendario 
			<!--<span style="color: red">(En mantenimiento)</span>-->
		</h3></div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div id="contenidoEvento">
				<input type="radio" name="evento" id="idEvento" value="estandar" checked><label for=""><h5 class="modal-title" id="eventoTitulo">&nbsp Crear evento</h5></label>&nbsp&nbsp&nbsp&nbsp&nbsp	
				<?php if(in_array($this->tank_auth->get_usermail(),$top_email) || $this->tank_auth->get_usermail()=="SISTEMAS@ASESORESCAPITAL.COM") {?>
					<input type="radio" name="evento" id="idCapacitacion" value="capacitacion"><label for=""><h5 class="modal-title" id="eventoTitulo">&nbsp Convocar a capacitación</h5></label>
				<?php }?>
			</div>
			<!---------------------------------------------------------------------------------------------->
				<div class="modal-body" style="padding-top: 10px">
					<fieldset>
						<div class="panel panel-default">
							<div class="panel-body">
								<div>
									<div class="group form row" id="tituloEvento">
										<label for="title" class="col-md-3 col-sm-3 control-label text-right" id="TE">*Tema del evento</label>
										<div class="col-md-8">
									...
									<!------------------------------------------------------------------------------------------------------------------------->
									<!--[Dennis 2020-06-15]-->
									<div class="group form row" id="tituloCapacitacion" style="display:none">
										<label for="title" class="col-md-3 col-sm-3 control-label" id="TE">*Tema del evento</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="title_cap" name="title_cap" placeholder="Titulo del evento de capacitación">
										</div>
									</div>
									<!------------------------------------------------------------------------------------------------------------------------->
								</div>
								...
								<div class="form-group row">									
									<div class=" col-sm-9 col-md-9 row">
										...
										<div class="col-md-8 input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="start" data-link-format="yyyy-mm-dd">
								...
								<div class="form-group row" id="end-group">
									<div class="col-sm-9 col-md-9 row">
										<label for="end" class="col-sm-3 col-md-3 col-xs-3 control-label">Final</label>
										<div class="col-md-8 input-group form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="end" data-link-format="yyyy-mm-dd">
								...
								<div class="form group row">
									<label for="urlZoom" class="col-md-3 col-sm-3 control-label text-left">*Liga del evento</label>
									<div class="col-md-8">
										<input type="text" class="form-control" id="urlZoom" name="urlZoom" placeholder="Escriba URL">
									</div>
								</div>
								<div class="form group row">
									<label for="idZoom" class="col-md-3 col-sm-3 control-label text-left">*ID del evento</label>
									<div class="col-md-8">
										<input type="text" class="form-control" id="idZoom" name="idZoom" placeholder="Escriba ID">
									</div>
								</div>
								<div class="form group row mt-3">
									<label for="pswZoom" class="col-md-3 col-sm-3 text-right">*Contraseña del evento</label>
									<div class="col-md-8">
										<input type="text" class="form-control" id="pswZoom" name="pswZoom" placeholder="Escriba codigo de acceso">
									</div>
								</div>
								<div class="form group row mt-3">
									<label for="pswZoom" class="col-md-3 col-sm-3 text-right">Lugar</label>
									<div class="col-md-8">
										<input type="text" class="form-control" id="location" name="location" placeholder="Escriba lugar">
									</div>
								</div>								
							</div>
						</div>
						<!--Dennis-->
						<!------------------------------------------------------------------------------------------------------>
						<div class="combo-cat" style="margin-top: 8px; min-height: 40px;">
							<span class="basic-category-event">
								<div class="show-link-category-event" style="float: right; padding-right: 5px;">
									<a href="javascript:void(0);" id="show-category-event-settings">Opciones de categoria</a>
								</div>
							</span>
							<div class="form-inline category-event" style="float: right; padding-bottom:3px">
								<div class="checkbox" style="padding-top: 0; float: right; ">
									<label for="hide-category-event-settings"  style="padding-right: 5px; ">
										<a href="javascript:void(0);" id="hide-category-event-settings">Ocultar opciones de categoria</a>
									</label>
								</div>
							</div>
							<div class="category-event form group row">
								<label for="categoria" class="col-sm-2 col-md-2 col-xs-2 control-label" id="TC" >Categoría</label>
								<div class="col-sm-9" id="campoSelectEvento">
									<select name="selectCapacitacion" id="idSelectCapacitacion" class="form-control">
										<option value="0">Seleccione una opcion</option>
										<?php foreach($capacitaciones as $valores){?>
											<option value="<?=$valores->id_capacitacion?>"><?=$valores->tipoCapacitacion?></option>
										<?php }?>
									</select>
								</div>
								<br><br>
								<div class="col-sm-12 col-md-12 col-xs-12" id="sub_categoria">
									<label for="subCategoria" class="col-sm-4 col-md-2 col-xs-2 control-label" id="TSC" >Sub-categoría</label>
									<div class="col-sm-9">
										<select name="subCategoria" id="idSubCategoria" class="form-control" >
											<option value="0">Seleccione</option>
										</select>
									</div> 
								</div>
								<br><br>
								<div class="col-sm-12 col-md-12 col-xs-12" id="ramosCap">
									<label for="ramosCap" class="col-sm-4 col-md-2 col-xs-2 control-label" id="RC" >Ramos</label>
									<div class="col-sm-9">
										<select name="ramosCapa" id="ramosCapa" class="form-control" >
											<option value="Ninguno">Seleccione un ramo</option>
											<?php 
											foreach($ramosC as $valor){ ?>
												<option value="<?=$valor->idR?>"><?=strtoupper($valor->nombre_ramo)?></option>
											<?php }
											?>
										</select>
									</div>
						...
						<div class="" style="margin-top: 2px">
							...
							<span class="basic">
							   <div class="show-link" style="float: right; padding-right: 5px; display: block;">
									<a href="javascript:void(0);" id="show-standard-settings">Agregar Invitados Usuarios</a>
							   </div>
							</span>
									...
									<div class="panel-group" id="accordion1">
									 ...
									 <div class="panel-group" id="accordion2">
										<div class="panel panel-default">
										  <div class="panel-heading">
											<h5 class="panel-title">
											  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#emails_acordion"><label style="border:solid;">▼Mostrar de contactos</label></a>
											</h5>
										  </div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<div class="col-sm-offset-2 col-sm-10">
																			<div class="checkbox">
																				<input type="checkbox" class="client" data-alias="todos"> Todos los correos
																			</div>
																		</div>
																	</div>
																...
																<div class="col-md-6">
																	<div class="row">
																		...
																		<div class="col-md-10 text-right mt-2"><em><b><span class="persons-selected">0</span> personas de 150</b></em></div>
																	</div>
																</div>
															</div>
														</div>
														<!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-9 bhoechie-tab-container"> Dennis-->
														<div class="row">
	...
	?>															      </div>
															    ...
															    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab" style="height:500px;overflow-y:scroll;overflow-x:hidden;">
																	...
																	if(isset($Catalogo_Perfiles)):
																		...
																		<div class="bhoechie-tab-content table-responsive <?php echo $i == 0 ? 'active' : '' ;?>">
																			<div class="form-group">
																				<label><input type="checkbox" class="client" data-alias="tablaVen-<?php echo($i)?>"> Todos los <?php echo $item["Name"]; ?></label>
																				<?php if( isset($item["Data"]) && $item["Data"] != NULL ): ?>
																				<table class="table table-hover table-email-gap" id="tablaVenC-<?php echo ($i); ?>" <?php echo ($item["Name"] == "Vendedores" ? 'data-IdVen="'.$item["idTipoUser"].'"' : "");?>>
																				  <thead>
																					<tr>
																					  <th class="all"></th>
																					  <th></th>
																				  ...
																				  <tbody>
																						...
																						if(!is_null($items["aliadoCarCapital"]) && $items["aliadoCarCapital"] == 0):?>
																						<tr>
																						  <td><input type="checkbox" class="tablaVen-<?php echo ($i); ?> emailGap client" data-id="<?php echo $items["id"];?>" data-email ="<?php echo $items["email"]; ?>"> <a href="#"><i class="glyphicon glyphicon-envelope"></i></a></td>
						...
						<div class="" style="margin-top: 10px; min-height: 40px;">
							...
							<div class="reminder col-sm-12" style="margin-top: 8px">
								...
								<!--<div class="form-group">									
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="guest" style="width:80%; float:left;" placeholder="correo@ejemplo.com">&nbsp;<button type="button" class="btn btn-small btn-success" id="add-guest">A&ntilde;adir</button>
						...
						<!---------------------------------------------------------------------------------------------------------->
						<div class="" style="margin-top: 2px; min-height: 40px;">
							<span class="basic-externalEmail">
								<div class="show-link-externalEmail" style="float: right; padding-right: 5px;">
									<a href="javascript:void(0);" id="show-externalEmail-settings">Agregar Invitados Especiales</a>
								</div>
							</span>
							&nbsp;
							<div class="form-inline externalEmail" style="float: right; padding-bottom:3px">
								<div class="checkbox" style="padding-top: 0; float: right; ">
									<label for="hide-externalEmail-settings"  style="padding-right: 5px; ">
										<a href="javascript:void(0);" id="hide-externalEmail-settings">Ocultar ajustes de invitados</a>
									</label>
								</div>
							</div>
							<div class="externalEmail col-sm-12">
								<div class="form-group">									
										<label for="privacy" class="col-sm-2 control-label">Invitados</label>
										<div class="col-sm-9">
											<div class="row">
												<div class="col-md-9"><input type="text" class="form-control" id="guest" style="float:left;" placeholder="Ingrese correo ej.: correo@ejemplo.com"></div>
												<div class="col-md-3"><button type="button" class="btn btn-small btn-success" id="add-guest">A&ntilde;adir</button><!-- band0--></div>
											</div>
											<div id="guest-list"></div>
											<div id="guest-list-gap" style="display:none"></div>
										</div>
						...
						<div class="row">
							<div class="col-md-8"><input type="hidden" id="all-guest" name="all-guest" value="0" data-internal-count="0" data-external-count="0"></div>
							<div class="col-md-4 text-right mt-4 "><em><b><span class="persons-selected">0</span> personas de 150</b></em></div>
						</div>
						<!---------------------------------------------------------------------------------------------------------->
...
<!-- Aesores online modal -->
<div class="modal fade" id="AsesoresOnlineModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		  <h4 class="modal-title" id="myModalLabel">Cita para el <span class="diary-date"></span> </h4>
		  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">
        
	  	<div class="loading-data text-center d-none">
			<i class="fa fa-spinner fa-spin fa-3x"></i>
			<div class="col-md-12" style="margin-top: 5px;">Cargando información</div>
		</div>

		<div class="show-diary-content d-none">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-2 text-center"><i class="fa fa-info fa-2x"></i></div>
					<div class="col-md-10 block-section" >
						<span class="diary-sections">Detalle de la cita</span>
						<div style="margin-top: 10px"><i class="fa fa-comment"></i> El tema será acerca de: <span class="detail-d"></span></div>
						<div style="margin-top: 5px"><i class="fa fa-arrow-right"></i> Origen: <span class="origin-d"></span></div>
						<div style="margin-top: 5px"><i class="fa fa-clock-o"></i> Hora para contacto con el cliente es a la(s): <span class="time-d"></span></div>
						<div style="margin-top: 5px"><i class="fa fa-exclamation-circle"></i> Esta cita se encuentra <span id="status-label"></span></div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-2 text-center"><i class="fa fa-user fa-2x"></i></i></div>
					<div class="col-md-10 block-section" >
						<span class="diary-sections">Cliente</span>
						<div style="margin-top: 10px"><i class="fa fa-arrow-right"></i> <span class="client-d"></span></div>
						<div style="margin-top: 5px"><i class="fa fa-envelope"></i> <span class="email-d"></span></div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-2 text-center"><i class="fa fa-comments fa-2x"></i></div>
					<div class="col-md-10 block-section" >
						<span class="diary-sections">Forma de contacto</span>
						<div style="margin-top: 10px"><div class="contact-d"></div></div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-2 text-center"><i class="fa fa-question-circle fa-2x"></i></div>
					<div class="col-md-10 block-section" >
						<span class="diary-sections">Confirmación de asistencia</span>
						<div style="margin-top: 10px">
							<div class="row">
								<div class="col-md-6">¿Confirmar asistencia?</div>
								<div class="col-md-6">
									<div class="dropdown">
										<button id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-primary btn-xs">
											<span class="status-current">PENDIENTE</span>
											<span class="caret"></span>
										</button>
										<ul class="dropdown-menu" aria-labelledby="dLabel">
											<li><a href="javascript: void(0);" class="status-option" status="pendiente">Pendiente</a></li>
											<li><a href="javascript: void(0);" class="status-option" status="confirmado">Confirmar</a></li>
											<li><a href="javascript: void(0);" class="status-option" status="rechazado">Rechazar</a></li>
										</ul>
									</div>
								</div>
							</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary confirm-diary">Confirmar cambios</button>
      </div>
    </div>
  </div>
</div>
<!-- Asesores online modal final -->

</div><!--final de tab calendario-->


<!--Tab de configuracion de agenda de cita-->
<div role="tabpanel" class="tab-pane" id="configuracion">
	<?php $this->load->view("calendario/configuracion_citas_online") ?>
</div>
<!-- final de tab de configuracion-->


<!--Tab de Administracion de agenda de cita-->
<div role="tabpanel" class="tab-pane" id="administracion">
	<div id="pantalla">
		<?php $this->load->view("calendario/administracion_citas_online") ?>
	</div>
</div>
<!-- final de tab de Administracion-->


</div><!-- Final del tab menu-->
...
<link href="<?=site_url('assets/js/formstoneuploadfile/dist/css/upload.css') ?>" rel="stylesheet">
...
<script src="<?=site_url('assets/js/formstoneuploadfile/dist/js/core.js') ?>"></script>
<script src="<?=site_url('assets/js/formstoneuploadfile/dist/js/upload.js')?>"></script>
	...
	$(document).ready(function(){
		...
		$(document).on("click",".client",function (e) {
			 ...
			 if (data_value === undefined) {
				...
				if($(this).is(':checked')){							 
					//console.log("aqui"); //Aqui verifica los checks unitariamente
				...
				if($(this).is(':checked')){
					//console.log("check area"); //Por aqui cruza
					...
					if(data_value == "todos")
					{
						...
						$.each(email,function(index,item){
							...
							var dta_id_sub = $(item).attr("data-id-sub");
							$(item).prop( "checked", true );
							if($(".guest_" + dta_id+"_"+dta_id_sub).length == 0 && validateEmail($(item).attr("data-email")) && $(item).attr("data-email") !== ""){
								guestView += "<input class='guest_" + dta_id +"_"+dta_id_sub+"' name='guests[]' value='" + $(item).attr("data-email") + "'>";
								count_++;
								//console.log($(item).attr("data-email"), count_++);
							}
						...
						//console.log("xdddd"); //para bloques especificos
					...
					if(data_value == "todos"){
						...
						$.each(email,function(index,item)
						{
							...
							var dta_id_sub = $(item).attr("data-id-sub");
							$(".guest_" + dta_id+"_"+dta_id_sub).remove();
							if($(item).attr("data-email") !== "" && validateEmail($(item).attr("data-email")) && $(item).is(":checked")){
								count_--;
								//console.log($(item));
							}
							$(item).prop( "checked", false );
						...
						$.each(email,function(index,item)
						{
							...
							$(".guest_" + dta_id+"_"+dta_id_sub).remove();
							$(item).prop( "checked", false );
							if($(item).attr("data-email") !== "" && validateEmail($(item).attr("data-email"))){
								count_--;
							}
						});
					}
			 ...
			 //console.log(count_);
			 //$(`.persons-selected`).html(count_);
			 $(`#all-guest`).attr(`data-internal-count`, count_);
			 var countExternal = $(`#all-guest`).attr(`data-external-count`);
			 $(`.persons-selected`).html(parseInt(countExternal) + count_);
		});
