...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Capsys Web V3.0';
$config['webmaster_email'] = 'juanjose@dre-learning.com';
...
$config['recaptcha_public_key'] = '6LcmSRETAAAAAK1M6zIOHAFGpdkYBDLJWWBcrNN0';
$config['recaptcha_private_key'] = '6LcmSRETAAAAAN99rY13u3TcgVFJHa_vzQeY5bHm';
