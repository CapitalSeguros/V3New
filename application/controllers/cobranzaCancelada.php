...
class cobranzaCancelada extends CI_Controller
{
...
//--------------------------------------------------------------------------------------------------------------//
   ...
   {	
	  ...
	  {
     $this->load->view('reportes/cobranzaCancelada');	
	  }
  }
//--------------------------------------------------------------------------------------------------------------//
    function traeDatos(){
	...
	{ 
		if($this->input->post('fIni')=='' or $this->input->post('fFin')=='' )	
       {
 	    ...
 	    $this->load->view('reportes/cobranzaCancelada',$datos);	
	   }
       else{   
                 ...
                 { 
                    $x['fecFin']= $this->input->post('fFin');
                     ...
                     $x['TableControl'] =$xml->TableControl;               
                           ...
                           $this->load->view('reportes/cobranzaCancelada',$x);
                 }
