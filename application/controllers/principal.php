...
<section class="container-fluid breadcrumb-formularios">
              ...
              { 
                  ...
                  $imprimeBarras=$graficaBarras.$perfiladito.",".$contactaditos.",".$registraditos.",".$cotizaditos.",".$pagaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=50";

                  $imprimePastel=$graficaBarras.$perfiladito.",".$contactaditos.",".$registraditos.",".$cotizaditos.",".$pagaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=200&hgt=100 ";
              ...
              else
              {
                  ...
                  { 
                      ...
                      $imprimeBarras=$graficaBarras.$perfiladito.",".$contactaditos.",".$registraditos.",".$cotizaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=50";

                      $imprimePastel=$graficaPastel.$perfiladito.",".$contactaditos.",".$registraditos.",".$cotizaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=200&hgt=100 ";
                  ...
                  else
                  {
                        ...
                        if(
                         ...
                         { 
                           ...
                           $imprimeBarras=$graficaBarras.$perfiladito.",".$contactaditos.",".$registraditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=50";

                           $imprimePastel=$graficaPastel.$perfiladito.",".$contactaditos.",".$registraditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=200&hgt=100 ";
                        ...
                        else
                        {
                             ...
                             if(
                              ...
                              { 
                                   ...
                                   $imprimeBarras=$graficaBarras.$perfiladito.",".$contactaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=50";


                                   $imprimePastel=$graficaPastel.$perfiladito.",".$contactaditos."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=200&hgt=100 ";
                                   ...
                                   if(isset($perfiladito) && $perfiladito>0 )
                                    { 
                                      ...
                                      $imprimeBarras=$graficaBarras.$perfiladito."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=50";
                                       ...
                                       $imprimePastel=$graficaPastel.$perfiladito."&ttl=Puntos+por+etapa&bkg=FFFFFF&wdt=200&hgt=100 ";
       ...
       <div class="col-md-3 col-sm-3 col-xs-3"> 
           ...
           <label>Puntos en Regsitrados=</label>
 ...
 <form  class="form-horizontal" role="formdimension3"
              ...
              method="post" 
              action="<?=base_url()?>crmproyecto/InsertaDimensiondeSikas" >
 ...
 <section class="container-fluid breadcrumb-formularios">
          ...
          <form  class="form-horizontal" role="formdimension"
            ...
            <label>Fuentes de Prospectos</label>
              ...
              size="1" class="form-control" >
                  ...
                  <option value="AMIGODEESCUELA">Amigos de la Escuela</option>
                  <option value="AMIGODEFAMILIA">Amigos de la Familia</option>
                  <option value="VECINOS">Vecinos</option>
                  <option value="CONOCIDOPASATIEMPOS">Conocidos a traves de Pasatiempos</option>
                  <option value="FAMPROPIAOCONYUGUE">Familia Propia o Conyugue</option>
                  <option value="CONOCIDOGRUPOSOCIAL">Conocidos atraves de los grupos sociales</option>
                  <option value="CONOCIDOACTIVICOMUNIDAD">Conocidos por la actividad de la comunidad</option>
                  <option value="CONOCIDOANTIGUOEMPLEO">Conocidos de Antiguos Empleos</option>
                  <option value="PERSONASHACENEGOCIO">Personas con las que hace negocios</option>
                  <option value="CENTRODEINFLUENCIA">Centro de Influencia</option>
              ...
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
                  <option value="MENOSDE$25000">Menos de $25000</option>
                  <option value="DE$25000A$60000">de $25000 a $60000</option>
                  <option value="DE$6000A$100000">de $60000 a $100000</option>
                  <option value="MASDE$100000">Mas de $100000</option>
                </select>
              </div>  
              ...
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
                  <option value="MENOSDE18">Menos de 18</option>
                  <option value="DE19A35">de 19 a 35</option>
                  <option value="DE36A50">de 36 a 50</option>
                  <option value="DE51A65">de 51 a 65</option>
                </select>
              </div>  
              ...
              size="1" class="form-control" >
                  ...
                  <option value="NEGOCIOPROPIO">Negocio Propio</option>
                  <option value="PROFESIONISTAINDEPENDIENTE">Profesionista Independiente</option>
                  <option value="RETIRADO">Retirado</option>
                  <option value="OTROSEMPLEOS">Otros Empleos</option>
              ...
              size="1" class="form-control" >
                  ...
                  <option value="CASADOCONHIJOS">Casado con hijos</option>
                  <option value="DIVORCIADOS">Divorciado</option>
                  <option value="DIVORCIADOSCONHIJOS">Divorciado con hijos </option>

                  <option value="SOLTERO">Soltero</option>
                  <option value="SOLTEROCONHIJOS">Soltero con hijos</option>
                  <option value="UNIONLIBRE">Union Libre</option>
                  <option value="UNIONLIBRECONHIJOS">Union Libre con hijos</option>
                  <option value="VIUDO">Viudo</option>
                  <option value="VIUDOCONHIJOS">Viudo con hijos</option>

                </select>
              </div>  

               <div class="row">
               <label>Tiempo de Conocer los Prospectos</label>
              <select name="tiempoconocer" 
              id="tiempoconocer" 
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
                  <option value="MASDE5ANIOS">Mas de 5 Años</option>
                  <option value="DE2A5ANIOS">de 2 a 5 Años</option>
                  <option value="MENOSDE2ANIOS">Menos de 2 años</option>
                </select>
              </div>  

               <div class="row">
               <label>Frecuencia que lo vio(ulitmo 12 meses)</label>
              <select name="frecuenciavio" 
              id="frecuenciavio" 
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
                  <option value="MASDE5VECES">Mas de 5 Veces</option>
                  <option value="DE3A5VECES">de 3 a 5 Veces</option>
                  <option value="DE1A2VECES">de 1 a 2 Veces</option>
                  <option value="NOLOVIO">No lo vio</option>
                </select>
              </div> 

              <div class="row">
               <label>Posibilidad de Acercamiento</label>
              <select name="posacercamiento" 
              id="posacercamiento" 
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
                  <option value="FACILMENTE">Facilmente</option>
                  <option value="NOMUYFACIL">No muy Facil</option>
                  <option value="CONDIFICULTAD">Con Dificultad</option>
                </select>
              </div>  


              <div class="row">
               <label>Habilidad para dar Referencias</label>
              <select name="habilidadref" 
              id="habilidadref" 
              size="1" class="form-control" >
                  <option value="">Seleccione una opcion</option>
        ...
        <input type="button" name="button" id="button" value="Agregar Referido" align="right" 
              ...
              { 
                ...
                {
                   alert('No capturaste Razon y RFC');
                } 
              ...
              { 
                ...
                {
                   alert('No capturaste Nombre o Apellidos');
                } 
              }
...
<form  class="form-horizontal" role="formreferidos"
            ...
            action="<?=base_url()?>crmproyecto/InsertaPerfilado/" >    
         	...
         	<div class="col-md-3 col-sm-3 col-xs-3"> 
            	...
            	<h4 class="titulo-secciones">1.-Dimension/Referidos</h4> 
				  <div class="row">
					<select name="IDCli" 
			        id="IDCli" 
            ...
            action="<?=base_url()?>crmproyecto/InsertaContactado/" >    
         	...
         	<div class="col-md-3 col-sm-3 col-xs-3">
          	<h4 class="titulo-secciones">2.-Perfilados (+1 Punto)</h4> 
               ...
               onclick="
              var cli = cliselecInsertaConta.value;
              ...
              {
                alert('Selecciona un Nombre de la Lista de PERFILADOS');
              }" >
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
         ...
         <div class="col-md-3 col-sm-3 col-xs-3">
              ...
              <div class="col-md-3 col-sm-3 col-xs-3">
                 ...
                 <input
                  type="text" name="fechaStartCita" id="fechaStartCita"
                  class="form-control input-sm fecha fechaStartCita"
                  placeholder="1900-01-01"
                                  value="<?=($this->input->post('fechaStartCita',TRUE)!="")?$this->input->post('fechaStartCita',TRUE):date('Y-m-d')?>" >
...
<form  class="form-horizontal" role="formcitado2"
            ...
            method="post" 
            action="<?=base_url()?>crmproyecto/Emision/"   > 
...
<form  class="form-horizontal" role="formcitado2"
            ...
            method="post" 
            action="<?=base_url()?>crmproyecto/LlamaCapturaEmision/"   > 
            ...
            <table class="table" id='Mitabla'>
              ...
              ?>
                    <tr>
                      ...
                      <td>
                      <a href="<?=base_url()?>crmproyecto/VerificarPago?IDSIK=<?php echo $row->idSicas?>&IDCL=<?php echo $row->IDCli?>"
...
<section > 
      ...
      <div class="row">
         <h4 class="titulo-secciones">6.-Pagados(+5 Puntos)</h4>
      </div>
