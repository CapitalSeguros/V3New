...
class Autos extends TIC_Controller
{
    ...
    function index()
    {
        ...
        $this->headerScripts(array(
            ...
            array(
                'type' => 'JS',
                'path' => 'js/fileupload/public/bundle-autos_individual.js'
            )
        ));
        ...
        //$this->render('autos/autos', $head, $data, $footer);//autosV2
        $this->render('autos/autosV2', $head, $data, $footer);
    }
    ...
    //metodo de retorno de la informacion
    function getAutosV2()
    {
        $id = null;
        $year = '0';
    ...
    function getAutosV2_1()
    {
        ...
        $code = 200;
        $message = "Exito" . "id->" . $id . " Año->" . json_encode($input_data);
        //$data=$this->autos->getAllAutos($id, $year);
        $data = $this->autos->getAllAutosV2($input_data);
    ...
    function postTramite()
    {
        ...
        if ($id_tramite == 0) {
            ...
            $this->autos->updateAutos($id_siniestro, array("ultimo_tramite" => $inserted_id));
        } else {
