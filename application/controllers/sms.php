...
class Sms extends CI_Controller{
	...
	function index(){
		if (!$this->tank_auth->is_logged_in()) {
			...
			if($this->input->post('paraSms') != "" && $this->input->post('paraSms') != "Para" ){
				$this->form_validation->set_rules('paraSms', 'Sms ("Para")', 'trim|valid_emails');
			}				
			...
			if($this->input->post('smsText') == "Sms")	$this->post_get_clean('smsText',"");
