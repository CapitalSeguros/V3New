...
/*===============================================================================================*/			
            ...
            $usuarioResponsable=$this->catalogos_model->devolverRamoConIdSubramo($infoActividad->IDSRamo);
				...
				if($this->input->post('cruce') != false){$data['cruce_cartera']	= "Si";}				
							...
							if(isset($_GET['servidor']))
				{
	             ...
	             {	
	               if($_SESSION['versionNuevaActividad']){$this->load->view('actividades/verS',$data);}		
	             	else{$this->load->view('actividades/verS',$data);}
	             }
	...
	{ 		if (!$this->tank_auth->is_logged_in()) {
		...
		} else 
		{
          ...
          $this->db->insert('bitacorarefrescado',$insert);
			...
			if($this->tank_auth->get_View()!= "App"){$this->load->view('actividades/verActividadesprueba',$data);} 	     
			else {$this->load->view('actividades/verActividadesprueba',$data);}
		}
