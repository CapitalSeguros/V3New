...
<script type="text/javascript">
    <?php echo "const _puestos=".json_encode($puestos).";";?>
    <?php echo "const _puestos2=".json_encode($puestos2).";";?>
</script>
<script>
...
<script type="text/javascript" src="<?= base_url() ?>assets/js/fileupload/public/bundle-modal-autorizacion.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/js/fileupload/public/bundle-tabuladorbono.js"></script>