...
<div id="modalTipo" class="modal bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select type="text" class="form-control" name="notificacion" id="cbNotificacion">
                                    ...
                                    <option value="<?= $value['clave'] ?>"><?= $value['titulo'] ?></option>
                                    <? endforeach; ?>
                                </select>
                            </div>
                        </div>
