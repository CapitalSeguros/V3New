...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" >
  <head>
    ...
    #element2 {
        padding-top: 3px;padding-left : 20px; float:left;
        } 
                                    ...
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;color:#ffffff !important;'>
                                        <div style='color:#ffffff !important;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                          ...
                                          <span>
                                          El período <strong>{{ titulo }}</strong> no estará disponible en <strong>{{ dias }}</strong> dias, fecha <strong>{{ fecha_final }}</strong>, esté al pendiente de realizar las evaluaciones correspondientes.
                                          </span>
                                        </div>
                                      </td>
                                    </tr>
