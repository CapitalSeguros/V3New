...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#Tabla_siniestros').DataTable({
            ...
            ajax: {
                url: `${$path}Siniestros/getTable`,
                type: 'GET',
                dataSrc: function(json) {
                    label = json.data.lastUpdt;
                    console.log('lastuPD', label);

                    //document.getElementById("last_update").text(json.data.lastUpdt);
                    return json.data.data;
                }
            },
            drawCallback: function() {
                console.log("Inicio el callback");
                if (draw == 0) {
                    draw++;
                } else {
                    //console.log("entra a eliminar el load");
                    //document.getElementById("over").style.display = "none";
                    //document.getElementById("upProgressModal").style.display = "none";
                    $("#over").css("display", "none");
                    $("#upProgressGeneral").css("display", "none");
                }
                Getpermisos();
            },
            ordering: false,
            ...
            initComplete: function() {
                ...
                ///no se esta contemplando ya que se dejo abierto 
                /*  <div class="col-sm-2">
                         <label>Tipo Reparación </label><br>
                         <select id="Tipos_reparacion" class="form-control" name="11">
                ...
                <div class="row">
                    ...
                    ${_clienteT.length>1?`<div class="col-sm-2">
                        <label>Cliente </label>
                        <select class="form-control input-sm"  id="cbEstado2" name="8">
                        <option value="">Todos</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-right" style="margin-top: 10px;">
                            ...
                            <a href="${$path}Siniestros/RegistroAutosC" class="btn btn-primary Nuevo">Nuevo siniestro</a>
                            ...
                            <div>
                                <div class="media-body">
                                    ...
                                    <div class="Siniestro-body">
                                        ...
                                        ${row.nombre_tramite=='REPARACIÓN'?`<div class="box first" style="padding-left: 15px;"> Estatus Reparación: ${row.Estatus_Reparacion}</div>`:''}
                                    </div>
                                </div>
                            </div>  
                        </div>
                        ...
                        <div style="text-align: center;">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right"  aria-labelledby="dp${row.id}">
                                       ...
                                       <li><a class="bn-bono-view show-notes-modal" data-type="autos corporativo" data-id="${row.id}" data-number="${row.siniestro_id}" data-insured="${row.asegurado_nombre}" data-policy="${row.poliza}" data-type-sinister="${row.sub_evento.toUpperCase()}" style="cursor: pointer;" >Generar nota</a></li>
