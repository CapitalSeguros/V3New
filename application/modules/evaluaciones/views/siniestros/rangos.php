<section class="container-fluid breadcrumb-formularios">
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Rango de dias</h3>
        </div>
    </div>
    <hr />
</section>
...
<div id="mdBaja" class="modal" tabindex="-1" role="dialog" aria-labelledby="mdBaja" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addSaveBaja" action="<?= base_url() ?>Siniestros/rangos/getDataRangos/2" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">Rango de dias</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Rango" name="Rango" id="txRango" required>
