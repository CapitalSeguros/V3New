<section class="container-fluid breadcrumb-formularios">
    <div class="row">
        <div class="col-md-6 col-sm-5 col-xs-5">
            <h3 class="titulo-secciones">Notificaciones por dias</h3>
        </div>
    </div>
    <hr />
</section>
    ...
    <div style="float: left; width: 90%;">
        <div class="row">
            <div class="form-group col-md-12 text-right">
                <a href="#" class="btn btn-primary btn-sm js-NuevoN" data-permiso="permiso" data-accion-permiso="Nuevo">Nuevo</a>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        const datatable = $('#example').DataTable({
            ...
            ajax: {
                url: `${$path}Serviciosws/getTable/4`,
                type: 'GET',
                dataSrc: 'data'
            },
                ...
                },
                {
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right"  aria-labelledby="dp${row.id}">
                            <li><a style="cursor: pointer;" class="js-EditarN" data-id='${row.id}' data-row='${JSON.stringify(row)}' data-permiso="permiso" data-accion-permiso="Editar">Editar</a></li>
        ...
        window.eliminar = function(id) {
            swal({
                ...
                if (value) {
                    $.ajax({
                        type: 'POST',
                        url: `${$path}Serviciosws/servicio_postA/3`,
                        data: {
                            "id": id
                        },
