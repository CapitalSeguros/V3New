...
function kpiUnionPuesto($array='')
{
   ...
   $consulta='select k.*,pp.personaPuesto,pp.email,p.nombres,p.apellidoPaterno,p.apellidoMaterno,kip.kpi,kip.variable1,kip.variable2,kip.comentarioKPI,ca.colaboradorArea,kip.referenciaKPI from kpi_puesto k
