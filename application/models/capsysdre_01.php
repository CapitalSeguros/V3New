...
$sqlBusquedapro="";
	...
	function GetCuentaContable($idCuentaContable){		
	 ...
	 function ListaPagos(){
        ...
        $sqlBusquedaVendedor = "
			select f.id,f.fecha_captura,f.fecha_factura ,f.folio_factura ,f.concepto ,f.montofianzas,f.montoinstitucional ,f.gestion,f.promomid ,f.promocun,f.corporativo,f.otromonto1,f.otromonto2,f.totalfactura ,f.autorizadireccion ,
f.pagado,f.fecha_pago,f.Usuario,f.idProveedor,f.iva,f.totalconiva,f.posteriorapago,f.archivoNombreXML,f.archivoNombrePDF ,f.archivoDescripcionXML,f.archivoDescripcionPDF,f.sucursal,f.validada,f.idCuentaContable ,f.idAperturaContable,'' as idPersonaDepartamento               from facturas f where f.autorizadireccion='1' and f.pagado='0' and f.posteriorapago in(0,1,3,4,5,9) 
union
select '' as id,
'' as fecha_captura,
'' as fecha_factura,
...
f.sucursal,f.validada,f.idCuentaContable,f.idAperturaContable ,f.idPersonaDepartamento
 from facturas f where f.autorizadireccion='1' and f.pagado='0' and f.posteriorapago='2' and f.sucursal='MERIDA' 
 union
select '' as id,
'' as fecha_captura,
'' as fecha_factura,
...
f.sucursal,f.validada,f.idCuentaContable,f.idAperturaContable,f.idPersonaDepartamento 
 ...
 from facturas f where f.autorizadireccion='1' and f.pagado='0' and f.posteriorapago='2' and f.sucursal='NORTE' 
 union
select '' as id,
'' as fecha_captura,
'' as fecha_factura,
...
f.sucursal,f.validada,f.idCuentaContable,f.idAperturaContable,f.idPersonaDepartamento 
 ...
 from facturas f where f.autorizadireccion='1' and f.pagado='0' and f.posteriorapago='2' and f.sucursal='CANCUN' 
 group by f.Usuario
							   ";
		$query = $this->db->query($sqlBusquedaVendedor);
		return
