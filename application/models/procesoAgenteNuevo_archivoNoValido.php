...
<div class="container-fluid">
    <br>
    <h2>Seguimiento del agente nuevo</h2>
    <hr>
    <div  class="card" style="width: 50%; border: 1px black solid; margin: 0 auto; margin-top:40px;">
        <div class="card-header">
            <?php foreach($datosPersonales as $datos) {?>
                <div class="jumbotron">
                    <h3 class="display-4 text-center"><?=$datos->nombres." ".$datos->apellidoPaterno." ".$datos->apellidoMaterno?></h3>
                </div>
            ...
            <?php foreach($capacitacionActiva as $orden){?> 
                <tr>
